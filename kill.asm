...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 47 09 00 	movl   $0x947,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 58 05 00 00       	call   57b <printf>
    exit();
...
void ps(void) {
 ...
 2e1:	c7 44 24 04 5b 09 00 	movl   $0x95b,0x4(%esp)
 2e8:	00 
 2e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 2f0:	e8 86 02 00 00       	call   57b <printf>
 ...
 3be:	c7 44 24 04 74 09 00 	movl   $0x974,0x4(%esp)
 3c5:	00 
 3c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 3cd:	e8 a9 01 00 00       	call   57b <printf>
  for (i = 0; i < NPROC; ++i) {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 514:	0f b6 80 00 0c 00 00 	movzbl 0xc00(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 671:	75 09                	jne    67c <printf+0x101>
          s = "(null)";
 673:	c7 45 f4 84 09 00 00 	movl   $0x984,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 73d:	a1 1c 0c 00 00       	mov    0xc1c,%eax
 ...
 808:	a3 1c 0c 00 00       	mov    %eax,0xc1c
}
 80d:	c9                   	leave  
 80e:	c3                   	ret    
