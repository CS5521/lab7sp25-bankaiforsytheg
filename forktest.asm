...
printf(int fd, const char *s, ...)
{
  ...
  22:	e8 9a 04 00 00       	call   4c1 <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 54 05 00 	movl   $0x554,0x4(%esp)
  36:	00 
  ...
  4a:	eb 1f                	jmp    6b <forktest+0x42>
    pid = fork();
  4c:	e8 48 04 00 00       	call   499 <fork>
  ...
  60:	75 05                	jne    67 <forktest+0x3e>
      exit();
  62:	e8 3a 04 00 00       	call   4a1 <exit>
  for(n=0; n<N; n++){
  ...
  if(wait() != -1){
  cc:	e8 d8 03 00 00       	call   4a9 <wait>
  d1:	83 f8 ff             	cmp    $0xffffffff,%eax
  d4:	74 19                	je     ef <forktest+0xc6>
    printf(1, "wait got too many\n");
  d6:	c7 44 24 04 93 05 00 	movl   $0x593,0x4(%esp)
  dd:	00 
  de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e5:	e8 16 ff ff ff       	call   0 <printf>
    exit();
  ea:	e8 b2 03 00 00       	call   4a1 <exit>
  }

  printf(1, "fork test OK\n");
  ef:	c7 44 24 04 a6 05 00 	movl   $0x5a6,0x4(%esp)
  f6:	00 
...
main(void)
{
 ...
 10b:	e8 19 ff ff ff       	call   29 <forktest>
  exit();
 110:	e8 8c 03 00 00       	call   4a1 <exit>
...
gets(char *buf, int max)
{
 ...
 24c:	e8 68 02 00 00       	call   4b9 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2b1:	e8 2b 02 00 00       	call   4e1 <open>
...
void ps(void) {
 ...
 38a:	e8 b2 01 00 00       	call   541 <getpinfo>

  printf(1, "PID\tTKTS\tTCKS\tSTAT\tNAME\n");
 38f:	c7 44 24 04 b4 05 00 	movl   $0x5b4,0x4(%esp)
 396:	00 
 ...
 3b1:	e9 ce 00 00 00       	jmp    484 <ps+0x10f>
    if (pstat[i].inuse) {
 3b6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3b9:	89 d0                	mov    %edx,%eax
 3bb:	c1 e0 03             	shl    $0x3,%eax
 3be:	01 d0                	add    %edx,%eax
 3c0:	c1 e0 02             	shl    $0x2,%eax
 3c3:	8d 5d e8             	lea    -0x18(%ebp),%ebx
 3c6:	01 d8                	add    %ebx,%eax
 3c8:	2d 04 09 00 00       	sub    $0x904,%eax
 3cd:	8b 00                	mov    (%eax),%eax
 3cf:	85 c0                	test   %eax,%eax
 3d1:	0f 84 a9 00 00 00    	je     480 <ps+0x10b>
      printf(1, "%d\t%d\t%d\t%c\t%s\n", pstat[i].pid, pstat[i].tickets, pstat[i].ticks, pstat[i].state, pstat[i].name);
 3d7:	8d 8d e4 f6 ff ff    	lea    -0x91c(%ebp),%ecx
 3dd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3e0:	89 d0                	mov    %edx,%eax
 3e2:	c1 e0 03             	shl    $0x3,%eax
 3e5:	01 d0                	add    %edx,%eax
 3e7:	c1 e0 02             	shl    $0x2,%eax
 3ea:	83 c0 10             	add    $0x10,%eax
 3ed:	8d 3c 01             	lea    (%ecx,%eax,1),%edi
 3f0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3f3:	89 d0                	mov    %edx,%eax
 3f5:	c1 e0 03             	shl    $0x3,%eax
 3f8:	01 d0                	add    %edx,%eax
 3fa:	c1 e0 02             	shl    $0x2,%eax
 3fd:	8d 75 e8             	lea    -0x18(%ebp),%esi
 400:	01 f0                	add    %esi,%eax
 402:	2d e4 08 00 00       	sub    $0x8e4,%eax
 407:	0f b6 00             	movzbl (%eax),%eax
 40a:	0f be f0             	movsbl %al,%esi
 40d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 410:	89 d0                	mov    %edx,%eax
 412:	c1 e0 03             	shl    $0x3,%eax
 415:	01 d0                	add    %edx,%eax
 417:	c1 e0 02             	shl    $0x2,%eax
 41a:	8d 4d e8             	lea    -0x18(%ebp),%ecx
 41d:	01 c8                	add    %ecx,%eax
 41f:	2d f8 08 00 00       	sub    $0x8f8,%eax
 424:	8b 18                	mov    (%eax),%ebx
 426:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 429:	89 d0                	mov    %edx,%eax
 42b:	c1 e0 03             	shl    $0x3,%eax
 42e:	01 d0                	add    %edx,%eax
 430:	c1 e0 02             	shl    $0x2,%eax
 433:	8d 4d e8             	lea    -0x18(%ebp),%ecx
 436:	01 c8                	add    %ecx,%eax
 438:	2d 00 09 00 00       	sub    $0x900,%eax
 43d:	8b 08                	mov    (%eax),%ecx
 43f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 442:	89 d0                	mov    %edx,%eax
 444:	c1 e0 03             	shl    $0x3,%eax
 447:	01 d0                	add    %edx,%eax
 449:	c1 e0 02             	shl    $0x2,%eax
 44c:	8d 55 e8             	lea    -0x18(%ebp),%edx
 44f:	01 d0                	add    %edx,%eax
 451:	2d fc 08 00 00       	sub    $0x8fc,%eax
 456:	8b 00                	mov    (%eax),%eax
 458:	89 7c 24 18          	mov    %edi,0x18(%esp)
 45c:	89 74 24 14          	mov    %esi,0x14(%esp)
 460:	89 5c 24 10          	mov    %ebx,0x10(%esp)
 464:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
 468:	89 44 24 08          	mov    %eax,0x8(%esp)
 46c:	c7 44 24 04 cd 05 00 	movl   $0x5cd,0x4(%esp)
 473:	00 
 474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 47b:	e8 80 fb ff ff       	call   0 <printf>
  for (i = 0; i < NPROC; ++i) {
 480:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
 484:	83 7d e4 3f          	cmpl   $0x3f,-0x1c(%ebp)
 488:	0f 8e 28 ff ff ff    	jle    3b6 <ps+0x41>
    }
  }
 48e:	81 c4 3c 09 00 00    	add    $0x93c,%esp
 494:	5b                   	pop    %ebx
 495:	5e                   	pop    %esi
 496:	5f                   	pop    %edi
 497:	5d                   	pop    %ebp
...
00000541 <getpinfo>:
SYSCALL(getpinfo)
 541:	b8 16 00 00 00       	mov    $0x16,%eax
 546:	cd 40                	int    $0x40
 548:	c3                   	ret    

00000549 <settickets>:
 549:	b8 17 00 00 00       	mov    $0x17,%eax
 54e:	cd 40                	int    $0x40
 550:	c3                   	ret    
