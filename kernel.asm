...
80100049:	e8 dd 4f 00 00       	call   8010502b <initlock>
...
80100092:	e8 31 4e 00 00       	call   80104ec8 <initsleeplock>
...
801000c9:	e8 7e 4f 00 00       	call   8010504c <acquire>
...
80100104:	e8 ab 4f 00 00       	call   801050b4 <release>
      acquiresleep(&b->lock);
80100109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010010c:	83 c0 0c             	add    $0xc,%eax
8010010f:	89 04 24             	mov    %eax,(%esp)
80100112:	e8 eb 4d 00 00       	call   80104f02 <acquiresleep>
      return b;
...
8010017d:	e8 32 4f 00 00       	call   801050b4 <release>
      acquiresleep(&b->lock);
80100182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100185:	83 c0 0c             	add    $0xc,%eax
80100188:	89 04 24             	mov    %eax,(%esp)
8010018b:	e8 72 4d 00 00       	call   80104f02 <acquiresleep>
      return b;
...
801001fb:	e8 9f 4d 00 00       	call   80104f9f <holdingsleep>
...
8010023b:	e8 5f 4d 00 00       	call   80104f9f <holdingsleep>
...
80100259:	e8 ff 4c 00 00       	call   80104f5d <releasesleep>

  acquire(&bcache.lock);
8010025e:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100265:	e8 e2 4d 00 00       	call   8010504c <acquire>
  b->refcnt--;
...
801002d1:	e8 de 4d 00 00       	call   801050b4 <release>
}
801002d6:	c9                   	leave  
801002d7:	c3                   	ret    
...
801003e3:	e8 64 4c 00 00       	call   8010504c <acquire>
...
8010055b:	e8 54 4b 00 00       	call   801050b4 <release>
}
80100560:	c9                   	leave  
80100561:	c3                   	ret    
...
801005b0:	e8 4a 4b 00 00       	call   801050ff <getcallerpcs>
  for(i=0; i<10; i++)
...
801006ee:	e8 9a 4c 00 00       	call   8010538d <memmove>
    pos -= 80;
...
8010071d:	e8 9c 4b 00 00       	call   801052be <memset>
  }
...
801007b2:	e8 9c 64 00 00       	call   80106c53 <uartputc>
801007b7:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801007be:	e8 90 64 00 00       	call   80106c53 <uartputc>
...
801007fd:	e8 4a 48 00 00       	call   8010504c <acquire>
  while((c = getc()) >= 0){
...
80100938:	e8 2e 42 00 00       	call   80104b6b <wakeup>
        }
      }
      break;
...
80100959:	e8 56 47 00 00       	call   801050b4 <release>
  if(doprocdump) {
8010095e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80100962:	74 05                	je     80100969 <consoleintr+0x180>
    procdump();  // now call procdump() wo. cons.lock held
80100964:	e8 a8 42 00 00       	call   80104c11 <procdump>
  }
}
80100969:	c9                   	leave  
8010096a:	c3                   	ret    
...
80100989:	e8 be 46 00 00       	call   8010504c <acquire>
  while(n > 0){
...
801009a8:	e8 07 47 00 00       	call   801050b4 <release>
        ilock(ip);
...
801009d1:	e8 be 40 00 00       	call   80104a94 <sleep>
    while(input.r == input.w){
...
80100a4d:	e8 62 46 00 00       	call   801050b4 <release>
  ilock(ip);
...
80100a81:	e8 c6 45 00 00       	call   8010504c <acquire>
  for(i = 0; i < n; i++)
...
80100abb:	e8 f4 45 00 00       	call   801050b4 <release>
  ilock(ip);
...
80100ae5:	e8 41 45 00 00       	call   8010502b <initlock>
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 95 70 00 00       	call   80107c50 <setupkvm>
...
80100c74:	e8 ad 73 00 00       	call   80108026 <allocuvm>
...
80100cc6:	e8 78 72 00 00       	call   80107f43 <loaduvm>
...
80100d34:	e8 ed 72 00 00       	call   80108026 <allocuvm>
...
80100d59:	e8 3b 75 00 00       	call   80108299 <clearpteu>
  sp = sz;
...
80100d8f:	e8 94 47 00 00       	call   80105528 <strlen>
...
80100db8:	e8 6b 47 00 00       	call   80105528 <strlen>
...
80100de8:	e8 6f 76 00 00       	call   8010845c <copyout>
...
80100e8f:	e8 c8 75 00 00       	call   8010845c <copyout>
...
80100ee4:	e8 f5 45 00 00       	call   801054de <safestrcpy>
...
80100f24:	e8 01 6e 00 00       	call   80107d2a <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 ce 72 00 00       	call   80108202 <freevm>
  return 0;
...
80100f47:	e8 b6 72 00 00       	call   80108202 <freevm>
  if(ip){
...
80100f7e:	e8 a8 40 00 00       	call   8010502b <initlock>
}
80100f83:	c9                   	leave  
80100f84:	c3                   	ret    
...
80100f92:	e8 b5 40 00 00       	call   8010504c <acquire>
...
80100fbb:	e8 f4 40 00 00       	call   801050b4 <release>
      return f;
...
80100fd9:	e8 d6 40 00 00       	call   801050b4 <release>
  return 0;
...
80100ff2:	e8 55 40 00 00       	call   8010504c <acquire>
  if(f->ref < 1)
...
80101023:	e8 8c 40 00 00       	call   801050b4 <release>
  return f;
...
8010103a:	e8 0d 40 00 00       	call   8010504c <acquire>
  if(f->ref < 1)
...
80101075:	e8 3a 40 00 00       	call   801050b4 <release>
...
801010bf:	e8 f0 3f 00 00       	call   801050b4 <release>
...
80101384:	e8 04 40 00 00       	call   8010538d <memmove>
  brelse(bp);
...
801013ca:	e8 ef 3e 00 00       	call   801052be <memset>
  log_write(bp);
...
8010160f:	e8 17 3a 00 00       	call   8010502b <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101640:	e8 83 38 00 00       	call   80104ec8 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
80101732:	e8 87 3b 00 00       	call   801052be <memset>
      dip->type = type;
...
80101839:	e8 4f 3b 00 00       	call   8010538d <memmove>
  log_write(bp);
...
80101863:	e8 e4 37 00 00       	call   8010504c <acquire>
...
801018ad:	e8 02 38 00 00       	call   801050b4 <release>
      return ip;
...
80101921:	e8 8e 37 00 00       	call   801050b4 <release>
...
80101938:	e8 0f 37 00 00       	call   8010504c <acquire>
  ip->ref++;
...
80101953:	e8 5c 37 00 00       	call   801050b4 <release>
  return ip;
...
80101988:	e8 75 35 00 00       	call   80104f02 <acquiresleep>
...
80101a36:	e8 52 39 00 00       	call   8010538d <memmove>
    brelse(bp);
...
80101a7f:	e8 1b 35 00 00       	call   80104f9f <holdingsleep>
...
80101aa7:	e8 b1 34 00 00       	call   80104f5d <releasesleep>
}
80101aac:	c9                   	leave  
80101aad:	c3                   	ret    
...
80101abd:	e8 40 34 00 00       	call   80104f02 <acquiresleep>
...
80101adf:	e8 68 35 00 00       	call   8010504c <acquire>
    int r = ip->ref;
...
80101af4:	e8 bb 35 00 00       	call   801050b4 <release>
    if(r == 1){
...
80101b31:	e8 27 34 00 00       	call   80104f5d <releasesleep>

  acquire(&icache.lock);
80101b36:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
80101b3d:	e8 0a 35 00 00       	call   8010504c <acquire>
  ip->ref--;
...
80101b58:	e8 57 35 00 00       	call   801050b4 <release>
}
80101b5d:	c9                   	leave  
80101b5e:	c3                   	ret    
...
80101f2b:	e8 5d 34 00 00       	call   8010538d <memmove>
    brelse(bp);
...
8010208a:	e8 fe 32 00 00       	call   8010538d <memmove>
    log_write(bp);
...
80102108:	e8 23 33 00 00       	call   80105430 <strncmp>
}
8010210d:	c9                   	leave  
8010210e:	c3                   	ret    
...
8010228a:	e8 f7 31 00 00       	call   80105486 <strncpy>
  de.inum = inum;
...
80102341:	e8 47 30 00 00       	call   8010538d <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010235c:	e8 2c 30 00 00       	call   8010538d <memmove>
    name[len] = 0;
...
801025b9:	e8 6d 2a 00 00       	call   8010502b <initlock>
...
801027d5:	e8 72 28 00 00       	call   8010504c <acquire>
...
801027ef:	e8 c0 28 00 00       	call   801050b4 <release>
    return;
...
80102862:	e8 04 23 00 00       	call   80104b6b <wakeup>
...
80102884:	e8 2b 28 00 00       	call   801050b4 <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
...
8010289a:	e8 00 27 00 00       	call   80104f9f <holdingsleep>
...
801028ee:	e8 59 27 00 00       	call   8010504c <acquire>
...
80102949:	e8 46 21 00 00       	call   80104a94 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102962:	e8 4d 27 00 00       	call   801050b4 <release>
}
80102967:	c9                   	leave  
80102968:	c3                   	ret    
...
80102a93:	e8 93 25 00 00       	call   8010502b <initlock>
  kmem.use_lock = 0;
...
80102b5f:	e8 5a 27 00 00       	call   801052be <memset>
...
80102b74:	e8 d3 24 00 00       	call   8010504c <acquire>
  r = (struct run*)v;
...
80102ba2:	e8 0d 25 00 00       	call   801050b4 <release>
}
80102ba7:	c9                   	leave  
80102ba8:	c3                   	ret    
...
80102bbf:	e8 88 24 00 00       	call   8010504c <acquire>
  r = kmem.freelist;
...
80102bec:	e8 c3 24 00 00       	call   801050b4 <release>
  return (char*)r;
...
80103189:	e8 a7 21 00 00       	call   80105335 <memcmp>
...
80103298:	e8 8e 1d 00 00       	call   8010502b <initlock>
  readsb(dev, &sb);
...
80103342:	e8 46 20 00 00       	call   8010538d <memmove>
...
80103494:	e8 b3 1b 00 00       	call   8010504c <acquire>
  while(1){
    if(log.committing){
...
801034b1:	e8 de 15 00 00       	call   80104a94 <sleep>
...
801034e5:	e8 aa 15 00 00       	call   80104a94 <sleep>
...
80103500:	e8 af 1b 00 00       	call   801050b4 <release>
      break;
...
8010351f:	e8 28 1b 00 00       	call   8010504c <acquire>
  log.outstanding -= 1;
...
80103569:	e8 fd 15 00 00       	call   80104b6b <wakeup>
  }
  release(&log.lock);
8010356e:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103575:	e8 3a 1b 00 00       	call   801050b4 <release>
...
80103629:	e8 5f 1d 00 00       	call   8010538d <memmove>
...
801036dc:	e8 6b 19 00 00       	call   8010504c <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103753:	e8 5c 19 00 00       	call   801050b4 <release>
}
80103758:	c9                   	leave  
80103759:	c3                   	ret    
...
801037b4:	e8 96 33 00 00       	call   80106b4f <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 55 2f 00 00       	call   80106718 <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 10 45 00 00       	call   80107d10 <switchkvm>
  seginit();
80103800:	e8 c0 3f 00 00       	call   801077c5 <seginit>
  lapicinit();
...
80103836:	e8 51 30 00 00       	call   8010688c <idtinit>
...
80103855:	e8 ed 0f 00 00       	call   80104847 <scheduler>
...
8010387e:	e8 0a 1b 00 00       	call   8010538d <memmove>
...
801039ca:	e8 66 19 00 00       	call   80105335 <memcmp>
...
80103b08:	e8 28 18 00 00       	call   80105335 <memcmp>
...
80103d88:	e8 9e 12 00 00       	call   8010502b <initlock>
  (*f0)->type = FD_PIPE;
...
80103e34:	e8 13 12 00 00       	call   8010504c <acquire>
  if(writable){
...
80103e57:	e8 0f 0d 00 00       	call   80104b6b <wakeup>
...
80103e76:	e8 f0 0c 00 00       	call   80104b6b <wakeup>
  }
...
80103e9b:	e8 14 12 00 00       	call   801050b4 <release>
    kfree((char*)p);
...
80103eb3:	e8 fc 11 00 00       	call   801050b4 <release>
}
80103eb8:	c9                   	leave  
80103eb9:	c3                   	ret    
...
80103ec6:	e8 81 11 00 00       	call   8010504c <acquire>
  for(i = 0; i < n; i++){
...
80103ef8:	e8 b7 11 00 00       	call   801050b4 <release>
        return -1;
...
80103f12:	e8 54 0c 00 00       	call   80104b6b <wakeup>
...
80103f2a:	e8 65 0b 00 00       	call   80104a94 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103f93:	e8 d3 0b 00 00       	call   80104b6b <wakeup>
  release(&p->lock);
80103f98:	8b 45 08             	mov    0x8(%ebp),%eax
80103f9b:	89 04 24             	mov    %eax,(%esp)
80103f9e:	e8 11 11 00 00       	call   801050b4 <release>
  return n;
...
80103fb5:	e8 92 10 00 00       	call   8010504c <acquire>
...
80103fce:	e8 e1 10 00 00       	call   801050b4 <release>
      return -1;
...
80103ff0:	e8 9f 0a 00 00       	call   80104a94 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010407f:	e8 e7 0a 00 00       	call   80104b6b <wakeup>
  release(&p->lock);
80104084:	8b 45 08             	mov    0x8(%ebp),%eax
80104087:	89 04 24             	mov    %eax,(%esp)
8010408a:	e8 25 10 00 00       	call   801050b4 <release>
  return i;
...
801040bb:	80 
801040bc:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801040c3:	e8 63 0f 00 00       	call   8010502b <initlock>
}
801040c8:	c9                   	leave  
801040c9:	c3                   	ret    
...
801040d7:	b8 20 38 11 80       	mov    $0x80113820,%eax
...
80104125:	05 20 38 11 80       	add    $0x80113820,%eax
...
8010413e:	05 20 38 11 80       	add    $0x80113820,%eax
80104143:	eb 1a                	jmp    8010415f <mycpu+0x74>
  for (i = 0; i < ncpu; ++i) {
80104145:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104149:	a1 a0 3d 11 80       	mov    0x80113da0,%eax
...
80104164:	83 ec 18             	sub    $0x18,%esp
  ...
  struct proc *p;
  pushcli();
80104167:	e8 4d 10 00 00       	call   801051b9 <pushcli>
  c = mycpu();
...
8010417d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  popcli();
80104180:	e8 80 10 00 00       	call   80105205 <popcli>
  return p;
...
8010418d:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104190:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104197:	e8 b0 0e 00 00       	call   8010504c <acquire>

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010419c:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
801041cb:	89 42 10             	mov    %eax,0x10(%edx)
  ...
  release(&ptable.lock);
801041ce:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801041d5:	e8 da 0e 00 00       	call   801050b4 <release>
...
801041f8:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
801041ff:	72 a4                	jb     801041a5 <allocproc+0x1b>
  release(&ptable.lock);
80104201:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104208:	e8 a7 0e 00 00       	call   801050b4 <release>
  return 0;
...
80104244:	ba d3 66 10 80       	mov    $0x801066d3,%edx
...
80104274:	e8 45 10 00 00       	call   801052be <memset>
  p->context->eip = (uint)forkret;
80104279:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010427c:	8b 40 1c             	mov    0x1c(%eax),%eax
8010427f:	ba 55 4a 10 80       	mov    $0x80104a55,%edx
...
8010429d:	a3 40 b6 10 80       	mov    %eax,0x8010b640
  if((p->pgdir = setupkvm()) == 0)
801042a2:	e8 a9 39 00 00       	call   80107c50 <setupkvm>
...
801042d2:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
801042d9:	80 
801042da:	89 04 24             	mov    %eax,(%esp)
801042dd:	e8 d9 3b 00 00       	call   80107ebb <inituvm>
  p->sz = PGSIZE;
...
80104304:	e8 b5 0f 00 00       	call   801052be <memset>
...
8010437d:	00 
8010437e:	c7 44 24 04 8f 88 10 	movl   $0x8010888f,0x4(%esp)
80104385:	80 
80104386:	89 04 24             	mov    %eax,(%esp)
80104389:	e8 50 11 00 00       	call   801054de <safestrcpy>
  p->cwd = namei("/");
8010438e:	c7 04 24 98 88 10 80 	movl   $0x80108898,(%esp)
...
8010439d:	89 42 68             	mov    %eax,0x68(%edx)
  ...
  acquire(&ptable.lock);
801043a0:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801043a7:	e8 a0 0c 00 00       	call   8010504c <acquire>
...
801043c6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
801043cd:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801043d4:	e8 db 0c 00 00       	call   801050b4 <release>
}
801043d9:	c9                   	leave  
801043da:	c3                   	ret    
...
80104413:	e8 0e 3c 00 00       	call   80108026 <allocuvm>
...
8010444a:	e8 ed 3c 00 00       	call   8010813c <deallocuvm>
...
8010446d:	e8 b8 38 00 00       	call   80107d2a <switchuvm>
  return 0;
...
801044b4:	e8 26 3e 00 00       	call   801082df <copyuvm>
...
801045a5:	e8 34 0f 00 00       	call   801054de <safestrcpy>
...
801045b0:	89 45 d8             	mov    %eax,-0x28(%ebp)
  ...
  acquire(&ptable.lock);
801045b3:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801045ba:	e8 8d 0a 00 00       	call   8010504c <acquire>
...
801045e9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
801045f0:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801045f7:	e8 b8 0a 00 00       	call   801050b4 <release>
...
80104612:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  if(curproc == initproc)
80104615:	a1 40 b6 10 80       	mov    0x8010b640,%eax
8010461a:	39 45 ec             	cmp    %eax,-0x14(%ebp)
8010461d:	75 0c                	jne    8010462b <exit+0x24>
    panic("init exiting");
8010461f:	c7 04 24 9a 88 10 80 	movl   $0x8010889a,(%esp)
...
80104690:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  acquire(&ptable.lock);
80104697:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
8010469e:	e8 a9 09 00 00       	call   8010504c <acquire>
...
801046ac:	e8 79 04 00 00       	call   80104b2a <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046b1:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
801046c3:	75 24                	jne    801046e9 <exit+0xe2>
      p->parent = initproc;
801046c5:	8b 15 40 b6 10 80    	mov    0x8010b640,%edx
...
801046da:	75 0d                	jne    801046e9 <exit+0xe2>
        wakeup1(initproc);
801046dc:	a1 40 b6 10 80       	mov    0x8010b640,%eax
801046e1:	89 04 24             	mov    %eax,(%esp)
801046e4:	e8 41 04 00 00       	call   80104b2a <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046e9:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
801046f0:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
...
801046fc:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104703:	e8 6d 02 00 00       	call   80104975 <sched>
  panic("zombie exit");
80104708:	c7 04 24 a7 88 10 80 	movl   $0x801088a7,(%esp)
...
8010471f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  acquire(&ptable.lock);
80104722:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104729:	e8 1e 09 00 00       	call   8010504c <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
8010472e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104735:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
8010478d:	e8 70 3a 00 00       	call   80108202 <freevm>
        p->pid = 0;
...
801047ba:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        release(&ptable.lock);
801047c1:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801047c8:	e8 e7 08 00 00       	call   801050b4 <release>
        return pid;
801047cd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801047d0:	eb 4f                	jmp    80104821 <wait+0x10d>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047d2:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
801047d9:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
...
801047f4:	74 13                	je     80104809 <wait+0xf5>
      release(&ptable.lock);
801047f6:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801047fd:	e8 b2 08 00 00       	call   801050b4 <release>
      return -1;
...
80104809:	c7 44 24 04 c0 3d 11 	movl   $0x80113dc0,0x4(%esp)
80104810:	80 
80104811:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104814:	89 04 24             	mov    %eax,(%esp)
80104817:	e8 78 02 00 00       	call   80104a94 <sleep>
  }
...
80104826:	a1 04 b0 10 80       	mov    0x8010b004,%eax
8010482b:	69 c0 6d 4e c6 41    	imul   $0x41c64e6d,%eax,%eax
80104831:	05 39 30 00 00       	add    $0x3039,%eax
80104836:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
8010483b:	a3 04 b0 10 80       	mov    %eax,0x8010b004
80104840:	a1 04 b0 10 80       	mov    0x8010b004,%eax
}
80104845:	5d                   	pop    %ebp
80104846:	c3                   	ret    
...
8010484a:	83 ec 38             	sub    $0x38,%esp
  struct proc *p;
  struct cpu *c = mycpu();
8010484d:	e8 99 f8 ff ff       	call   801040eb <mycpu>
80104852:	89 45 e8             	mov    %eax,-0x18(%ebp)
  c->proc = 0;
80104855:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104858:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010485f:	00 00 00 
  
  for(;;){
    // Enable interrupts on this processor.
    sti();
80104862:	e8 41 f8 ff ff       	call   801040a8 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104867:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
8010486e:	e8 d9 07 00 00       	call   8010504c <acquire>

    int totalTickets = 0;
80104873:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

    for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
8010487a:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104881:	eb 1b                	jmp    8010489e <scheduler+0x57>
      if (p->state == RUNNABLE) totalTickets += p->tickets;
80104883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104886:	8b 40 0c             	mov    0xc(%eax),%eax
80104889:	83 f8 03             	cmp    $0x3,%eax
8010488c:	75 09                	jne    80104897 <scheduler+0x50>
8010488e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104891:	8b 40 7c             	mov    0x7c(%eax),%eax
80104894:	01 45 f0             	add    %eax,-0x10(%ebp)
    for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
80104897:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010489e:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
801048a5:	72 dc                	jb     80104883 <scheduler+0x3c>
    }

    if (totalTickets > 0) {
801048a7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801048ab:	0f 8e b3 00 00 00    	jle    80104964 <scheduler+0x11d>
      int winner = random() % totalTickets;
801048b1:	e8 6d ff ff ff       	call   80104823 <random>
801048b6:	99                   	cltd   
801048b7:	f7 7d f0             	idivl  -0x10(%ebp)
801048ba:	89 55 e4             	mov    %edx,-0x1c(%ebp)
      int ticketCounter = 0;
801048bd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801048c4:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
801048cb:	e9 87 00 00 00       	jmp    80104957 <scheduler+0x110>
        if(p->state != RUNNABLE)
801048d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d3:	8b 40 0c             	mov    0xc(%eax),%eax
801048d6:	83 f8 03             	cmp    $0x3,%eax
801048d9:	74 02                	je     801048dd <scheduler+0x96>
          continue;
801048db:	eb 73                	jmp    80104950 <scheduler+0x109>

        ticketCounter += p->tickets;
801048dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048e0:	8b 40 7c             	mov    0x7c(%eax),%eax
801048e3:	01 45 ec             	add    %eax,-0x14(%ebp)

        if (ticketCounter > winner) {
801048e6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801048e9:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
801048ec:	7e 62                	jle    80104950 <scheduler+0x109>
...
801048f4:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
          switchuvm(p);
801048fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048fd:	89 04 24             	mov    %eax,(%esp)
80104900:	e8 25 34 00 00       	call   80107d2a <switchuvm>
          p->state = RUNNING;
80104905:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104908:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
          p->ticks++;
8010490f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104912:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104918:	8d 50 01             	lea    0x1(%eax),%edx
8010491b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010491e:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)

          swtch(&(c->scheduler), p->context);
80104924:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104927:	8b 40 1c             	mov    0x1c(%eax),%eax
8010492a:	8b 55 e8             	mov    -0x18(%ebp),%edx
8010492d:	83 c2 04             	add    $0x4,%edx
80104930:	89 44 24 04          	mov    %eax,0x4(%esp)
80104934:	89 14 24             	mov    %edx,(%esp)
80104937:	e8 13 0c 00 00       	call   8010554f <swtch>
          switchkvm();
8010493c:	e8 cf 33 00 00       	call   80107d10 <switchkvm>

          // Process is done running for now.
          // It should have changed its p->state before coming back.
          c->proc = 0;
80104941:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104944:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010494b:	00 00 00 
          break;
8010494e:	eb 14                	jmp    80104964 <scheduler+0x11d>
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104950:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104957:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
8010495e:	0f 82 6c ff ff ff    	jb     801048d0 <scheduler+0x89>
        }
      }
    }

    release(&ptable.lock);
80104964:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
8010496b:	e8 44 07 00 00       	call   801050b4 <release>

  }
80104970:	e9 ed fe ff ff       	jmp    80104862 <scheduler+0x1b>
...
80104978:	83 ec 28             	sub    $0x28,%esp
  int intena;
  struct proc *p = myproc();
8010497b:	e8 e1 f7 ff ff       	call   80104161 <myproc>
80104980:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(!holding(&ptable.lock))
80104983:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
8010498a:	e8 e9 07 00 00       	call   80105178 <holding>
8010498f:	85 c0                	test   %eax,%eax
80104991:	75 0c                	jne    8010499f <sched+0x2a>
    panic("sched ptable.lock");
80104993:	c7 04 24 b3 88 10 80 	movl   $0x801088b3,(%esp)
8010499a:	e8 c3 bb ff ff       	call   80100562 <panic>
  if(mycpu()->ncli != 1)
8010499f:	e8 47 f7 ff ff       	call   801040eb <mycpu>
801049a4:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801049aa:	83 f8 01             	cmp    $0x1,%eax
801049ad:	74 0c                	je     801049bb <sched+0x46>
    panic("sched locks");
801049af:	c7 04 24 c5 88 10 80 	movl   $0x801088c5,(%esp)
801049b6:	e8 a7 bb ff ff       	call   80100562 <panic>
  if(p->state == RUNNING)
801049bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049be:	8b 40 0c             	mov    0xc(%eax),%eax
801049c1:	83 f8 04             	cmp    $0x4,%eax
801049c4:	75 0c                	jne    801049d2 <sched+0x5d>
    panic("sched running");
801049c6:	c7 04 24 d1 88 10 80 	movl   $0x801088d1,(%esp)
801049cd:	e8 90 bb ff ff       	call   80100562 <panic>
  if(readeflags()&FL_IF)
801049d2:	e8 c1 f6 ff ff       	call   80104098 <readeflags>
801049d7:	25 00 02 00 00       	and    $0x200,%eax
801049dc:	85 c0                	test   %eax,%eax
801049de:	74 0c                	je     801049ec <sched+0x77>
    panic("sched interruptible");
801049e0:	c7 04 24 df 88 10 80 	movl   $0x801088df,(%esp)
801049e7:	e8 76 bb ff ff       	call   80100562 <panic>
  intena = mycpu()->intena;
801049ec:	e8 fa f6 ff ff       	call   801040eb <mycpu>
801049f1:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801049f7:	89 45 f0             	mov    %eax,-0x10(%ebp)
  swtch(&p->context, mycpu()->scheduler);
801049fa:	e8 ec f6 ff ff       	call   801040eb <mycpu>
801049ff:	8b 40 04             	mov    0x4(%eax),%eax
80104a02:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a05:	83 c2 1c             	add    $0x1c,%edx
80104a08:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a0c:	89 14 24             	mov    %edx,(%esp)
80104a0f:	e8 3b 0b 00 00       	call   8010554f <swtch>
  mycpu()->intena = intena;
80104a14:	e8 d2 f6 ff ff       	call   801040eb <mycpu>
80104a19:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a1c:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
}
80104a22:	c9                   	leave  
80104a23:	c3                   	ret    
...
80104a2a:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a31:	e8 16 06 00 00       	call   8010504c <acquire>
  myproc()->state = RUNNABLE;
80104a36:	e8 26 f7 ff ff       	call   80104161 <myproc>
80104a3b:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a42:	e8 2e ff ff ff       	call   80104975 <sched>
  release(&ptable.lock);
80104a47:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a4e:	e8 61 06 00 00       	call   801050b4 <release>
}
80104a53:	c9                   	leave  
80104a54:	c3                   	ret    
...
80104a58:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a5b:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a62:	e8 4d 06 00 00       	call   801050b4 <release>

  if (first) {
80104a67:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104a6c:	85 c0                	test   %eax,%eax
80104a6e:	74 22                	je     80104a92 <forkret+0x3d>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot
    // be run from main().
    first = 0;
80104a70:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104a77:	00 00 00 
    iinit(ROOTDEV);
80104a7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104a81:	e8 6a cb ff ff       	call   801015f0 <iinit>
    initlog(ROOTDEV);
80104a86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104a8d:	e8 f1 e7 ff ff       	call   80103283 <initlog>
  }
...
80104a97:	83 ec 28             	sub    $0x28,%esp
  struct proc *p = myproc();
80104a9a:	e8 c2 f6 ff ff       	call   80104161 <myproc>
80104a9f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  if(p == 0)
80104aa2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104aa6:	75 0c                	jne    80104ab4 <sleep+0x20>
    panic("sleep");
80104aa8:	c7 04 24 f3 88 10 80 	movl   $0x801088f3,(%esp)
80104aaf:	e8 ae ba ff ff       	call   80100562 <panic>

  if(lk == 0)
80104ab4:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104ab8:	75 0c                	jne    80104ac6 <sleep+0x32>
    panic("sleep without lk");
80104aba:	c7 04 24 f9 88 10 80 	movl   $0x801088f9,(%esp)
80104ac1:	e8 9c ba ff ff       	call   80100562 <panic>
...
80104ac6:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
80104acd:	74 17                	je     80104ae6 <sleep+0x52>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104acf:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104ad6:	e8 71 05 00 00       	call   8010504c <acquire>
    release(lk);
80104adb:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ade:	89 04 24             	mov    %eax,(%esp)
80104ae1:	e8 ce 05 00 00       	call   801050b4 <release>
  }
  // Go to sleep.
  p->chan = chan;
80104ae6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ae9:	8b 55 08             	mov    0x8(%ebp),%edx
80104aec:	89 50 20             	mov    %edx,0x20(%eax)
  p->state = SLEEPING;
80104aef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af2:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)

  sched();
80104af9:	e8 77 fe ff ff       	call   80104975 <sched>

  // Tidy up.
  p->chan = 0;
80104afe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b01:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104b08:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
80104b0f:	74 17                	je     80104b28 <sleep+0x94>
    release(&ptable.lock);
80104b11:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104b18:	e8 97 05 00 00       	call   801050b4 <release>
    acquire(lk);
80104b1d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b20:	89 04 24             	mov    %eax,(%esp)
80104b23:	e8 24 05 00 00       	call   8010504c <acquire>
  }
}
80104b28:	c9                   	leave  
80104b29:	c3                   	ret    
...
80104b2d:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b30:	c7 45 fc f4 3d 11 80 	movl   $0x80113df4,-0x4(%ebp)
80104b37:	eb 27                	jmp    80104b60 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104b39:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b3c:	8b 40 0c             	mov    0xc(%eax),%eax
80104b3f:	83 f8 02             	cmp    $0x2,%eax
80104b42:	75 15                	jne    80104b59 <wakeup1+0x2f>
80104b44:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b47:	8b 40 20             	mov    0x20(%eax),%eax
80104b4a:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b4d:	75 0a                	jne    80104b59 <wakeup1+0x2f>
      p->state = RUNNABLE;
80104b4f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b52:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b59:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
80104b60:	81 7d fc f4 5e 11 80 	cmpl   $0x80115ef4,-0x4(%ebp)
80104b67:	72 d0                	jb     80104b39 <wakeup1+0xf>
}
80104b69:	c9                   	leave  
80104b6a:	c3                   	ret    
...
80104b6e:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b71:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104b78:	e8 cf 04 00 00       	call   8010504c <acquire>
  wakeup1(chan);
80104b7d:	8b 45 08             	mov    0x8(%ebp),%eax
80104b80:	89 04 24             	mov    %eax,(%esp)
80104b83:	e8 a2 ff ff ff       	call   80104b2a <wakeup1>
  release(&ptable.lock);
80104b88:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104b8f:	e8 20 05 00 00       	call   801050b4 <release>
}
80104b94:	c9                   	leave  
80104b95:	c3                   	ret    
...
80104b99:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104b9c:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104ba3:	e8 a4 04 00 00       	call   8010504c <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ba8:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104baf:	eb 44                	jmp    80104bf5 <kill+0x5f>
    if(p->pid == pid){
80104bb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb4:	8b 40 10             	mov    0x10(%eax),%eax
80104bb7:	3b 45 08             	cmp    0x8(%ebp),%eax
80104bba:	75 32                	jne    80104bee <kill+0x58>
      p->killed = 1;
80104bbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bbf:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104bc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bc9:	8b 40 0c             	mov    0xc(%eax),%eax
80104bcc:	83 f8 02             	cmp    $0x2,%eax
80104bcf:	75 0a                	jne    80104bdb <kill+0x45>
        p->state = RUNNABLE;
80104bd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bd4:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104bdb:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104be2:	e8 cd 04 00 00       	call   801050b4 <release>
      return 0;
80104be7:	b8 00 00 00 00       	mov    $0x0,%eax
80104bec:	eb 21                	jmp    80104c0f <kill+0x79>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bee:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104bf5:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
80104bfc:	72 b3                	jb     80104bb1 <kill+0x1b>
    }
  }
  release(&ptable.lock);
80104bfe:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104c05:	e8 aa 04 00 00       	call   801050b4 <release>
  return -1;
...
80104c14:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c17:	c7 45 f0 f4 3d 11 80 	movl   $0x80113df4,-0x10(%ebp)
80104c1e:	e9 d9 00 00 00       	jmp    80104cfc <procdump+0xeb>
    if(p->state == UNUSED)
80104c23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c26:	8b 40 0c             	mov    0xc(%eax),%eax
80104c29:	85 c0                	test   %eax,%eax
80104c2b:	75 05                	jne    80104c32 <procdump+0x21>
      continue;
80104c2d:	e9 c3 00 00 00       	jmp    80104cf5 <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104c32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c35:	8b 40 0c             	mov    0xc(%eax),%eax
80104c38:	83 f8 05             	cmp    $0x5,%eax
80104c3b:	77 23                	ja     80104c60 <procdump+0x4f>
80104c3d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c40:	8b 40 0c             	mov    0xc(%eax),%eax
80104c43:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c4a:	85 c0                	test   %eax,%eax
80104c4c:	74 12                	je     80104c60 <procdump+0x4f>
      state = states[p->state];
80104c4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c51:	8b 40 0c             	mov    0xc(%eax),%eax
80104c54:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c5b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104c5e:	eb 07                	jmp    80104c67 <procdump+0x56>
    else
      state = "???";
80104c60:	c7 45 ec 0a 89 10 80 	movl   $0x8010890a,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104c67:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c6a:	8d 50 6c             	lea    0x6c(%eax),%edx
80104c6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c70:	8b 40 10             	mov    0x10(%eax),%eax
80104c73:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104c77:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104c7a:	89 54 24 08          	mov    %edx,0x8(%esp)
80104c7e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c82:	c7 04 24 0e 89 10 80 	movl   $0x8010890e,(%esp)
80104c89:	e8 3a b7 ff ff       	call   801003c8 <cprintf>
    if(p->state == SLEEPING){
80104c8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c91:	8b 40 0c             	mov    0xc(%eax),%eax
80104c94:	83 f8 02             	cmp    $0x2,%eax
80104c97:	75 50                	jne    80104ce9 <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104c99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c9c:	8b 40 1c             	mov    0x1c(%eax),%eax
80104c9f:	8b 40 0c             	mov    0xc(%eax),%eax
80104ca2:	83 c0 08             	add    $0x8,%eax
80104ca5:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104ca8:	89 54 24 04          	mov    %edx,0x4(%esp)
80104cac:	89 04 24             	mov    %eax,(%esp)
80104caf:	e8 4b 04 00 00       	call   801050ff <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cb4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104cbb:	eb 1b                	jmp    80104cd8 <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104cbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cc0:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104cc4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cc8:	c7 04 24 17 89 10 80 	movl   $0x80108917,(%esp)
80104ccf:	e8 f4 b6 ff ff       	call   801003c8 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cd4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104cd8:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104cdc:	7f 0b                	jg     80104ce9 <procdump+0xd8>
80104cde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ce1:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ce5:	85 c0                	test   %eax,%eax
80104ce7:	75 d4                	jne    80104cbd <procdump+0xac>
    }
    cprintf("\n");
80104ce9:	c7 04 24 1b 89 10 80 	movl   $0x8010891b,(%esp)
80104cf0:	e8 d3 b6 ff ff       	call   801003c8 <cprintf>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cf5:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104cfc:	81 7d f0 f4 5e 11 80 	cmpl   $0x80115ef4,-0x10(%ebp)
80104d03:	0f 82 1a ff ff ff    	jb     80104c23 <procdump+0x12>
  }
}
80104d09:	c9                   	leave  
80104d0a:	c3                   	ret    
...
80104d0f:	83 ec 24             	sub    $0x24,%esp
  struct proc* p;
  int i = 0;
80104d12:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  for(p = ptable.proc; p < &ptable.proc[NPROC]; ++p, ++i) {
80104d19:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104d20:	e9 65 01 00 00       	jmp    80104e8a <getpinfo+0x17f>
...
80104d2d:	0f 95 c0             	setne  %al
80104d30:	0f b6 c8             	movzbl %al,%ecx
80104d33:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104d36:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d39:	89 d0                	mov    %edx,%eax
80104d3b:	c1 e0 03             	shl    $0x3,%eax
80104d3e:	01 d0                	add    %edx,%eax
80104d40:	c1 e0 02             	shl    $0x2,%eax
80104d43:	01 d8                	add    %ebx,%eax
80104d45:	89 08                	mov    %ecx,(%eax)
    (*pstat)[i].tickets = p->tickets;
80104d47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d4a:	8b 48 7c             	mov    0x7c(%eax),%ecx
...
80104db4:	8d 50 10             	lea    0x10(%eax),%edx
80104db7:	8b 45 08             	mov    0x8(%ebp),%eax
80104dba:	01 d0                	add    %edx,%eax
80104dbc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104dc3:	00 
80104dc4:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104dc8:	89 04 24             	mov    %eax,(%esp)
80104dcb:	e8 b6 06 00 00       	call   80105486 <strncpy>
    if (p->state == EMBRYO) (*pstat)[i].state = 'E';
80104dd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dd3:	8b 40 0c             	mov    0xc(%eax),%eax
80104dd6:	83 f8 01             	cmp    $0x1,%eax
80104dd9:	75 18                	jne    80104df3 <getpinfo+0xe8>
...
80104df0:	c6 00 45             	movb   $0x45,(%eax)
    if (p->state == RUNNING) (*pstat)[i].state = 'R';
80104df3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104df6:	8b 40 0c             	mov    0xc(%eax),%eax
80104df9:	83 f8 04             	cmp    $0x4,%eax
80104dfc:	75 18                	jne    80104e16 <getpinfo+0x10b>
80104dfe:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
80104e0e:	01 c8                	add    %ecx,%eax
80104e10:	83 c0 20             	add    $0x20,%eax
80104e13:	c6 00 52             	movb   $0x52,(%eax)
...
80104e1f:	75 18                	jne    80104e39 <getpinfo+0x12e>
80104e21:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e24:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e27:	89 d0                	mov    %edx,%eax
80104e29:	c1 e0 03             	shl    $0x3,%eax
80104e2c:	01 d0                	add    %edx,%eax
80104e2e:	c1 e0 02             	shl    $0x2,%eax
80104e31:	01 c8                	add    %ecx,%eax
80104e33:	83 c0 20             	add    $0x20,%eax
80104e36:	c6 00 41             	movb   $0x41,(%eax)
...
80104e42:	75 18                	jne    80104e5c <getpinfo+0x151>
80104e44:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e47:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e4a:	89 d0                	mov    %edx,%eax
80104e4c:	c1 e0 03             	shl    $0x3,%eax
80104e4f:	01 d0                	add    %edx,%eax
80104e51:	c1 e0 02             	shl    $0x2,%eax
80104e54:	01 c8                	add    %ecx,%eax
80104e56:	83 c0 20             	add    $0x20,%eax
80104e59:	c6 00 53             	movb   $0x53,(%eax)
    if (p->state == ZOMBIE) (*pstat)[i].state = 'Z';
80104e5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e5f:	8b 40 0c             	mov    0xc(%eax),%eax
80104e62:	83 f8 05             	cmp    $0x5,%eax
80104e65:	75 18                	jne    80104e7f <getpinfo+0x174>
80104e67:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e6a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e6d:	89 d0                	mov    %edx,%eax
80104e6f:	c1 e0 03             	shl    $0x3,%eax
80104e72:	01 d0                	add    %edx,%eax
80104e74:	c1 e0 02             	shl    $0x2,%eax
80104e77:	01 c8                	add    %ecx,%eax
80104e79:	83 c0 20             	add    $0x20,%eax
80104e7c:	c6 00 5a             	movb   $0x5a,(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; ++p, ++i) {
80104e7f:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104e86:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104e8a:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
80104e91:	0f 82 8e fe ff ff    	jb     80104d25 <getpinfo+0x1a>
  }
}
80104e97:	83 c4 24             	add    $0x24,%esp
80104e9a:	5b                   	pop    %ebx
80104e9b:	5d                   	pop    %ebp
80104e9c:	c3                   	ret    
...
80104ea3:	83 7d 08 09          	cmpl   $0x9,0x8(%ebp)
80104ea7:	7f 07                	jg     80104eb0 <settickets+0x13>
80104ea9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104eae:	eb 16                	jmp    80104ec6 <settickets+0x29>
  struct proc* p = myproc();
80104eb0:	e8 ac f2 ff ff       	call   80104161 <myproc>
80104eb5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  p->tickets = number; 
80104eb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ebb:	8b 55 08             	mov    0x8(%ebp),%edx
80104ebe:	89 50 7c             	mov    %edx,0x7c(%eax)
  return 0;
80104ec1:	b8 00 00 00 00       	mov    $0x0,%eax
80104ec6:	c9                   	leave  
80104ec7:	c3                   	ret    

80104ec8 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80104ed1:	83 c0 04             	add    $0x4,%eax
80104ed4:	c7 44 24 04 47 89 10 	movl   $0x80108947,0x4(%esp)
80104edb:	80 
80104edc:	89 04 24             	mov    %eax,(%esp)
80104edf:	e8 47 01 00 00       	call   8010502b <initlock>
  lk->name = name;
80104ee4:	8b 45 08             	mov    0x8(%ebp),%eax
80104ee7:	8b 55 0c             	mov    0xc(%ebp),%edx
80104eea:	89 50 38             	mov    %edx,0x38(%eax)
  lk->locked = 0;
80104eed:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->pid = 0;
80104ef6:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef9:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
}
80104f00:	c9                   	leave  
80104f01:	c3                   	ret    

80104f02 <acquiresleep>:
...
80104f0b:	83 c0 04             	add    $0x4,%eax
80104f0e:	89 04 24             	mov    %eax,(%esp)
80104f11:	e8 36 01 00 00       	call   8010504c <acquire>
  while (lk->locked) {
80104f16:	eb 15                	jmp    80104f2d <acquiresleep+0x2b>
    sleep(lk, &lk->lk);
80104f18:	8b 45 08             	mov    0x8(%ebp),%eax
80104f1b:	83 c0 04             	add    $0x4,%eax
80104f1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f22:	8b 45 08             	mov    0x8(%ebp),%eax
80104f25:	89 04 24             	mov    %eax,(%esp)
80104f28:	e8 67 fb ff ff       	call   80104a94 <sleep>
  while (lk->locked) {
80104f2d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f30:	8b 00                	mov    (%eax),%eax
80104f32:	85 c0                	test   %eax,%eax
80104f34:	75 e2                	jne    80104f18 <acquiresleep+0x16>
  }
  lk->locked = 1;
80104f36:	8b 45 08             	mov    0x8(%ebp),%eax
80104f39:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  lk->pid = myproc()->pid;
80104f3f:	e8 1d f2 ff ff       	call   80104161 <myproc>
80104f44:	8b 50 10             	mov    0x10(%eax),%edx
80104f47:	8b 45 08             	mov    0x8(%ebp),%eax
80104f4a:	89 50 3c             	mov    %edx,0x3c(%eax)
  release(&lk->lk);
80104f4d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f50:	83 c0 04             	add    $0x4,%eax
80104f53:	89 04 24             	mov    %eax,(%esp)
80104f56:	e8 59 01 00 00       	call   801050b4 <release>
}
80104f5b:	c9                   	leave  
80104f5c:	c3                   	ret    

80104f5d <releasesleep>:
...
80104f6c:	e8 db 00 00 00       	call   8010504c <acquire>
  lk->locked = 0;
...
80104f8a:	e8 dc fb ff ff       	call   80104b6b <wakeup>
  release(&lk->lk);
80104f8f:	8b 45 08             	mov    0x8(%ebp),%eax
80104f92:	83 c0 04             	add    $0x4,%eax
80104f95:	89 04 24             	mov    %eax,(%esp)
80104f98:	e8 17 01 00 00       	call   801050b4 <release>
}
80104f9d:	c9                   	leave  
80104f9e:	c3                   	ret    

80104f9f <holdingsleep>:
...
80104faf:	e8 98 00 00 00       	call   8010504c <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104fb4:	8b 45 08             	mov    0x8(%ebp),%eax
80104fb7:	8b 00                	mov    (%eax),%eax
80104fb9:	85 c0                	test   %eax,%eax
80104fbb:	74 19                	je     80104fd6 <holdingsleep+0x37>
80104fbd:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc0:	8b 58 3c             	mov    0x3c(%eax),%ebx
80104fc3:	e8 99 f1 ff ff       	call   80104161 <myproc>
80104fc8:	8b 40 10             	mov    0x10(%eax),%eax
80104fcb:	39 c3                	cmp    %eax,%ebx
80104fcd:	75 07                	jne    80104fd6 <holdingsleep+0x37>
80104fcf:	b8 01 00 00 00       	mov    $0x1,%eax
80104fd4:	eb 05                	jmp    80104fdb <holdingsleep+0x3c>
...
80104fe7:	e8 c8 00 00 00       	call   801050b4 <release>
  return r;
80104fec:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80104fef:	83 c4 24             	add    $0x24,%esp
80104ff2:	5b                   	pop    %ebx
80104ff3:	5d                   	pop    %ebp
80104ff4:	c3                   	ret    
...
80105020:	f0 87 02             	lock xchg %eax,(%edx)
...
80105031:	8b 55 0c             	mov    0xc(%ebp),%edx
80105034:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105037:	8b 45 08             	mov    0x8(%ebp),%eax
8010503a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
...
80105050:	83 ec 14             	sub    $0x14,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80105053:	e8 61 01 00 00       	call   801051b9 <pushcli>
  if(holding(lk))
80105058:	8b 45 08             	mov    0x8(%ebp),%eax
8010505b:	89 04 24             	mov    %eax,(%esp)
8010505e:	e8 15 01 00 00       	call   80105178 <holding>
80105063:	85 c0                	test   %eax,%eax
80105065:	74 0c                	je     80105073 <acquire+0x27>
    panic("acquire");
80105067:	c7 04 24 52 89 10 80 	movl   $0x80108952,(%esp)
...
80105077:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010507e:	00 
8010507f:	89 04 24             	mov    %eax,(%esp)
80105082:	e8 8a ff ff ff       	call   80105011 <xchg>
80105087:	85 c0                	test   %eax,%eax
80105089:	75 e9                	jne    80105074 <acquire+0x28>
    ;
  ...
  __sync_synchronize();
8010508b:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
8010508e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105091:	e8 55 f0 ff ff       	call   801040eb <mycpu>
80105096:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80105099:	8b 45 08             	mov    0x8(%ebp),%eax
8010509c:	83 c0 0c             	add    $0xc,%eax
8010509f:	89 44 24 04          	mov    %eax,0x4(%esp)
801050a3:	8d 45 08             	lea    0x8(%ebp),%eax
801050a6:	89 04 24             	mov    %eax,(%esp)
801050a9:	e8 51 00 00 00       	call   801050ff <getcallerpcs>
}
801050ae:	83 c4 14             	add    $0x14,%esp
801050b1:	5b                   	pop    %ebx
801050b2:	5d                   	pop    %ebp
801050b3:	c3                   	ret    
...
801050c0:	e8 b3 00 00 00       	call   80105178 <holding>
801050c5:	85 c0                	test   %eax,%eax
801050c7:	75 0c                	jne    801050d5 <release+0x21>
    panic("release");
801050c9:	c7 04 24 5a 89 10 80 	movl   $0x8010895a,(%esp)
801050d0:	e8 8d b4 ff ff       	call   80100562 <panic>

  lk->pcs[0] = 0;
801050d5:	8b 45 08             	mov    0x8(%ebp),%eax
801050d8:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
801050df:	8b 45 08             	mov    0x8(%ebp),%eax
801050e2:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  // Tell the C compiler and the processor to not move loads or stores
...
801050ef:	8b 55 08             	mov    0x8(%ebp),%edx
801050f2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

  popcli();
801050f8:	e8 08 01 00 00       	call   80105205 <popcli>
}
801050fd:	c9                   	leave  
801050fe:	c3                   	ret    

801050ff <getcallerpcs>:
...
80105108:	83 e8 08             	sub    $0x8,%eax
8010510b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010510e:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105115:	eb 38                	jmp    8010514f <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105117:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010511b:	74 38                	je     80105155 <getcallerpcs+0x56>
8010511d:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105124:	76 2f                	jbe    80105155 <getcallerpcs+0x56>
80105126:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010512a:	74 29                	je     80105155 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010512c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010512f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105136:	8b 45 0c             	mov    0xc(%ebp),%eax
80105139:	01 c2                	add    %eax,%edx
8010513b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010513e:	8b 40 04             	mov    0x4(%eax),%eax
80105141:	89 02                	mov    %eax,(%edx)
    ebp = (uint*)ebp[0]; // saved %ebp
80105143:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105146:	8b 00                	mov    (%eax),%eax
80105148:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010514b:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010514f:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105153:	7e c2                	jle    80105117 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
80105155:	eb 19                	jmp    80105170 <getcallerpcs+0x71>
    pcs[i] = 0;
80105157:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010515a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105161:	8b 45 0c             	mov    0xc(%ebp),%eax
80105164:	01 d0                	add    %edx,%eax
80105166:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010516c:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105170:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105174:	7e e1                	jle    80105157 <getcallerpcs+0x58>
}
80105176:	c9                   	leave  
80105177:	c3                   	ret    
...
8010517c:	83 ec 14             	sub    $0x14,%esp
  int r;
  pushcli();
8010517f:	e8 35 00 00 00       	call   801051b9 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105184:	8b 45 08             	mov    0x8(%ebp),%eax
80105187:	8b 00                	mov    (%eax),%eax
80105189:	85 c0                	test   %eax,%eax
8010518b:	74 16                	je     801051a3 <holding+0x2b>
...
8010519a:	75 07                	jne    801051a3 <holding+0x2b>
8010519c:	b8 01 00 00 00       	mov    $0x1,%eax
801051a1:	eb 05                	jmp    801051a8 <holding+0x30>
801051a3:	b8 00 00 00 00       	mov    $0x0,%eax
801051a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  popcli();
801051ab:	e8 55 00 00 00       	call   80105205 <popcli>
  return r;
...
801051bc:	83 ec 18             	sub    $0x18,%esp
  ...
  eflags = readeflags();
801051bf:	e8 31 fe ff ff       	call   80104ff5 <readeflags>
801051c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  cli();
801051c7:	e8 39 fe ff ff       	call   80105005 <cli>
  if(mycpu()->ncli == 0)
801051cc:	e8 1a ef ff ff       	call   801040eb <mycpu>
801051d1:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051d7:	85 c0                	test   %eax,%eax
801051d9:	75 14                	jne    801051ef <pushcli+0x36>
    mycpu()->intena = eflags & FL_IF;
801051db:	e8 0b ef ff ff       	call   801040eb <mycpu>
801051e0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801051e3:	81 e2 00 02 00 00    	and    $0x200,%edx
801051e9:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
  mycpu()->ncli += 1;
801051ef:	e8 f7 ee ff ff       	call   801040eb <mycpu>
801051f4:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801051fa:	83 c2 01             	add    $0x1,%edx
801051fd:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
}
80105203:	c9                   	leave  
80105204:	c3                   	ret    
...
80105208:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010520b:	e8 e5 fd ff ff       	call   80104ff5 <readeflags>
80105210:	25 00 02 00 00       	and    $0x200,%eax
80105215:	85 c0                	test   %eax,%eax
80105217:	74 0c                	je     80105225 <popcli+0x20>
    panic("popcli - interruptible");
80105219:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80105220:	e8 3d b3 ff ff       	call   80100562 <panic>
  if(--mycpu()->ncli < 0)
80105225:	e8 c1 ee ff ff       	call   801040eb <mycpu>
8010522a:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105230:	83 ea 01             	sub    $0x1,%edx
80105233:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80105239:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
8010523f:	85 c0                	test   %eax,%eax
80105241:	79 0c                	jns    8010524f <popcli+0x4a>
    panic("popcli");
80105243:	c7 04 24 79 89 10 80 	movl   $0x80108979,(%esp)
8010524a:	e8 13 b3 ff ff       	call   80100562 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010524f:	e8 97 ee ff ff       	call   801040eb <mycpu>
80105254:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
8010525a:	85 c0                	test   %eax,%eax
8010525c:	75 14                	jne    80105272 <popcli+0x6d>
8010525e:	e8 88 ee ff ff       	call   801040eb <mycpu>
80105263:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80105269:	85 c0                	test   %eax,%eax
8010526b:	74 05                	je     80105272 <popcli+0x6d>
    sti();
8010526d:	e8 99 fd ff ff       	call   8010500b <sti>
}
80105272:	c9                   	leave  
80105273:	c3                   	ret    
...
8010527c:	8b 55 10             	mov    0x10(%ebp),%edx
8010527f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105282:	89 cb                	mov    %ecx,%ebx
80105284:	89 df                	mov    %ebx,%edi
80105286:	89 d1                	mov    %edx,%ecx
80105288:	fc                   	cld    
80105289:	f3 aa                	rep stos %al,%es:(%edi)
8010528b:	89 ca                	mov    %ecx,%edx
8010528d:	89 fb                	mov    %edi,%ebx
8010528f:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105292:	89 55 10             	mov    %edx,0x10(%ebp)
}
80105295:	5b                   	pop    %ebx
80105296:	5f                   	pop    %edi
80105297:	5d                   	pop    %ebp
...
801052ad:	fc                   	cld    
801052ae:	f3 ab                	rep stos %eax,%es:(%edi)
...
801052c7:	83 e0 03             	and    $0x3,%eax
801052ca:	85 c0                	test   %eax,%eax
801052cc:	75 49                	jne    80105317 <memset+0x59>
801052ce:	8b 45 10             	mov    0x10(%ebp),%eax
801052d1:	83 e0 03             	and    $0x3,%eax
801052d4:	85 c0                	test   %eax,%eax
801052d6:	75 3f                	jne    80105317 <memset+0x59>
    c &= 0xFF;
801052d8:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801052df:	8b 45 10             	mov    0x10(%ebp),%eax
801052e2:	c1 e8 02             	shr    $0x2,%eax
801052e5:	89 c2                	mov    %eax,%edx
801052e7:	8b 45 0c             	mov    0xc(%ebp),%eax
801052ea:	c1 e0 18             	shl    $0x18,%eax
801052ed:	89 c1                	mov    %eax,%ecx
801052ef:	8b 45 0c             	mov    0xc(%ebp),%eax
801052f2:	c1 e0 10             	shl    $0x10,%eax
801052f5:	09 c1                	or     %eax,%ecx
801052f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801052fa:	c1 e0 08             	shl    $0x8,%eax
801052fd:	09 c8                	or     %ecx,%eax
801052ff:	0b 45 0c             	or     0xc(%ebp),%eax
80105302:	89 54 24 08          	mov    %edx,0x8(%esp)
80105306:	89 44 24 04          	mov    %eax,0x4(%esp)
8010530a:	8b 45 08             	mov    0x8(%ebp),%eax
8010530d:	89 04 24             	mov    %eax,(%esp)
80105310:	e8 84 ff ff ff       	call   80105299 <stosl>
80105315:	eb 19                	jmp    80105330 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010532b:	e8 44 ff ff ff       	call   80105274 <stosb>
  return dst;
...
80105344:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105347:	eb 30                	jmp    80105379 <memcmp+0x44>
    if(*s1 != *s2)
...
80105357:	74 18                	je     80105371 <memcmp+0x3c>
      return *s1 - *s2;
80105359:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010535c:	0f b6 00             	movzbl (%eax),%eax
8010535f:	0f b6 d0             	movzbl %al,%edx
80105362:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105365:	0f b6 00             	movzbl (%eax),%eax
80105368:	0f b6 c0             	movzbl %al,%eax
8010536b:	29 c2                	sub    %eax,%edx
8010536d:	89 d0                	mov    %edx,%eax
8010536f:	eb 1a                	jmp    8010538b <memcmp+0x56>
    s1++, s2++;
80105371:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105375:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
  while(n-- > 0){
...
80105384:	75 c3                	jne    80105349 <memcmp+0x14>
  }
...
8010539c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010539f:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053a2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053a5:	73 3d                	jae    801053e4 <memmove+0x57>
801053a7:	8b 45 10             	mov    0x10(%ebp),%eax
801053aa:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053ad:	01 d0                	add    %edx,%eax
801053af:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053b2:	76 30                	jbe    801053e4 <memmove+0x57>
    s += n;
801053b4:	8b 45 10             	mov    0x10(%ebp),%eax
801053b7:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801053ba:	8b 45 10             	mov    0x10(%ebp),%eax
801053bd:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801053c0:	eb 13                	jmp    801053d5 <memmove+0x48>
      *--d = *--s;
801053c2:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801053c6:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
801053e0:	75 e0                	jne    801053c2 <memmove+0x35>
  if(s < d && s + n > d){
801053e2:	eb 26                	jmp    8010540a <memmove+0x7d>
  } else
    while(n-- > 0)
801053e4:	eb 17                	jmp    801053fd <memmove+0x70>
      *d++ = *s++;
801053e6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801053e9:	8d 50 01             	lea    0x1(%eax),%edx
801053ec:	89 55 f8             	mov    %edx,-0x8(%ebp)
801053ef:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053f2:	8d 4a 01             	lea    0x1(%edx),%ecx
801053f5:	89 4d fc             	mov    %ecx,-0x4(%ebp)
...
80105408:	75 dc                	jne    801053e6 <memmove+0x59>
...
80105429:	e8 5f ff ff ff       	call   8010538d <memmove>
}
8010542e:	c9                   	leave  
8010542f:	c3                   	ret    
...
80105431:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105433:	eb 0c                	jmp    80105441 <strncmp+0x11>
    n--, p++, q++;
80105435:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105439:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010543d:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(n > 0 && *p && *p == *q)
80105441:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105445:	74 1a                	je     80105461 <strncmp+0x31>
80105447:	8b 45 08             	mov    0x8(%ebp),%eax
8010544a:	0f b6 00             	movzbl (%eax),%eax
8010544d:	84 c0                	test   %al,%al
8010544f:	74 10                	je     80105461 <strncmp+0x31>
80105451:	8b 45 08             	mov    0x8(%ebp),%eax
80105454:	0f b6 10             	movzbl (%eax),%edx
80105457:	8b 45 0c             	mov    0xc(%ebp),%eax
8010545a:	0f b6 00             	movzbl (%eax),%eax
8010545d:	38 c2                	cmp    %al,%dl
8010545f:	74 d4                	je     80105435 <strncmp+0x5>
  if(n == 0)
80105461:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105465:	75 07                	jne    8010546e <strncmp+0x3e>
    return 0;
80105467:	b8 00 00 00 00       	mov    $0x0,%eax
8010546c:	eb 16                	jmp    80105484 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
8010546e:	8b 45 08             	mov    0x8(%ebp),%eax
80105471:	0f b6 00             	movzbl (%eax),%eax
80105474:	0f b6 d0             	movzbl %al,%edx
80105477:	8b 45 0c             	mov    0xc(%ebp),%eax
8010547a:	0f b6 00             	movzbl (%eax),%eax
8010547d:	0f b6 c0             	movzbl %al,%eax
80105480:	29 c2                	sub    %eax,%edx
...
8010548f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105492:	90                   	nop
...
8010549e:	7e 1e                	jle    801054be <strncpy+0x38>
...
801054bc:	75 d5                	jne    80105493 <strncpy+0xd>
    ;
  while(n-- > 0)
801054be:	eb 0c                	jmp    801054cc <strncpy+0x46>
    *s++ = 0;
801054c0:	8b 45 08             	mov    0x8(%ebp),%eax
801054c3:	8d 50 01             	lea    0x1(%eax),%edx
801054c6:	89 55 08             	mov    %edx,0x8(%ebp)
801054c9:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
801054cc:	8b 45 10             	mov    0x10(%ebp),%eax
801054cf:	8d 50 ff             	lea    -0x1(%eax),%edx
801054d2:	89 55 10             	mov    %edx,0x10(%ebp)
801054d5:	85 c0                	test   %eax,%eax
801054d7:	7f e7                	jg     801054c0 <strncpy+0x3a>
  return os;
...
801054e1:	83 ec 10             	sub    $0x10,%esp
  char *os;
...
801054ee:	7f 05                	jg     801054f5 <safestrcpy+0x17>
    return os;
801054f0:	8b 45 fc             	mov    -0x4(%ebp),%eax
801054f3:	eb 31                	jmp    80105526 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
801054f5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801054f9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801054fd:	7e 1e                	jle    8010551d <safestrcpy+0x3f>
...
8010550b:	8d 4a 01             	lea    0x1(%edx),%ecx
8010550e:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105511:	0f b6 12             	movzbl (%edx),%edx
80105514:	88 10                	mov    %dl,(%eax)
80105516:	0f b6 00             	movzbl (%eax),%eax
80105519:	84 c0                	test   %al,%al
8010551b:	75 d8                	jne    801054f5 <safestrcpy+0x17>
    ;
  *s = 0;
...
8010552b:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
8010552e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105535:	eb 04                	jmp    8010553b <strlen+0x13>
80105537:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
80105546:	84 c0                	test   %al,%al
80105548:	75 ed                	jne    80105537 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010554f:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105553:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010555a:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010555b:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010555d:	89 d4                	mov    %edx,%esp
...
80105567:	83 ec 18             	sub    $0x18,%esp
  struct proc *curproc = myproc();
8010556a:	e8 f2 eb ff ff       	call   80104161 <myproc>
8010556f:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80105572:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105575:	8b 00                	mov    (%eax),%eax
80105577:	3b 45 08             	cmp    0x8(%ebp),%eax
8010557a:	76 0f                	jbe    8010558b <fetchint+0x27>
8010557c:	8b 45 08             	mov    0x8(%ebp),%eax
8010557f:	8d 50 04             	lea    0x4(%eax),%edx
80105582:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105585:	8b 00                	mov    (%eax),%eax
80105587:	39 c2                	cmp    %eax,%edx
80105589:	76 07                	jbe    80105592 <fetchint+0x2e>
    return -1;
8010558b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105590:	eb 0f                	jmp    801055a1 <fetchint+0x3d>
  *ip = *(int*)(addr);
80105592:	8b 45 08             	mov    0x8(%ebp),%eax
80105595:	8b 10                	mov    (%eax),%edx
...
801055a6:	83 ec 18             	sub    $0x18,%esp
  char *s, *ep;
  struct proc *curproc = myproc();
801055a9:	e8 b3 eb ff ff       	call   80104161 <myproc>
...
801055b9:	77 07                	ja     801055c2 <fetchstr+0x1f>
    return -1;
801055bb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055c0:	eb 43                	jmp    80105605 <fetchstr+0x62>
  *pp = (char*)addr;
...
801055da:	eb 1c                	jmp    801055f8 <fetchstr+0x55>
    if(*s == 0)
801055dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055df:	0f b6 00             	movzbl (%eax),%eax
801055e2:	84 c0                	test   %al,%al
801055e4:	75 0e                	jne    801055f4 <fetchstr+0x51>
      return s - *pp;
801055e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055e9:	8b 45 0c             	mov    0xc(%ebp),%eax
801055ec:	8b 00                	mov    (%eax),%eax
801055ee:	29 c2                	sub    %eax,%edx
801055f0:	89 d0                	mov    %edx,%eax
801055f2:	eb 11                	jmp    80105605 <fetchstr+0x62>
  for(s = *pp; s < ep; s++){
801055f4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801055f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055fb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
801055fe:	72 dc                	jb     801055dc <fetchstr+0x39>
  }
  return -1;
...
8010560a:	83 ec 18             	sub    $0x18,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010560d:	e8 4f eb ff ff       	call   80104161 <myproc>
80105612:	8b 40 18             	mov    0x18(%eax),%eax
80105615:	8b 50 44             	mov    0x44(%eax),%edx
80105618:	8b 45 08             	mov    0x8(%ebp),%eax
8010561b:	c1 e0 02             	shl    $0x2,%eax
8010561e:	01 d0                	add    %edx,%eax
80105620:	8d 50 04             	lea    0x4(%eax),%edx
80105623:	8b 45 0c             	mov    0xc(%ebp),%eax
80105626:	89 44 24 04          	mov    %eax,0x4(%esp)
8010562a:	89 14 24             	mov    %edx,(%esp)
8010562d:	e8 32 ff ff ff       	call   80105564 <fetchint>
}
80105632:	c9                   	leave  
80105633:	c3                   	ret    
...
80105637:	83 ec 28             	sub    $0x28,%esp
  int i;
  struct proc *curproc = myproc();
8010563a:	e8 22 eb ff ff       	call   80104161 <myproc>
8010563f:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
80105682:	39 c2                	cmp    %eax,%edx
80105684:	76 07                	jbe    8010568d <argptr+0x59>
    return -1;
80105686:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010568b:	eb 0f                	jmp    8010569c <argptr+0x68>
  *pp = (char*)i;
...
801056b1:	e8 51 ff ff ff       	call   80105607 <argint>
801056b6:	85 c0                	test   %eax,%eax
801056b8:	79 07                	jns    801056c1 <argstr+0x23>
    return -1;
801056ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056bf:	eb 12                	jmp    801056d3 <argstr+0x35>
  return fetchstr(addr, pp);
801056c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056c4:	8b 55 0c             	mov    0xc(%ebp),%edx
801056c7:	89 54 24 04          	mov    %edx,0x4(%esp)
801056cb:	89 04 24             	mov    %eax,(%esp)
801056ce:	e8 d0 fe ff ff       	call   801055a3 <fetchstr>
}
801056d3:	c9                   	leave  
801056d4:	c3                   	ret    
...
801056d9:	83 ec 24             	sub    $0x24,%esp
  int num;
  struct proc *curproc = myproc();
801056dc:	e8 80 ea ff ff       	call   80104161 <myproc>
801056e1:	89 45 f4             	mov    %eax,-0xc(%ebp)

  num = curproc->tf->eax;
801056e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056e7:	8b 40 18             	mov    0x18(%eax),%eax
801056ea:	8b 40 1c             	mov    0x1c(%eax),%eax
801056ed:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801056f0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801056f4:	7e 2d                	jle    80105723 <syscall+0x4e>
801056f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056f9:	83 f8 17             	cmp    $0x17,%eax
801056fc:	77 25                	ja     80105723 <syscall+0x4e>
801056fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105701:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105708:	85 c0                	test   %eax,%eax
8010570a:	74 17                	je     80105723 <syscall+0x4e>
...
80105721:	eb 34                	jmp    80105757 <syscall+0x82>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80105723:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105726:	8d 48 6c             	lea    0x6c(%eax),%ecx
    cprintf("%d %s: unknown sys call %d\n",
80105729:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010572c:	8b 40 10             	mov    0x10(%eax),%eax
8010572f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105732:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105736:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010573a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010573e:	c7 04 24 80 89 10 80 	movl   $0x80108980,(%esp)
80105745:	e8 7e ac ff ff       	call   801003c8 <cprintf>
    curproc->tf->eax = -1;
...
80105757:	83 c4 24             	add    $0x24,%esp
8010575a:	5b                   	pop    %ebx
8010575b:	5d                   	pop    %ebp
8010575c:	c3                   	ret    
...
80105770:	e8 92 fe ff ff       	call   80105607 <argint>
80105775:	85 c0                	test   %eax,%eax
80105777:	79 07                	jns    80105780 <argfd+0x23>
    return -1;
80105779:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010577e:	eb 4f                	jmp    801057cf <argfd+0x72>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80105780:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105783:	85 c0                	test   %eax,%eax
80105785:	78 20                	js     801057a7 <argfd+0x4a>
80105787:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010578a:	83 f8 0f             	cmp    $0xf,%eax
8010578d:	7f 18                	jg     801057a7 <argfd+0x4a>
8010578f:	e8 cd e9 ff ff       	call   80104161 <myproc>
80105794:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105797:	83 c2 08             	add    $0x8,%edx
8010579a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010579e:	89 45 f4             	mov    %eax,-0xc(%ebp)
801057a1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801057a5:	75 07                	jne    801057ae <argfd+0x51>
    return -1;
801057a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057ac:	eb 21                	jmp    801057cf <argfd+0x72>
  if(pfd)
801057ae:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801057b2:	74 08                	je     801057bc <argfd+0x5f>
    *pfd = fd;
801057b4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801057ba:	89 10                	mov    %edx,(%eax)
  if(pf)
801057bc:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801057c0:	74 08                	je     801057ca <argfd+0x6d>
    *pf = f;
...
801057d4:	83 ec 18             	sub    $0x18,%esp
  int fd;
  struct proc *curproc = myproc();
801057d7:	e8 85 e9 ff ff       	call   80104161 <myproc>
801057dc:	89 45 f0             	mov    %eax,-0x10(%ebp)

  for(fd = 0; fd < NOFILE; fd++){
801057df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801057e6:	eb 2a                	jmp    80105812 <fdalloc+0x41>
    if(curproc->ofile[fd] == 0){
801057e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057eb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057ee:	83 c2 08             	add    $0x8,%edx
801057f1:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801057f5:	85 c0                	test   %eax,%eax
801057f7:	75 15                	jne    8010580e <fdalloc+0x3d>
      curproc->ofile[fd] = f;
801057f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057ff:	8d 4a 08             	lea    0x8(%edx),%ecx
80105802:	8b 55 08             	mov    0x8(%ebp),%edx
80105805:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105809:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010580c:	eb 0f                	jmp    8010581d <fdalloc+0x4c>
  for(fd = 0; fd < NOFILE; fd++){
8010580e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105812:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105816:	7e d0                	jle    801057e8 <fdalloc+0x17>
    }
  }
  return -1;
...
80105822:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
8010582c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105833:	00 
80105834:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010583b:	e8 1d ff ff ff       	call   8010575d <argfd>
80105840:	85 c0                	test   %eax,%eax
80105842:	79 07                	jns    8010584b <sys_dup+0x2c>
    return -1;
80105844:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105849:	eb 29                	jmp    80105874 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
8010584b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010584e:	89 04 24             	mov    %eax,(%esp)
80105851:	e8 7b ff ff ff       	call   801057d1 <fdalloc>
80105856:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105859:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010585d:	79 07                	jns    80105866 <sys_dup+0x47>
    return -1;
8010585f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105864:	eb 0e                	jmp    80105874 <sys_dup+0x55>
  filedup(f);
80105866:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105869:	89 04 24             	mov    %eax,(%esp)
8010586c:	e8 74 b7 ff ff       	call   80100fe5 <filedup>
  return fd;
...
80105892:	e8 c6 fe ff ff       	call   8010575d <argfd>
80105897:	85 c0                	test   %eax,%eax
80105899:	78 35                	js     801058d0 <sys_read+0x5a>
8010589b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010589e:	89 44 24 04          	mov    %eax,0x4(%esp)
801058a2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801058a9:	e8 59 fd ff ff       	call   80105607 <argint>
801058ae:	85 c0                	test   %eax,%eax
801058b0:	78 1e                	js     801058d0 <sys_read+0x5a>
...
801058c7:	e8 68 fd ff ff       	call   80105634 <argptr>
801058cc:	85 c0                	test   %eax,%eax
801058ce:	79 07                	jns    801058d7 <sys_read+0x61>
    return -1;
801058d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058d5:	eb 19                	jmp    801058f0 <sys_read+0x7a>
...
801058eb:	e8 62 b8 ff ff       	call   80101152 <fileread>
}
801058f0:	c9                   	leave  
801058f1:	c3                   	ret    
...
8010590e:	e8 4a fe ff ff       	call   8010575d <argfd>
80105913:	85 c0                	test   %eax,%eax
80105915:	78 35                	js     8010594c <sys_write+0x5a>
80105917:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010591a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010591e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105925:	e8 dd fc ff ff       	call   80105607 <argint>
8010592a:	85 c0                	test   %eax,%eax
8010592c:	78 1e                	js     8010594c <sys_write+0x5a>
...
80105943:	e8 ec fc ff ff       	call   80105634 <argptr>
80105948:	85 c0                	test   %eax,%eax
8010594a:	79 07                	jns    80105953 <sys_write+0x61>
    return -1;
8010594c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105951:	eb 19                	jmp    8010596c <sys_write+0x7a>
  return filewrite(f, p, n);
80105953:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105956:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105959:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010595c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105960:	89 54 24 04          	mov    %edx,0x4(%esp)
80105964:	89 04 24             	mov    %eax,(%esp)
80105967:	e8 a2 b8 ff ff       	call   8010120e <filewrite>
}
8010596c:	c9                   	leave  
8010596d:	c3                   	ret    
...
80105989:	e8 cf fd ff ff       	call   8010575d <argfd>
8010598e:	85 c0                	test   %eax,%eax
80105990:	79 07                	jns    80105999 <sys_close+0x2b>
    return -1;
80105992:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105997:	eb 23                	jmp    801059bc <sys_close+0x4e>
  myproc()->ofile[fd] = 0;
80105999:	e8 c3 e7 ff ff       	call   80104161 <myproc>
...
801059b2:	e8 76 b6 ff ff       	call   8010102d <fileclose>
  return 0;
...
801059c7:	89 44 24 08          	mov    %eax,0x8(%esp)
801059cb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801059d2:	00 
801059d3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059da:	e8 7e fd ff ff       	call   8010575d <argfd>
801059df:	85 c0                	test   %eax,%eax
801059e1:	78 1f                	js     80105a02 <sys_fstat+0x44>
801059e3:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801059ea:	00 
801059eb:	8d 45 f0             	lea    -0x10(%ebp),%eax
801059ee:	89 44 24 04          	mov    %eax,0x4(%esp)
801059f2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801059f9:	e8 36 fc ff ff       	call   80105634 <argptr>
801059fe:	85 c0                	test   %eax,%eax
80105a00:	79 07                	jns    80105a09 <sys_fstat+0x4b>
    return -1;
80105a02:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a07:	eb 12                	jmp    80105a1b <sys_fstat+0x5d>
  return filestat(f, st);
80105a09:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a0f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a13:	89 04 24             	mov    %eax,(%esp)
80105a16:	e8 e8 b6 ff ff       	call   80101103 <filestat>
}
80105a1b:	c9                   	leave  
80105a1c:	c3                   	ret    
...
80105a31:	e8 68 fc ff ff       	call   8010569e <argstr>
80105a36:	85 c0                	test   %eax,%eax
80105a38:	78 17                	js     80105a51 <sys_link+0x34>
80105a3a:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105a3d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a41:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a48:	e8 51 fc ff ff       	call   8010569e <argstr>
80105a4d:	85 c0                	test   %eax,%eax
80105a4f:	79 0a                	jns    80105a5b <sys_link+0x3e>
    return -1;
80105a51:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a56:	e9 42 01 00 00       	jmp    80105b9d <sys_link+0x180>

  begin_op();
80105a5b:	e8 27 da ff ff       	call   80103487 <begin_op>
  if((ip = namei(old)) == 0){
80105a60:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105a63:	89 04 24             	mov    %eax,(%esp)
80105a66:	e8 2c ca ff ff       	call   80102497 <namei>
80105a6b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a6e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a72:	75 0f                	jne    80105a83 <sys_link+0x66>
    end_op();
80105a74:	e8 92 da ff ff       	call   8010350b <end_op>
    return -1;
80105a79:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a7e:	e9 1a 01 00 00       	jmp    80105b9d <sys_link+0x180>
  }

  ilock(ip);
80105a83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a86:	89 04 24             	mov    %eax,(%esp)
80105a89:	e8 cf be ff ff       	call   8010195d <ilock>
  if(ip->type == T_DIR){
80105a8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a91:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105a95:	66 83 f8 01          	cmp    $0x1,%ax
80105a99:	75 1a                	jne    80105ab5 <sys_link+0x98>
    iunlockput(ip);
80105a9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a9e:	89 04 24             	mov    %eax,(%esp)
80105aa1:	e8 b9 c0 ff ff       	call   80101b5f <iunlockput>
    end_op();
80105aa6:	e8 60 da ff ff       	call   8010350b <end_op>
    return -1;
80105aab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ab0:	e9 e8 00 00 00       	jmp    80105b9d <sys_link+0x180>
  }

  ip->nlink++;
80105ab5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ab8:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105abc:	8d 50 01             	lea    0x1(%eax),%edx
...
80105b10:	75 20                	jne    80105b32 <sys_link+0x115>
...
80105ba2:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105ba5:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105bac:	eb 4b                	jmp    80105bf9 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105bae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bb1:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105bb8:	00 
80105bb9:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bbd:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105bc0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bc4:	8b 45 08             	mov    0x8(%ebp),%eax
80105bc7:	89 04 24             	mov    %eax,(%esp)
80105bca:	e8 2b c2 ff ff       	call   80101dfa <readi>
80105bcf:	83 f8 10             	cmp    $0x10,%eax
80105bd2:	74 0c                	je     80105be0 <isdirempty+0x41>
      panic("isdirempty: readi");
80105bd4:	c7 04 24 9c 89 10 80 	movl   $0x8010899c,(%esp)
80105bdb:	e8 82 a9 ff ff       	call   80100562 <panic>
    if(de.inum != 0)
80105be0:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105be4:	66 85 c0             	test   %ax,%ax
80105be7:	74 07                	je     80105bf0 <isdirempty+0x51>
      return 0;
80105be9:	b8 00 00 00 00       	mov    $0x0,%eax
80105bee:	eb 1b                	jmp    80105c0b <isdirempty+0x6c>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105bf0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf3:	83 c0 10             	add    $0x10,%eax
80105bf6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bf9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105bfc:	8b 45 08             	mov    0x8(%ebp),%eax
80105bff:	8b 40 58             	mov    0x58(%eax),%eax
80105c02:	39 c2                	cmp    %eax,%edx
80105c04:	72 a8                	jb     80105bae <isdirempty+0xf>
  }
  return 1;
80105c06:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105c0b:	c9                   	leave  
80105c0c:	c3                   	ret    
...
80105c10:	83 ec 48             	sub    $0x48,%esp
  ...
  if(argstr(0, &path) < 0)
80105c13:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105c16:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c1a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c21:	e8 78 fa ff ff       	call   8010569e <argstr>
80105c26:	85 c0                	test   %eax,%eax
80105c28:	79 0a                	jns    80105c34 <sys_unlink+0x27>
    return -1;
80105c2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c2f:	e9 af 01 00 00       	jmp    80105de3 <sys_unlink+0x1d6>

  begin_op();
80105c34:	e8 4e d8 ff ff       	call   80103487 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105c39:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105c3c:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105c3f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c43:	89 04 24             	mov    %eax,(%esp)
80105c46:	e8 6e c8 ff ff       	call   801024b9 <nameiparent>
80105c4b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c4e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c52:	75 0f                	jne    80105c63 <sys_unlink+0x56>
    end_op();
80105c54:	e8 b2 d8 ff ff       	call   8010350b <end_op>
    return -1;
80105c59:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c5e:	e9 80 01 00 00       	jmp    80105de3 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105c63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c66:	89 04 24             	mov    %eax,(%esp)
80105c69:	e8 ef bc ff ff       	call   8010195d <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105c6e:	c7 44 24 04 ae 89 10 	movl   $0x801089ae,0x4(%esp)
80105c75:	80 
80105c76:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105c79:	89 04 24             	mov    %eax,(%esp)
80105c7c:	e8 6c c4 ff ff       	call   801020ed <namecmp>
80105c81:	85 c0                	test   %eax,%eax
80105c83:	0f 84 45 01 00 00    	je     80105dce <sys_unlink+0x1c1>
80105c89:	c7 44 24 04 b0 89 10 	movl   $0x801089b0,0x4(%esp)
80105c90:	80 
80105c91:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105c94:	89 04 24             	mov    %eax,(%esp)
80105c97:	e8 51 c4 ff ff       	call   801020ed <namecmp>
80105c9c:	85 c0                	test   %eax,%eax
80105c9e:	0f 84 2a 01 00 00    	je     80105dce <sys_unlink+0x1c1>
    goto bad;
...
80105cb8:	e8 52 c4 ff ff       	call   8010210f <dirlookup>
80105cbd:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cc0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105cc4:	75 05                	jne    80105ccb <sys_unlink+0xbe>
    goto bad;
80105cc6:	e9 03 01 00 00       	jmp    80105dce <sys_unlink+0x1c1>
  ilock(ip);
80105ccb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cce:	89 04 24             	mov    %eax,(%esp)
80105cd1:	e8 87 bc ff ff       	call   8010195d <ilock>

  if(ip->nlink < 1)
80105cd6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd9:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105cdd:	66 85 c0             	test   %ax,%ax
80105ce0:	7f 0c                	jg     80105cee <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105ce2:	c7 04 24 b3 89 10 80 	movl   $0x801089b3,(%esp)
80105ce9:	e8 74 a8 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105cee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cf1:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105cf5:	66 83 f8 01          	cmp    $0x1,%ax
80105cf9:	75 1f                	jne    80105d1a <sys_unlink+0x10d>
80105cfb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cfe:	89 04 24             	mov    %eax,(%esp)
80105d01:	e8 99 fe ff ff       	call   80105b9f <isdirempty>
80105d06:	85 c0                	test   %eax,%eax
80105d08:	75 10                	jne    80105d1a <sys_unlink+0x10d>
    iunlockput(ip);
80105d0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0d:	89 04 24             	mov    %eax,(%esp)
80105d10:	e8 4a be ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105d15:	e9 b4 00 00 00       	jmp    80105dce <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105d1a:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105d21:	00 
80105d22:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d29:	00 
80105d2a:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105d2d:	89 04 24             	mov    %eax,(%esp)
80105d30:	e8 89 f5 ff ff       	call   801052be <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105d35:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105d38:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105d3f:	00 
...
80105d51:	e8 08 c2 ff ff       	call   80101f5e <writei>
80105d56:	83 f8 10             	cmp    $0x10,%eax
80105d59:	74 0c                	je     80105d67 <sys_unlink+0x15a>
    panic("unlink: writei");
80105d5b:	c7 04 24 c5 89 10 80 	movl   $0x801089c5,(%esp)
80105d62:	e8 fb a7 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR){
80105d67:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d6a:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105d6e:	66 83 f8 01          	cmp    $0x1,%ax
80105d72:	75 1c                	jne    80105d90 <sys_unlink+0x183>
    dp->nlink--;
80105d74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d77:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105d7b:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105d8b:	e8 08 ba ff ff       	call   80101798 <iupdate>
  }
  iunlockput(dp);
80105d90:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d93:	89 04 24             	mov    %eax,(%esp)
80105d96:	e8 c4 bd ff ff       	call   80101b5f <iunlockput>

  ip->nlink--;
80105d9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d9e:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105da2:	8d 50 ff             	lea    -0x1(%eax),%edx
80105da5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105da8:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105dac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105daf:	89 04 24             	mov    %eax,(%esp)
80105db2:	e8 e1 b9 ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
80105db7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dba:	89 04 24             	mov    %eax,(%esp)
80105dbd:	e8 9d bd ff ff       	call   80101b5f <iunlockput>

  end_op();
80105dc2:	e8 44 d7 ff ff       	call   8010350b <end_op>

  return 0;
80105dc7:	b8 00 00 00 00       	mov    $0x0,%eax
80105dcc:	eb 15                	jmp    80105de3 <sys_unlink+0x1d6>
...
80105de8:	83 ec 48             	sub    $0x48,%esp
80105deb:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105dee:	8b 55 10             	mov    0x10(%ebp),%edx
80105df1:	8b 45 14             	mov    0x14(%ebp),%eax
80105df4:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105df8:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105dfc:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105e00:	8d 45 de             	lea    -0x22(%ebp),%eax
80105e03:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e07:	8b 45 08             	mov    0x8(%ebp),%eax
80105e0a:	89 04 24             	mov    %eax,(%esp)
80105e0d:	e8 a7 c6 ff ff       	call   801024b9 <nameiparent>
80105e12:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e15:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e19:	75 0a                	jne    80105e25 <create+0x40>
    return 0;
80105e1b:	b8 00 00 00 00       	mov    $0x0,%eax
80105e20:	e9 7e 01 00 00       	jmp    80105fa3 <create+0x1be>
  ilock(dp);
80105e25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e28:	89 04 24             	mov    %eax,(%esp)
80105e2b:	e8 2d bb ff ff       	call   8010195d <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105e30:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e33:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e37:	8d 45 de             	lea    -0x22(%ebp),%eax
80105e3a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e41:	89 04 24             	mov    %eax,(%esp)
80105e44:	e8 c6 c2 ff ff       	call   8010210f <dirlookup>
80105e49:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e50:	74 47                	je     80105e99 <create+0xb4>
    iunlockput(dp);
80105e52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e55:	89 04 24             	mov    %eax,(%esp)
80105e58:	e8 02 bd ff ff       	call   80101b5f <iunlockput>
    ilock(ip);
80105e5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e60:	89 04 24             	mov    %eax,(%esp)
80105e63:	e8 f5 ba ff ff       	call   8010195d <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105e68:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105e6d:	75 15                	jne    80105e84 <create+0x9f>
80105e6f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e72:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105e76:	66 83 f8 02          	cmp    $0x2,%ax
80105e7a:	75 08                	jne    80105e84 <create+0x9f>
      return ip;
80105e7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e7f:	e9 1f 01 00 00       	jmp    80105fa3 <create+0x1be>
    iunlockput(ip);
80105e84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e87:	89 04 24             	mov    %eax,(%esp)
80105e8a:	e8 d0 bc ff ff       	call   80101b5f <iunlockput>
    return 0;
80105e8f:	b8 00 00 00 00       	mov    $0x0,%eax
80105e94:	e9 0a 01 00 00       	jmp    80105fa3 <create+0x1be>
  }
...
80105ea2:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ea6:	89 04 24             	mov    %eax,(%esp)
80105ea9:	e8 15 b8 ff ff       	call   801016c3 <ialloc>
80105eae:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105eb1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105eb5:	75 0c                	jne    80105ec3 <create+0xde>
    panic("create: ialloc");
80105eb7:	c7 04 24 d4 89 10 80 	movl   $0x801089d4,(%esp)
80105ebe:	e8 9f a6 ff ff       	call   80100562 <panic>

  ilock(ip);
80105ec3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec6:	89 04 24             	mov    %eax,(%esp)
80105ec9:	e8 8f ba ff ff       	call   8010195d <ilock>
  ip->major = major;
80105ece:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed1:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105ed5:	66 89 50 52          	mov    %dx,0x52(%eax)
  ip->minor = minor;
80105ed9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105edc:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105ee0:	66 89 50 54          	mov    %dx,0x54(%eax)
  ip->nlink = 1;
80105ee4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ee7:	66 c7 40 56 01 00    	movw   $0x1,0x56(%eax)
  iupdate(ip);
80105eed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ef0:	89 04 24             	mov    %eax,(%esp)
80105ef3:	e8 a0 b8 ff ff       	call   80101798 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105ef8:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105efd:	75 6a                	jne    80105f69 <create+0x184>
    dp->nlink++;  // for ".."
80105eff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f02:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105f06:	8d 50 01             	lea    0x1(%eax),%edx
80105f09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0c:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105f10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f13:	89 04 24             	mov    %eax,(%esp)
80105f16:	e8 7d b8 ff ff       	call   80101798 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105f1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f1e:	8b 40 04             	mov    0x4(%eax),%eax
80105f21:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f25:	c7 44 24 04 ae 89 10 	movl   $0x801089ae,0x4(%esp)
80105f2c:	80 
80105f2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f30:	89 04 24             	mov    %eax,(%esp)
80105f33:	e8 a0 c2 ff ff       	call   801021d8 <dirlink>
80105f38:	85 c0                	test   %eax,%eax
80105f3a:	78 21                	js     80105f5d <create+0x178>
80105f3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f3f:	8b 40 04             	mov    0x4(%eax),%eax
80105f42:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f46:	c7 44 24 04 b0 89 10 	movl   $0x801089b0,0x4(%esp)
80105f4d:	80 
80105f4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f51:	89 04 24             	mov    %eax,(%esp)
80105f54:	e8 7f c2 ff ff       	call   801021d8 <dirlink>
80105f59:	85 c0                	test   %eax,%eax
80105f5b:	79 0c                	jns    80105f69 <create+0x184>
      panic("create dots");
80105f5d:	c7 04 24 e3 89 10 80 	movl   $0x801089e3,(%esp)
80105f64:	e8 f9 a5 ff ff       	call   80100562 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105f69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f6c:	8b 40 04             	mov    0x4(%eax),%eax
80105f6f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f73:	8d 45 de             	lea    -0x22(%ebp),%eax
80105f76:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f7d:	89 04 24             	mov    %eax,(%esp)
80105f80:	e8 53 c2 ff ff       	call   801021d8 <dirlink>
80105f85:	85 c0                	test   %eax,%eax
80105f87:	79 0c                	jns    80105f95 <create+0x1b0>
    panic("create: dirlink");
80105f89:	c7 04 24 ef 89 10 80 	movl   $0x801089ef,(%esp)
80105f90:	e8 cd a5 ff ff       	call   80100562 <panic>

  iunlockput(dp);
80105f95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f98:	89 04 24             	mov    %eax,(%esp)
80105f9b:	e8 bf bb ff ff       	call   80101b5f <iunlockput>
...
80105fa8:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105fab:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105fae:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fb2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fb9:	e8 e0 f6 ff ff       	call   8010569e <argstr>
80105fbe:	85 c0                	test   %eax,%eax
80105fc0:	78 17                	js     80105fd9 <sys_open+0x34>
80105fc2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105fc5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fd0:	e8 32 f6 ff ff       	call   80105607 <argint>
80105fd5:	85 c0                	test   %eax,%eax
80105fd7:	79 0a                	jns    80105fe3 <sys_open+0x3e>
    return -1;
80105fd9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fde:	e9 5c 01 00 00       	jmp    8010613f <sys_open+0x19a>

  begin_op();
80105fe3:	e8 9f d4 ff ff       	call   80103487 <begin_op>

  if(omode & O_CREATE){
80105fe8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105feb:	25 00 02 00 00       	and    $0x200,%eax
80105ff0:	85 c0                	test   %eax,%eax
80105ff2:	74 3b                	je     8010602f <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105ff4:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ff7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105ffe:	00 
80105fff:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106006:	00 
80106007:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010600e:	00 
8010600f:	89 04 24             	mov    %eax,(%esp)
80106012:	e8 ce fd ff ff       	call   80105de5 <create>
80106017:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
8010601a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010601e:	75 6b                	jne    8010608b <sys_open+0xe6>
      end_op();
80106020:	e8 e6 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106025:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010602a:	e9 10 01 00 00       	jmp    8010613f <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
8010602f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106032:	89 04 24             	mov    %eax,(%esp)
80106035:	e8 5d c4 ff ff       	call   80102497 <namei>
8010603a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010603d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106041:	75 0f                	jne    80106052 <sys_open+0xad>
      end_op();
80106043:	e8 c3 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106048:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010604d:	e9 ed 00 00 00       	jmp    8010613f <sys_open+0x19a>
    }
    ilock(ip);
80106052:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106055:	89 04 24             	mov    %eax,(%esp)
80106058:	e8 00 b9 ff ff       	call   8010195d <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010605d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106060:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80106064:	66 83 f8 01          	cmp    $0x1,%ax
80106068:	75 21                	jne    8010608b <sys_open+0xe6>
8010606a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010606d:	85 c0                	test   %eax,%eax
8010606f:	74 1a                	je     8010608b <sys_open+0xe6>
      iunlockput(ip);
80106071:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106074:	89 04 24             	mov    %eax,(%esp)
80106077:	e8 e3 ba ff ff       	call   80101b5f <iunlockput>
      end_op();
8010607c:	e8 8a d4 ff ff       	call   8010350b <end_op>
      return -1;
80106081:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106086:	e9 b4 00 00 00       	jmp    8010613f <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010608b:	e8 f5 ae ff ff       	call   80100f85 <filealloc>
80106090:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106093:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106097:	74 14                	je     801060ad <sys_open+0x108>
80106099:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010609c:	89 04 24             	mov    %eax,(%esp)
8010609f:	e8 2d f7 ff ff       	call   801057d1 <fdalloc>
801060a4:	89 45 ec             	mov    %eax,-0x14(%ebp)
801060a7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801060ab:	79 28                	jns    801060d5 <sys_open+0x130>
    if(f)
801060ad:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060b1:	74 0b                	je     801060be <sys_open+0x119>
      fileclose(f);
801060b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060b6:	89 04 24             	mov    %eax,(%esp)
801060b9:	e8 6f af ff ff       	call   8010102d <fileclose>
    iunlockput(ip);
801060be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060c1:	89 04 24             	mov    %eax,(%esp)
801060c4:	e8 96 ba ff ff       	call   80101b5f <iunlockput>
    end_op();
801060c9:	e8 3d d4 ff ff       	call   8010350b <end_op>
    return -1;
801060ce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060d3:	eb 6a                	jmp    8010613f <sys_open+0x19a>
  }
  iunlock(ip);
801060d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060d8:	89 04 24             	mov    %eax,(%esp)
801060db:	e8 8a b9 ff ff       	call   80101a6a <iunlock>
  end_op();
801060e0:	e8 26 d4 ff ff       	call   8010350b <end_op>

  f->type = FD_INODE;
801060e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060e8:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801060ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801060f4:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
801060f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060fa:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106101:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106104:	83 e0 01             	and    $0x1,%eax
80106107:	85 c0                	test   %eax,%eax
80106109:	0f 94 c0             	sete   %al
8010610c:	89 c2                	mov    %eax,%edx
8010610e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106111:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106114:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106117:	83 e0 01             	and    $0x1,%eax
8010611a:	85 c0                	test   %eax,%eax
8010611c:	75 0a                	jne    80106128 <sys_open+0x183>
8010611e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106121:	83 e0 02             	and    $0x2,%eax
80106124:	85 c0                	test   %eax,%eax
80106126:	74 07                	je     8010612f <sys_open+0x18a>
80106128:	b8 01 00 00 00       	mov    $0x1,%eax
8010612d:	eb 05                	jmp    80106134 <sys_open+0x18f>
8010612f:	b8 00 00 00 00       	mov    $0x0,%eax
80106134:	89 c2                	mov    %eax,%edx
80106136:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106139:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80106144:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106147:	e8 3b d3 ff ff       	call   80103487 <begin_op>
...
8010615a:	e8 3f f5 ff ff       	call   8010569e <argstr>
8010615f:	85 c0                	test   %eax,%eax
80106161:	78 2c                	js     8010618f <sys_mkdir+0x4e>
80106163:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106166:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010616d:	00 
8010616e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106175:	00 
80106176:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010617d:	00 
8010617e:	89 04 24             	mov    %eax,(%esp)
80106181:	e8 5f fc ff ff       	call   80105de5 <create>
80106186:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106189:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010618d:	75 0c                	jne    8010619b <sys_mkdir+0x5a>
    end_op();
8010618f:	e8 77 d3 ff ff       	call   8010350b <end_op>
    return -1;
80106194:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106199:	eb 15                	jmp    801061b0 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010619b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010619e:	89 04 24             	mov    %eax,(%esp)
801061a1:	e8 b9 b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
...
801061b5:	83 ec 28             	sub    $0x28,%esp
  struct inode *ip;
  char *path;
  int major, minor;

  begin_op();
801061b8:	e8 ca d2 ff ff       	call   80103487 <begin_op>
  if((argstr(0, &path)) < 0 ||
801061bd:	8d 45 f0             	lea    -0x10(%ebp),%eax
801061c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801061c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061cb:	e8 ce f4 ff ff       	call   8010569e <argstr>
801061d0:	85 c0                	test   %eax,%eax
801061d2:	78 5e                	js     80106232 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801061d4:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801061db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801061e2:	e8 20 f4 ff ff       	call   80105607 <argint>
  if((argstr(0, &path)) < 0 ||
801061e7:	85 c0                	test   %eax,%eax
801061e9:	78 47                	js     80106232 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801061eb:	8d 45 e8             	lea    -0x18(%ebp),%eax
801061ee:	89 44 24 04          	mov    %eax,0x4(%esp)
801061f2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801061f9:	e8 09 f4 ff ff       	call   80105607 <argint>
     argint(1, &major) < 0 ||
801061fe:	85 c0                	test   %eax,%eax
80106200:	78 30                	js     80106232 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106202:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106205:	0f bf c8             	movswl %ax,%ecx
80106208:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010620b:	0f bf d0             	movswl %ax,%edx
8010620e:	8b 45 f0             	mov    -0x10(%ebp),%eax
     argint(2, &minor) < 0 ||
80106211:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106215:	89 54 24 08          	mov    %edx,0x8(%esp)
80106219:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106220:	00 
80106221:	89 04 24             	mov    %eax,(%esp)
80106224:	e8 bc fb ff ff       	call   80105de5 <create>
80106229:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010622c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106230:	75 0c                	jne    8010623e <sys_mknod+0x8c>
    end_op();
80106232:	e8 d4 d2 ff ff       	call   8010350b <end_op>
    return -1;
80106237:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010623c:	eb 15                	jmp    80106253 <sys_mknod+0xa1>
  }
  iunlockput(ip);
8010623e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106241:	89 04 24             	mov    %eax,(%esp)
80106244:	e8 16 b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
80106249:	e8 bd d2 ff ff       	call   8010350b <end_op>
  return 0;
8010624e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106253:	c9                   	leave  
80106254:	c3                   	ret    
...
80106258:	83 ec 28             	sub    $0x28,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010625b:	e8 01 df ff ff       	call   80104161 <myproc>
80106260:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  begin_op();
80106263:	e8 1f d2 ff ff       	call   80103487 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106268:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010626b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010626f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106276:	e8 23 f4 ff ff       	call   8010569e <argstr>
8010627b:	85 c0                	test   %eax,%eax
8010627d:	78 14                	js     80106293 <sys_chdir+0x3e>
8010627f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106282:	89 04 24             	mov    %eax,(%esp)
80106285:	e8 0d c2 ff ff       	call   80102497 <namei>
8010628a:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010628d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106291:	75 0c                	jne    8010629f <sys_chdir+0x4a>
    end_op();
80106293:	e8 73 d2 ff ff       	call   8010350b <end_op>
    return -1;
80106298:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010629d:	eb 5b                	jmp    801062fa <sys_chdir+0xa5>
  }
  ilock(ip);
8010629f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062a2:	89 04 24             	mov    %eax,(%esp)
801062a5:	e8 b3 b6 ff ff       	call   8010195d <ilock>
  if(ip->type != T_DIR){
801062aa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062ad:	0f b7 40 50          	movzwl 0x50(%eax),%eax
801062b1:	66 83 f8 01          	cmp    $0x1,%ax
801062b5:	74 17                	je     801062ce <sys_chdir+0x79>
    iunlockput(ip);
801062b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062ba:	89 04 24             	mov    %eax,(%esp)
801062bd:	e8 9d b8 ff ff       	call   80101b5f <iunlockput>
    end_op();
801062c2:	e8 44 d2 ff ff       	call   8010350b <end_op>
    return -1;
801062c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062cc:	eb 2c                	jmp    801062fa <sys_chdir+0xa5>
  }
  iunlock(ip);
801062ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062d1:	89 04 24             	mov    %eax,(%esp)
801062d4:	e8 91 b7 ff ff       	call   80101a6a <iunlock>
  iput(curproc->cwd);
801062d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062dc:	8b 40 68             	mov    0x68(%eax),%eax
801062df:	89 04 24             	mov    %eax,(%esp)
801062e2:	e8 c7 b7 ff ff       	call   80101aae <iput>
  end_op();
801062e7:	e8 1f d2 ff ff       	call   8010350b <end_op>
  curproc->cwd = ip;
...
801062ff:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106313:	e8 86 f3 ff ff       	call   8010569e <argstr>
80106318:	85 c0                	test   %eax,%eax
8010631a:	78 1a                	js     80106336 <sys_exec+0x3a>
8010631c:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106322:	89 44 24 04          	mov    %eax,0x4(%esp)
80106326:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010632d:	e8 d5 f2 ff ff       	call   80105607 <argint>
80106332:	85 c0                	test   %eax,%eax
80106334:	79 0a                	jns    80106340 <sys_exec+0x44>
    return -1;
80106336:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010633b:	e9 c8 00 00 00       	jmp    80106408 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106340:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106347:	00 
80106348:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010634f:	00 
80106350:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106356:	89 04 24             	mov    %eax,(%esp)
80106359:	e8 60 ef ff ff       	call   801052be <memset>
  for(i=0;; i++){
8010635e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106365:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106368:	83 f8 1f             	cmp    $0x1f,%eax
8010636b:	76 0a                	jbe    80106377 <sys_exec+0x7b>
      return -1;
8010636d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106372:	e9 91 00 00 00       	jmp    80106408 <sys_exec+0x10c>
...
80106387:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010638d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106391:	89 14 24             	mov    %edx,(%esp)
80106394:	e8 cb f1 ff ff       	call   80105564 <fetchint>
80106399:	85 c0                	test   %eax,%eax
8010639b:	79 07                	jns    801063a4 <sys_exec+0xa8>
      return -1;
8010639d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063a2:	eb 64                	jmp    80106408 <sys_exec+0x10c>
    if(uarg == 0){
801063a4:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801063aa:	85 c0                	test   %eax,%eax
801063ac:	75 26                	jne    801063d4 <sys_exec+0xd8>
      argv[i] = 0;
801063ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063b1:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801063b8:	00 00 00 00 
      break;
801063bc:	90                   	nop
    }
...
801063c0:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801063c6:	89 54 24 04          	mov    %edx,0x4(%esp)
801063ca:	89 04 24             	mov    %eax,(%esp)
801063cd:	e8 4c a7 ff ff       	call   80100b1e <exec>
801063d2:	eb 34                	jmp    80106408 <sys_exec+0x10c>
    if(fetchstr(uarg, &argv[i]) < 0)
801063d4:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801063da:	8b 55 f4             	mov    -0xc(%ebp),%edx
801063dd:	c1 e2 02             	shl    $0x2,%edx
801063e0:	01 c2                	add    %eax,%edx
801063e2:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801063e8:	89 54 24 04          	mov    %edx,0x4(%esp)
801063ec:	89 04 24             	mov    %eax,(%esp)
801063ef:	e8 af f1 ff ff       	call   801055a3 <fetchstr>
801063f4:	85 c0                	test   %eax,%eax
801063f6:	79 07                	jns    801063ff <sys_exec+0x103>
      return -1;
801063f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063fd:	eb 09                	jmp    80106408 <sys_exec+0x10c>
  for(i=0;; i++){
801063ff:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }
80106403:	e9 5d ff ff ff       	jmp    80106365 <sys_exec+0x69>
}
80106408:	c9                   	leave  
80106409:	c3                   	ret    
...
80106410:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106417:	00 
80106418:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010641b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010641f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106426:	e8 09 f2 ff ff       	call   80105634 <argptr>
8010642b:	85 c0                	test   %eax,%eax
8010642d:	79 0a                	jns    80106439 <sys_pipe+0x2f>
    return -1;
8010642f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106434:	e9 9a 00 00 00       	jmp    801064d3 <sys_pipe+0xc9>
...
80106446:	e8 9a d8 ff ff       	call   80103ce5 <pipealloc>
8010644b:	85 c0                	test   %eax,%eax
8010644d:	79 07                	jns    80106456 <sys_pipe+0x4c>
    return -1;
8010644f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106454:	eb 7d                	jmp    801064d3 <sys_pipe+0xc9>
  fd0 = -1;
80106456:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010645d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106460:	89 04 24             	mov    %eax,(%esp)
80106463:	e8 69 f3 ff ff       	call   801057d1 <fdalloc>
80106468:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010646b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010646f:	78 14                	js     80106485 <sys_pipe+0x7b>
80106471:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106474:	89 04 24             	mov    %eax,(%esp)
80106477:	e8 55 f3 ff ff       	call   801057d1 <fdalloc>
8010647c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010647f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106483:	79 36                	jns    801064bb <sys_pipe+0xb1>
    if(fd0 >= 0)
80106485:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106489:	78 13                	js     8010649e <sys_pipe+0x94>
      myproc()->ofile[fd0] = 0;
8010648b:	e8 d1 dc ff ff       	call   80104161 <myproc>
80106490:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106493:	83 c2 08             	add    $0x8,%edx
80106496:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010649d:	00 
    fileclose(rf);
8010649e:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064a1:	89 04 24             	mov    %eax,(%esp)
801064a4:	e8 84 ab ff ff       	call   8010102d <fileclose>
    fileclose(wf);
801064a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064ac:	89 04 24             	mov    %eax,(%esp)
801064af:	e8 79 ab ff ff       	call   8010102d <fileclose>
    return -1;
801064b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064b9:	eb 18                	jmp    801064d3 <sys_pipe+0xc9>
  }
  fd[0] = fd0;
...
801064c6:	8d 50 04             	lea    0x4(%eax),%edx
801064c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064cc:	89 02                	mov    %eax,(%edx)
  return 0;
...
801064d8:	83 ec 08             	sub    $0x8,%esp
  return fork();
801064db:	e8 99 df ff ff       	call   80104479 <fork>
}
801064e0:	c9                   	leave  
801064e1:	c3                   	ret    
...
801064e5:	83 ec 08             	sub    $0x8,%esp
  exit();
801064e8:	e8 1a e1 ff ff       	call   80104607 <exit>
...
801064f7:	83 ec 08             	sub    $0x8,%esp
  return wait();
801064fa:	e8 15 e2 ff ff       	call   80104714 <wait>
}
801064ff:	c9                   	leave  
80106500:	c3                   	ret    
...
80106515:	e8 ed f0 ff ff       	call   80105607 <argint>
8010651a:	85 c0                	test   %eax,%eax
8010651c:	79 07                	jns    80106525 <sys_kill+0x24>
    return -1;
8010651e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106523:	eb 0b                	jmp    80106530 <sys_kill+0x2f>
  return kill(pid);
80106525:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106528:	89 04 24             	mov    %eax,(%esp)
8010652b:	e8 66 e6 ff ff       	call   80104b96 <kill>
}
80106530:	c9                   	leave  
80106531:	c3                   	ret    
...
80106535:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106538:	e8 24 dc ff ff       	call   80104161 <myproc>
8010653d:	8b 40 10             	mov    0x10(%eax),%eax
}
80106540:	c9                   	leave  
80106541:	c3                   	ret    
...
80106556:	e8 ac f0 ff ff       	call   80105607 <argint>
8010655b:	85 c0                	test   %eax,%eax
8010655d:	79 07                	jns    80106566 <sys_sbrk+0x24>
    return -1;
8010655f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106564:	eb 23                	jmp    80106589 <sys_sbrk+0x47>
  addr = myproc()->sz;
80106566:	e8 f6 db ff ff       	call   80104161 <myproc>
...
80106576:	e8 60 de ff ff       	call   801043db <growproc>
8010657b:	85 c0                	test   %eax,%eax
8010657d:	79 07                	jns    80106586 <sys_sbrk+0x44>
    return -1;
8010657f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106584:	eb 03                	jmp    80106589 <sys_sbrk+0x47>
  return addr;
...
8010658e:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
...
8010659f:	e8 63 f0 ff ff       	call   80105607 <argint>
801065a4:	85 c0                	test   %eax,%eax
801065a6:	79 07                	jns    801065af <sys_sleep+0x24>
    return -1;
801065a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065ad:	eb 6b                	jmp    8010661a <sys_sleep+0x8f>
  acquire(&tickslock);
801065af:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
801065b6:	e8 91 ea ff ff       	call   8010504c <acquire>
  ticks0 = ticks;
801065bb:	a1 40 67 11 80       	mov    0x80116740,%eax
801065c0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801065c3:	eb 33                	jmp    801065f8 <sys_sleep+0x6d>
    if(myproc()->killed){
801065c5:	e8 97 db ff ff       	call   80104161 <myproc>
801065ca:	8b 40 24             	mov    0x24(%eax),%eax
801065cd:	85 c0                	test   %eax,%eax
801065cf:	74 13                	je     801065e4 <sys_sleep+0x59>
      release(&tickslock);
801065d1:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
801065d8:	e8 d7 ea ff ff       	call   801050b4 <release>
      return -1;
801065dd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065e2:	eb 36                	jmp    8010661a <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
801065e4:	c7 44 24 04 00 5f 11 	movl   $0x80115f00,0x4(%esp)
801065eb:	80 
801065ec:	c7 04 24 40 67 11 80 	movl   $0x80116740,(%esp)
801065f3:	e8 9c e4 ff ff       	call   80104a94 <sleep>
  while(ticks - ticks0 < n){
801065f8:	a1 40 67 11 80       	mov    0x80116740,%eax
801065fd:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106600:	89 c2                	mov    %eax,%edx
80106602:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106605:	39 c2                	cmp    %eax,%edx
80106607:	72 bc                	jb     801065c5 <sys_sleep+0x3a>
  }
  release(&tickslock);
80106609:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106610:	e8 9f ea ff ff       	call   801050b4 <release>
  return 0;
...
8010661f:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106622:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106629:	e8 1e ea ff ff       	call   8010504c <acquire>
  xticks = ticks;
8010662e:	a1 40 67 11 80       	mov    0x80116740,%eax
80106633:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106636:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
8010663d:	e8 72 ea ff ff       	call   801050b4 <release>
  return xticks;
...
80106647 <sys_getpinfo>:

int sys_getpinfo(void) {  
80106647:	55                   	push   %ebp
80106648:	89 e5                	mov    %esp,%ebp
8010664a:	83 ec 28             	sub    $0x28,%esp

  pstatTable* pTable;
  if(argptr(0, (void*) &pTable, sizeof(*pTable)) < 0)
8010664d:	c7 44 24 08 00 09 00 	movl   $0x900,0x8(%esp)
80106654:	00 
80106655:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106658:	89 44 24 04          	mov    %eax,0x4(%esp)
8010665c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106663:	e8 cc ef ff ff       	call   80105634 <argptr>
80106668:	85 c0                	test   %eax,%eax
8010666a:	79 07                	jns    80106673 <sys_getpinfo+0x2c>
    return -1;
8010666c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106671:	eb 10                	jmp    80106683 <sys_getpinfo+0x3c>
  getpinfo(pTable);
80106673:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106676:	89 04 24             	mov    %eax,(%esp)
80106679:	e8 8d e6 ff ff       	call   80104d0b <getpinfo>
  return 0;
...
80106699:	e8 69 ef ff ff       	call   80105607 <argint>
8010669e:	85 c0                	test   %eax,%eax
801066a0:	79 07                	jns    801066a9 <sys_settickets+0x24>
    return -1;
801066a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066a7:	eb 10                	jmp    801066b9 <sys_settickets+0x34>
  settickets(n);
801066a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ac:	89 04 24             	mov    %eax,(%esp)
801066af:	e8 e9 e7 ff ff       	call   80104e9d <settickets>
  return 0;
...
801066bc:	06                   	push   %es
  pushl %fs
801066bd:	0f a0                	push   %fs
  pushl %gs
801066bf:	0f a8                	push   %gs
  pushal
801066c1:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801066c2:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801066c6:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801066c8:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801066ca:	54                   	push   %esp
  call trap
801066cb:	e8 d8 01 00 00       	call   801068a8 <trap>
  addl $4, %esp
...
801066d3:	61                   	popa   
  popl %gs
801066d4:	0f a9                	pop    %gs
  popl %fs
801066d6:	0f a1                	pop    %fs
  popl %es
801066d8:	07                   	pop    %es
  popl %ds
801066d9:	1f                   	pop    %ds
...
801066e1:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801066e4:	8b 45 0c             	mov    0xc(%ebp),%eax
801066e7:	83 e8 01             	sub    $0x1,%eax
801066ea:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801066ee:	8b 45 08             	mov    0x8(%ebp),%eax
801066f1:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
...
8010670d:	0f 20 d0             	mov    %cr2,%eax
80106710:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106713:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106716:	c9                   	leave  
80106717:	c3                   	ret    
...
8010671b:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
8010671e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106725:	e9 c3 00 00 00       	jmp    801067ed <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010672a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010672d:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
80106734:	89 c2                	mov    %eax,%edx
80106736:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106739:	66 89 14 c5 40 5f 11 	mov    %dx,-0x7feea0c0(,%eax,8)
80106740:	80 
80106741:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106744:	66 c7 04 c5 42 5f 11 	movw   $0x8,-0x7feea0be(,%eax,8)
8010674b:	80 08 00 
8010674e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106751:	0f b6 14 c5 44 5f 11 	movzbl -0x7feea0bc(,%eax,8),%edx
80106758:	80 
80106759:	83 e2 e0             	and    $0xffffffe0,%edx
8010675c:	88 14 c5 44 5f 11 80 	mov    %dl,-0x7feea0bc(,%eax,8)
80106763:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106766:	0f b6 14 c5 44 5f 11 	movzbl -0x7feea0bc(,%eax,8),%edx
8010676d:	80 
8010676e:	83 e2 1f             	and    $0x1f,%edx
80106771:	88 14 c5 44 5f 11 80 	mov    %dl,-0x7feea0bc(,%eax,8)
80106778:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010677b:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
80106782:	80 
80106783:	83 e2 f0             	and    $0xfffffff0,%edx
80106786:	83 ca 0e             	or     $0xe,%edx
80106789:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
80106790:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106793:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
8010679a:	80 
8010679b:	83 e2 ef             	and    $0xffffffef,%edx
8010679e:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
801067a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067a8:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
801067af:	80 
801067b0:	83 e2 9f             	and    $0xffffff9f,%edx
801067b3:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
801067ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067bd:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
801067c4:	80 
801067c5:	83 ca 80             	or     $0xffffff80,%edx
801067c8:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
801067cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067d2:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
801067d9:	c1 e8 10             	shr    $0x10,%eax
801067dc:	89 c2                	mov    %eax,%edx
801067de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067e1:	66 89 14 c5 46 5f 11 	mov    %dx,-0x7feea0ba(,%eax,8)
801067e8:	80 
  for(i = 0; i < 256; i++)
801067e9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801067ed:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801067f4:	0f 8e 30 ff ff ff    	jle    8010672a <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801067fa:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
801067ff:	66 a3 40 61 11 80    	mov    %ax,0x80116140
80106805:	66 c7 05 42 61 11 80 	movw   $0x8,0x80116142
8010680c:	08 00 
8010680e:	0f b6 05 44 61 11 80 	movzbl 0x80116144,%eax
80106815:	83 e0 e0             	and    $0xffffffe0,%eax
80106818:	a2 44 61 11 80       	mov    %al,0x80116144
8010681d:	0f b6 05 44 61 11 80 	movzbl 0x80116144,%eax
80106824:	83 e0 1f             	and    $0x1f,%eax
80106827:	a2 44 61 11 80       	mov    %al,0x80116144
8010682c:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106833:	83 c8 0f             	or     $0xf,%eax
80106836:	a2 45 61 11 80       	mov    %al,0x80116145
8010683b:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106842:	83 e0 ef             	and    $0xffffffef,%eax
80106845:	a2 45 61 11 80       	mov    %al,0x80116145
8010684a:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106851:	83 c8 60             	or     $0x60,%eax
80106854:	a2 45 61 11 80       	mov    %al,0x80116145
80106859:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106860:	83 c8 80             	or     $0xffffff80,%eax
80106863:	a2 45 61 11 80       	mov    %al,0x80116145
80106868:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
8010686d:	c1 e8 10             	shr    $0x10,%eax
80106870:	66 a3 46 61 11 80    	mov    %ax,0x80116146

  initlock(&tickslock, "time");
80106876:	c7 44 24 04 00 8a 10 	movl   $0x80108a00,0x4(%esp)
8010687d:	80 
8010687e:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106885:	e8 a1 e7 ff ff       	call   8010502b <initlock>
}
8010688a:	c9                   	leave  
8010688b:	c3                   	ret    
...
8010688f:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106892:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106899:	00 
8010689a:	c7 04 24 40 5f 11 80 	movl   $0x80115f40,(%esp)
801068a1:	e8 38 fe ff ff       	call   801066de <lidt>
}
801068a6:	c9                   	leave  
801068a7:	c3                   	ret    
...
801068ae:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801068b1:	8b 45 08             	mov    0x8(%ebp),%eax
801068b4:	8b 40 30             	mov    0x30(%eax),%eax
801068b7:	83 f8 40             	cmp    $0x40,%eax
801068ba:	75 3c                	jne    801068f8 <trap+0x50>
    if(myproc()->killed)
801068bc:	e8 a0 d8 ff ff       	call   80104161 <myproc>
801068c1:	8b 40 24             	mov    0x24(%eax),%eax
801068c4:	85 c0                	test   %eax,%eax
801068c6:	74 05                	je     801068cd <trap+0x25>
      exit();
801068c8:	e8 3a dd ff ff       	call   80104607 <exit>
    myproc()->tf = tf;
801068cd:	e8 8f d8 ff ff       	call   80104161 <myproc>
801068d2:	8b 55 08             	mov    0x8(%ebp),%edx
801068d5:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801068d8:	e8 f8 ed ff ff       	call   801056d5 <syscall>
    if(myproc()->killed)
801068dd:	e8 7f d8 ff ff       	call   80104161 <myproc>
801068e2:	8b 40 24             	mov    0x24(%eax),%eax
801068e5:	85 c0                	test   %eax,%eax
801068e7:	74 0a                	je     801068f3 <trap+0x4b>
      exit();
801068e9:	e8 19 dd ff ff       	call   80104607 <exit>
    return;
801068ee:	e9 19 02 00 00       	jmp    80106b0c <trap+0x264>
801068f3:	e9 14 02 00 00       	jmp    80106b0c <trap+0x264>
  }

  switch(tf->trapno){
801068f8:	8b 45 08             	mov    0x8(%ebp),%eax
801068fb:	8b 40 30             	mov    0x30(%eax),%eax
801068fe:	83 e8 20             	sub    $0x20,%eax
80106901:	83 f8 1f             	cmp    $0x1f,%eax
80106904:	0f 87 b1 00 00 00    	ja     801069bb <trap+0x113>
8010690a:	8b 04 85 a8 8a 10 80 	mov    -0x7fef7558(,%eax,4),%eax
80106911:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106913:	e8 b2 d7 ff ff       	call   801040ca <cpuid>
80106918:	85 c0                	test   %eax,%eax
8010691a:	75 31                	jne    8010694d <trap+0xa5>
      acquire(&tickslock);
8010691c:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106923:	e8 24 e7 ff ff       	call   8010504c <acquire>
      ticks++;
80106928:	a1 40 67 11 80       	mov    0x80116740,%eax
8010692d:	83 c0 01             	add    $0x1,%eax
80106930:	a3 40 67 11 80       	mov    %eax,0x80116740
      wakeup(&ticks);
80106935:	c7 04 24 40 67 11 80 	movl   $0x80116740,(%esp)
8010693c:	e8 2a e2 ff ff       	call   80104b6b <wakeup>
      release(&tickslock);
80106941:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106948:	e8 67 e7 ff ff       	call   801050b4 <release>
    }
    lapiceoi();
8010694d:	e8 ff c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106952:	e9 37 01 00 00       	jmp    80106a8e <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106957:	e8 6c be ff ff       	call   801027c8 <ideintr>
    lapiceoi();
8010695c:	e8 f0 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106961:	e9 28 01 00 00       	jmp    80106a8e <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106966:	e8 fb c3 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
8010696b:	e8 e1 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106970:	e9 19 01 00 00       	jmp    80106a8e <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106975:	e8 7b 03 00 00       	call   80106cf5 <uartintr>
    lapiceoi();
8010697a:	e8 d2 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
8010697f:	e9 0a 01 00 00       	jmp    80106a8e <trap+0x1e6>
  case T_IRQ0 + 7:
...
8010698d:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106991:	0f b7 d8             	movzwl %ax,%ebx
80106994:	e8 31 d7 ff ff       	call   801040ca <cpuid>
80106999:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010699d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801069a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801069a5:	c7 04 24 08 8a 10 80 	movl   $0x80108a08,(%esp)
801069ac:	e8 17 9a ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801069b1:	e8 9b c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069b6:	e9 d3 00 00 00       	jmp    80106a8e <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801069bb:	e8 a1 d7 ff ff       	call   80104161 <myproc>
801069c0:	85 c0                	test   %eax,%eax
801069c2:	74 11                	je     801069d5 <trap+0x12d>
...
801069d3:	75 40                	jne    80106a15 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801069d5:	e8 2d fd ff ff       	call   80106707 <rcr2>
801069da:	89 c3                	mov    %eax,%ebx
801069dc:	8b 45 08             	mov    0x8(%ebp),%eax
801069df:	8b 70 38             	mov    0x38(%eax),%esi
801069e2:	e8 e3 d6 ff ff       	call   801040ca <cpuid>
801069e7:	8b 55 08             	mov    0x8(%ebp),%edx
801069ea:	8b 52 30             	mov    0x30(%edx),%edx
801069ed:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801069f1:	89 74 24 0c          	mov    %esi,0xc(%esp)
801069f5:	89 44 24 08          	mov    %eax,0x8(%esp)
801069f9:	89 54 24 04          	mov    %edx,0x4(%esp)
801069fd:	c7 04 24 2c 8a 10 80 	movl   $0x80108a2c,(%esp)
80106a04:	e8 bf 99 ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106a09:	c7 04 24 5e 8a 10 80 	movl   $0x80108a5e,(%esp)
80106a10:	e8 4d 9b ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a15:	e8 ed fc ff ff       	call   80106707 <rcr2>
80106a1a:	89 c6                	mov    %eax,%esi
80106a1c:	8b 45 08             	mov    0x8(%ebp),%eax
80106a1f:	8b 40 38             	mov    0x38(%eax),%eax
80106a22:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a25:	e8 a0 d6 ff ff       	call   801040ca <cpuid>
80106a2a:	89 c3                	mov    %eax,%ebx
80106a2c:	8b 45 08             	mov    0x8(%ebp),%eax
80106a2f:	8b 78 34             	mov    0x34(%eax),%edi
80106a32:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106a35:	8b 45 08             	mov    0x8(%ebp),%eax
80106a38:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a3b:	e8 21 d7 ff ff       	call   80104161 <myproc>
80106a40:	8d 50 6c             	lea    0x6c(%eax),%edx
80106a43:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106a46:	e8 16 d7 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a4b:	8b 40 10             	mov    0x10(%eax),%eax
80106a4e:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106a52:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106a55:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106a59:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106a5d:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106a60:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106a64:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106a68:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106a6b:	89 54 24 08          	mov    %edx,0x8(%esp)
80106a6f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a73:	c7 04 24 64 8a 10 80 	movl   $0x80108a64,(%esp)
80106a7a:	e8 49 99 ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80106a7f:	e8 dd d6 ff ff       	call   80104161 <myproc>
80106a84:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106a8b:	eb 01                	jmp    80106a8e <trap+0x1e6>
    break;
80106a8d:	90                   	nop
  }
...
80106a95:	74 23                	je     80106aba <trap+0x212>
80106a97:	e8 c5 d6 ff ff       	call   80104161 <myproc>
80106a9c:	8b 40 24             	mov    0x24(%eax),%eax
80106a9f:	85 c0                	test   %eax,%eax
80106aa1:	74 17                	je     80106aba <trap+0x212>
...
80106ab3:	75 05                	jne    80106aba <trap+0x212>
    exit();
80106ab5:	e8 4d db ff ff       	call   80104607 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106aba:	e8 a2 d6 ff ff       	call   80104161 <myproc>
80106abf:	85 c0                	test   %eax,%eax
80106ac1:	74 1d                	je     80106ae0 <trap+0x238>
80106ac3:	e8 99 d6 ff ff       	call   80104161 <myproc>
80106ac8:	8b 40 0c             	mov    0xc(%eax),%eax
80106acb:	83 f8 04             	cmp    $0x4,%eax
80106ace:	75 10                	jne    80106ae0 <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
80106ad0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ad3:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106ad6:	83 f8 20             	cmp    $0x20,%eax
80106ad9:	75 05                	jne    80106ae0 <trap+0x238>
    yield();
80106adb:	e8 44 df ff ff       	call   80104a24 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106ae0:	e8 7c d6 ff ff       	call   80104161 <myproc>
80106ae5:	85 c0                	test   %eax,%eax
80106ae7:	74 23                	je     80106b0c <trap+0x264>
80106ae9:	e8 73 d6 ff ff       	call   80104161 <myproc>
80106aee:	8b 40 24             	mov    0x24(%eax),%eax
80106af1:	85 c0                	test   %eax,%eax
80106af3:	74 17                	je     80106b0c <trap+0x264>
...
80106b05:	75 05                	jne    80106b0c <trap+0x264>
    exit();
80106b07:	e8 fb da ff ff       	call   80104607 <exit>
}
80106b0c:	83 c4 3c             	add    $0x3c,%esp
80106b0f:	5b                   	pop    %ebx
80106b10:	5e                   	pop    %esi
80106b11:	5f                   	pop    %edi
80106b12:	5d                   	pop    %ebp
...
80106bef:	75 02                	jne    80106bf3 <uartinit+0xa4>
    return;
80106bf1:	eb 5e                	jmp    80106c51 <uartinit+0x102>
  uart = 1;
80106bf3:	c7 05 44 b6 10 80 01 	movl   $0x1,0x8010b644
80106bfa:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106bfd:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106c04:	e8 0b ff ff ff       	call   80106b14 <inb>
  inb(COM1+0);
80106c09:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c10:	e8 ff fe ff ff       	call   80106b14 <inb>
  ioapicenable(IRQ_COM1, 0);
80106c15:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c1c:	00 
80106c1d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106c24:	e8 16 be ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106c29:	c7 45 f4 28 8b 10 80 	movl   $0x80108b28,-0xc(%ebp)
80106c30:	eb 15                	jmp    80106c47 <uartinit+0xf8>
    uartputc(*p);
80106c32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c35:	0f b6 00             	movzbl (%eax),%eax
80106c38:	0f be c0             	movsbl %al,%eax
80106c3b:	89 04 24             	mov    %eax,(%esp)
80106c3e:	e8 10 00 00 00       	call   80106c53 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106c43:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c4a:	0f b6 00             	movzbl (%eax),%eax
80106c4d:	84 c0                	test   %al,%al
80106c4f:	75 e1                	jne    80106c32 <uartinit+0xe3>
}
80106c51:	c9                   	leave  
80106c52:	c3                   	ret    
...
80106c56:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106c59:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80106c5e:	85 c0                	test   %eax,%eax
80106c60:	75 02                	jne    80106c64 <uartputc+0x11>
    return;
80106c62:	eb 4b                	jmp    80106caf <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c64:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c6b:	eb 10                	jmp    80106c7d <uartputc+0x2a>
    microdelay(10);
80106c6d:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106c74:	e8 fd c2 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c79:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c7d:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106c81:	7f 16                	jg     80106c99 <uartputc+0x46>
80106c83:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c8a:	e8 85 fe ff ff       	call   80106b14 <inb>
80106c8f:	0f b6 c0             	movzbl %al,%eax
80106c92:	83 e0 20             	and    $0x20,%eax
80106c95:	85 c0                	test   %eax,%eax
80106c97:	74 d4                	je     80106c6d <uartputc+0x1a>
  outb(COM1+0, c);
80106c99:	8b 45 08             	mov    0x8(%ebp),%eax
80106c9c:	0f b6 c0             	movzbl %al,%eax
80106c9f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ca3:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106caa:	e8 82 fe ff ff       	call   80106b31 <outb>
}
80106caf:	c9                   	leave  
80106cb0:	c3                   	ret    
...
80106cb4:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106cb7:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80106cbc:	85 c0                	test   %eax,%eax
80106cbe:	75 07                	jne    80106cc7 <uartgetc+0x16>
    return -1;
80106cc0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cc5:	eb 2c                	jmp    80106cf3 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106cc7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106cce:	e8 41 fe ff ff       	call   80106b14 <inb>
80106cd3:	0f b6 c0             	movzbl %al,%eax
80106cd6:	83 e0 01             	and    $0x1,%eax
80106cd9:	85 c0                	test   %eax,%eax
80106cdb:	75 07                	jne    80106ce4 <uartgetc+0x33>
    return -1;
80106cdd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ce2:	eb 0f                	jmp    80106cf3 <uartgetc+0x42>
  return inb(COM1+0);
80106ce4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106ceb:	e8 24 fe ff ff       	call   80106b14 <inb>
...
80106cfb:	c7 04 24 b1 6c 10 80 	movl   $0x80106cb1,(%esp)
80106d02:	e8 e2 9a ff ff       	call   801007e9 <consoleintr>
}
80106d07:	c9                   	leave  
80106d08:	c3                   	ret    
...
80106d0b:	6a 00                	push   $0x0
  jmp alltraps
80106d0d:	e9 a9 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d12:	6a 00                	push   $0x0
  pushl $1
80106d14:	6a 01                	push   $0x1
  jmp alltraps
80106d16:	e9 a0 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d1b:	6a 00                	push   $0x0
  pushl $2
80106d1d:	6a 02                	push   $0x2
  jmp alltraps
80106d1f:	e9 97 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d24:	6a 00                	push   $0x0
  pushl $3
80106d26:	6a 03                	push   $0x3
  jmp alltraps
80106d28:	e9 8e f9 ff ff       	jmp    801066bb <alltraps>
...
80106d2f:	6a 04                	push   $0x4
  jmp alltraps
80106d31:	e9 85 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d36:	6a 00                	push   $0x0
  pushl $5
80106d38:	6a 05                	push   $0x5
  jmp alltraps
80106d3a:	e9 7c f9 ff ff       	jmp    801066bb <alltraps>
...
80106d41:	6a 06                	push   $0x6
  jmp alltraps
80106d43:	e9 73 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d48:	6a 00                	push   $0x0
  pushl $7
80106d4a:	6a 07                	push   $0x7
  jmp alltraps
80106d4c:	e9 6a f9 ff ff       	jmp    801066bb <alltraps>

80106d51 <vector8>:
.globl vector8
vector8:
  pushl $8
80106d51:	6a 08                	push   $0x8
  jmp alltraps
80106d53:	e9 63 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $9
80106d5a:	6a 09                	push   $0x9
  jmp alltraps
80106d5c:	e9 5a f9 ff ff       	jmp    801066bb <alltraps>

80106d61 <vector10>:
.globl vector10
vector10:
  pushl $10
80106d61:	6a 0a                	push   $0xa
  jmp alltraps
80106d63:	e9 53 f9 ff ff       	jmp    801066bb <alltraps>

80106d68 <vector11>:
.globl vector11
vector11:
  pushl $11
80106d68:	6a 0b                	push   $0xb
  jmp alltraps
80106d6a:	e9 4c f9 ff ff       	jmp    801066bb <alltraps>

80106d6f <vector12>:
.globl vector12
vector12:
  pushl $12
80106d6f:	6a 0c                	push   $0xc
  jmp alltraps
80106d71:	e9 45 f9 ff ff       	jmp    801066bb <alltraps>

80106d76 <vector13>:
.globl vector13
vector13:
  pushl $13
80106d76:	6a 0d                	push   $0xd
  jmp alltraps
80106d78:	e9 3e f9 ff ff       	jmp    801066bb <alltraps>

80106d7d <vector14>:
.globl vector14
vector14:
  pushl $14
80106d7d:	6a 0e                	push   $0xe
  jmp alltraps
80106d7f:	e9 37 f9 ff ff       	jmp    801066bb <alltraps>
...
80106d84:	6a 00                	push   $0x0
  pushl $15
80106d86:	6a 0f                	push   $0xf
  jmp alltraps
80106d88:	e9 2e f9 ff ff       	jmp    801066bb <alltraps>
...
80106d8d:	6a 00                	push   $0x0
  pushl $16
80106d8f:	6a 10                	push   $0x10
  jmp alltraps
80106d91:	e9 25 f9 ff ff       	jmp    801066bb <alltraps>

80106d96 <vector17>:
.globl vector17
vector17:
  pushl $17
80106d96:	6a 11                	push   $0x11
  jmp alltraps
80106d98:	e9 1e f9 ff ff       	jmp    801066bb <alltraps>
...
80106d9d:	6a 00                	push   $0x0
  pushl $18
80106d9f:	6a 12                	push   $0x12
  jmp alltraps
80106da1:	e9 15 f9 ff ff       	jmp    801066bb <alltraps>
...
80106da6:	6a 00                	push   $0x0
  pushl $19
80106da8:	6a 13                	push   $0x13
  jmp alltraps
80106daa:	e9 0c f9 ff ff       	jmp    801066bb <alltraps>
...
80106daf:	6a 00                	push   $0x0
  pushl $20
80106db1:	6a 14                	push   $0x14
  jmp alltraps
80106db3:	e9 03 f9 ff ff       	jmp    801066bb <alltraps>
...
80106db8:	6a 00                	push   $0x0
  pushl $21
80106dba:	6a 15                	push   $0x15
  jmp alltraps
80106dbc:	e9 fa f8 ff ff       	jmp    801066bb <alltraps>
...
80106dc1:	6a 00                	push   $0x0
  pushl $22
80106dc3:	6a 16                	push   $0x16
  jmp alltraps
80106dc5:	e9 f1 f8 ff ff       	jmp    801066bb <alltraps>
...
80106dca:	6a 00                	push   $0x0
  pushl $23
80106dcc:	6a 17                	push   $0x17
  jmp alltraps
80106dce:	e9 e8 f8 ff ff       	jmp    801066bb <alltraps>
...
80106dd3:	6a 00                	push   $0x0
  pushl $24
80106dd5:	6a 18                	push   $0x18
  jmp alltraps
80106dd7:	e9 df f8 ff ff       	jmp    801066bb <alltraps>
...
80106ddc:	6a 00                	push   $0x0
  pushl $25
80106dde:	6a 19                	push   $0x19
  jmp alltraps
80106de0:	e9 d6 f8 ff ff       	jmp    801066bb <alltraps>
...
80106de5:	6a 00                	push   $0x0
  pushl $26
80106de7:	6a 1a                	push   $0x1a
  jmp alltraps
80106de9:	e9 cd f8 ff ff       	jmp    801066bb <alltraps>
...
80106dee:	6a 00                	push   $0x0
  pushl $27
80106df0:	6a 1b                	push   $0x1b
  jmp alltraps
80106df2:	e9 c4 f8 ff ff       	jmp    801066bb <alltraps>
...
80106df7:	6a 00                	push   $0x0
  pushl $28
80106df9:	6a 1c                	push   $0x1c
  jmp alltraps
80106dfb:	e9 bb f8 ff ff       	jmp    801066bb <alltraps>
...
80106e00:	6a 00                	push   $0x0
  pushl $29
80106e02:	6a 1d                	push   $0x1d
  jmp alltraps
80106e04:	e9 b2 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e09:	6a 00                	push   $0x0
  pushl $30
80106e0b:	6a 1e                	push   $0x1e
  jmp alltraps
80106e0d:	e9 a9 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e12:	6a 00                	push   $0x0
  pushl $31
80106e14:	6a 1f                	push   $0x1f
  jmp alltraps
80106e16:	e9 a0 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e1b:	6a 00                	push   $0x0
  pushl $32
80106e1d:	6a 20                	push   $0x20
  jmp alltraps
80106e1f:	e9 97 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e24:	6a 00                	push   $0x0
  pushl $33
80106e26:	6a 21                	push   $0x21
  jmp alltraps
80106e28:	e9 8e f8 ff ff       	jmp    801066bb <alltraps>
...
80106e2d:	6a 00                	push   $0x0
  pushl $34
80106e2f:	6a 22                	push   $0x22
  jmp alltraps
80106e31:	e9 85 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e36:	6a 00                	push   $0x0
  pushl $35
80106e38:	6a 23                	push   $0x23
  jmp alltraps
80106e3a:	e9 7c f8 ff ff       	jmp    801066bb <alltraps>
...
80106e3f:	6a 00                	push   $0x0
  pushl $36
80106e41:	6a 24                	push   $0x24
  jmp alltraps
80106e43:	e9 73 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e48:	6a 00                	push   $0x0
  pushl $37
80106e4a:	6a 25                	push   $0x25
  jmp alltraps
80106e4c:	e9 6a f8 ff ff       	jmp    801066bb <alltraps>
...
80106e51:	6a 00                	push   $0x0
  pushl $38
80106e53:	6a 26                	push   $0x26
  jmp alltraps
80106e55:	e9 61 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e5a:	6a 00                	push   $0x0
  pushl $39
80106e5c:	6a 27                	push   $0x27
  jmp alltraps
80106e5e:	e9 58 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e63:	6a 00                	push   $0x0
  pushl $40
80106e65:	6a 28                	push   $0x28
  jmp alltraps
80106e67:	e9 4f f8 ff ff       	jmp    801066bb <alltraps>
...
80106e6c:	6a 00                	push   $0x0
  pushl $41
80106e6e:	6a 29                	push   $0x29
  jmp alltraps
80106e70:	e9 46 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e75:	6a 00                	push   $0x0
  pushl $42
80106e77:	6a 2a                	push   $0x2a
  jmp alltraps
80106e79:	e9 3d f8 ff ff       	jmp    801066bb <alltraps>
...
80106e7e:	6a 00                	push   $0x0
  pushl $43
80106e80:	6a 2b                	push   $0x2b
  jmp alltraps
80106e82:	e9 34 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e87:	6a 00                	push   $0x0
  pushl $44
80106e89:	6a 2c                	push   $0x2c
  jmp alltraps
80106e8b:	e9 2b f8 ff ff       	jmp    801066bb <alltraps>
...
80106e90:	6a 00                	push   $0x0
  pushl $45
80106e92:	6a 2d                	push   $0x2d
  jmp alltraps
80106e94:	e9 22 f8 ff ff       	jmp    801066bb <alltraps>
...
80106e99:	6a 00                	push   $0x0
  pushl $46
80106e9b:	6a 2e                	push   $0x2e
  jmp alltraps
80106e9d:	e9 19 f8 ff ff       	jmp    801066bb <alltraps>
...
80106ea2:	6a 00                	push   $0x0
  pushl $47
80106ea4:	6a 2f                	push   $0x2f
  jmp alltraps
80106ea6:	e9 10 f8 ff ff       	jmp    801066bb <alltraps>
...
80106eab:	6a 00                	push   $0x0
  pushl $48
80106ead:	6a 30                	push   $0x30
  jmp alltraps
80106eaf:	e9 07 f8 ff ff       	jmp    801066bb <alltraps>
...
80106eb4:	6a 00                	push   $0x0
  pushl $49
80106eb6:	6a 31                	push   $0x31
  jmp alltraps
80106eb8:	e9 fe f7 ff ff       	jmp    801066bb <alltraps>
...
80106ebd:	6a 00                	push   $0x0
  pushl $50
80106ebf:	6a 32                	push   $0x32
  jmp alltraps
80106ec1:	e9 f5 f7 ff ff       	jmp    801066bb <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $51
80106ec8:	6a 33                	push   $0x33
  jmp alltraps
80106eca:	e9 ec f7 ff ff       	jmp    801066bb <alltraps>
...
80106ecf:	6a 00                	push   $0x0
  pushl $52
80106ed1:	6a 34                	push   $0x34
  jmp alltraps
80106ed3:	e9 e3 f7 ff ff       	jmp    801066bb <alltraps>
...
80106ed8:	6a 00                	push   $0x0
  pushl $53
80106eda:	6a 35                	push   $0x35
  jmp alltraps
80106edc:	e9 da f7 ff ff       	jmp    801066bb <alltraps>
...
80106ee1:	6a 00                	push   $0x0
  pushl $54
80106ee3:	6a 36                	push   $0x36
  jmp alltraps
80106ee5:	e9 d1 f7 ff ff       	jmp    801066bb <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $55
80106eec:	6a 37                	push   $0x37
  jmp alltraps
80106eee:	e9 c8 f7 ff ff       	jmp    801066bb <alltraps>
...
80106ef3:	6a 00                	push   $0x0
  pushl $56
80106ef5:	6a 38                	push   $0x38
  jmp alltraps
80106ef7:	e9 bf f7 ff ff       	jmp    801066bb <alltraps>
...
80106efc:	6a 00                	push   $0x0
  pushl $57
80106efe:	6a 39                	push   $0x39
  jmp alltraps
80106f00:	e9 b6 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f05:	6a 00                	push   $0x0
  pushl $58
80106f07:	6a 3a                	push   $0x3a
  jmp alltraps
80106f09:	e9 ad f7 ff ff       	jmp    801066bb <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $59
80106f10:	6a 3b                	push   $0x3b
  jmp alltraps
80106f12:	e9 a4 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f17:	6a 00                	push   $0x0
  pushl $60
80106f19:	6a 3c                	push   $0x3c
  jmp alltraps
80106f1b:	e9 9b f7 ff ff       	jmp    801066bb <alltraps>
...
80106f20:	6a 00                	push   $0x0
  pushl $61
80106f22:	6a 3d                	push   $0x3d
  jmp alltraps
80106f24:	e9 92 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f29:	6a 00                	push   $0x0
  pushl $62
80106f2b:	6a 3e                	push   $0x3e
  jmp alltraps
80106f2d:	e9 89 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $63
80106f34:	6a 3f                	push   $0x3f
  jmp alltraps
80106f36:	e9 80 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f3b:	6a 00                	push   $0x0
  pushl $64
80106f3d:	6a 40                	push   $0x40
  jmp alltraps
80106f3f:	e9 77 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f44:	6a 00                	push   $0x0
  pushl $65
80106f46:	6a 41                	push   $0x41
  jmp alltraps
80106f48:	e9 6e f7 ff ff       	jmp    801066bb <alltraps>
...
80106f4d:	6a 00                	push   $0x0
  pushl $66
80106f4f:	6a 42                	push   $0x42
  jmp alltraps
80106f51:	e9 65 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $67
80106f58:	6a 43                	push   $0x43
  jmp alltraps
80106f5a:	e9 5c f7 ff ff       	jmp    801066bb <alltraps>
...
80106f5f:	6a 00                	push   $0x0
  pushl $68
80106f61:	6a 44                	push   $0x44
  jmp alltraps
80106f63:	e9 53 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f68:	6a 00                	push   $0x0
  pushl $69
80106f6a:	6a 45                	push   $0x45
  jmp alltraps
80106f6c:	e9 4a f7 ff ff       	jmp    801066bb <alltraps>
...
80106f71:	6a 00                	push   $0x0
  pushl $70
80106f73:	6a 46                	push   $0x46
  jmp alltraps
80106f75:	e9 41 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $71
80106f7c:	6a 47                	push   $0x47
  jmp alltraps
80106f7e:	e9 38 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f83:	6a 00                	push   $0x0
  pushl $72
80106f85:	6a 48                	push   $0x48
  jmp alltraps
80106f87:	e9 2f f7 ff ff       	jmp    801066bb <alltraps>
...
80106f8c:	6a 00                	push   $0x0
  pushl $73
80106f8e:	6a 49                	push   $0x49
  jmp alltraps
80106f90:	e9 26 f7 ff ff       	jmp    801066bb <alltraps>
...
80106f95:	6a 00                	push   $0x0
  pushl $74
80106f97:	6a 4a                	push   $0x4a
  jmp alltraps
80106f99:	e9 1d f7 ff ff       	jmp    801066bb <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $75
80106fa0:	6a 4b                	push   $0x4b
  jmp alltraps
80106fa2:	e9 14 f7 ff ff       	jmp    801066bb <alltraps>
...
80106fa7:	6a 00                	push   $0x0
  pushl $76
80106fa9:	6a 4c                	push   $0x4c
  jmp alltraps
80106fab:	e9 0b f7 ff ff       	jmp    801066bb <alltraps>
...
80106fb0:	6a 00                	push   $0x0
  pushl $77
80106fb2:	6a 4d                	push   $0x4d
  jmp alltraps
80106fb4:	e9 02 f7 ff ff       	jmp    801066bb <alltraps>
...
80106fb9:	6a 00                	push   $0x0
  pushl $78
80106fbb:	6a 4e                	push   $0x4e
  jmp alltraps
80106fbd:	e9 f9 f6 ff ff       	jmp    801066bb <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $79
80106fc4:	6a 4f                	push   $0x4f
  jmp alltraps
80106fc6:	e9 f0 f6 ff ff       	jmp    801066bb <alltraps>
...
80106fcb:	6a 00                	push   $0x0
  pushl $80
80106fcd:	6a 50                	push   $0x50
  jmp alltraps
80106fcf:	e9 e7 f6 ff ff       	jmp    801066bb <alltraps>
...
80106fd4:	6a 00                	push   $0x0
  pushl $81
80106fd6:	6a 51                	push   $0x51
  jmp alltraps
80106fd8:	e9 de f6 ff ff       	jmp    801066bb <alltraps>
...
80106fdd:	6a 00                	push   $0x0
  pushl $82
80106fdf:	6a 52                	push   $0x52
  jmp alltraps
80106fe1:	e9 d5 f6 ff ff       	jmp    801066bb <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $83
80106fe8:	6a 53                	push   $0x53
  jmp alltraps
80106fea:	e9 cc f6 ff ff       	jmp    801066bb <alltraps>
...
80106fef:	6a 00                	push   $0x0
  pushl $84
80106ff1:	6a 54                	push   $0x54
  jmp alltraps
80106ff3:	e9 c3 f6 ff ff       	jmp    801066bb <alltraps>
...
80106ff8:	6a 00                	push   $0x0
  pushl $85
80106ffa:	6a 55                	push   $0x55
  jmp alltraps
80106ffc:	e9 ba f6 ff ff       	jmp    801066bb <alltraps>
...
80107001:	6a 00                	push   $0x0
  pushl $86
80107003:	6a 56                	push   $0x56
  jmp alltraps
80107005:	e9 b1 f6 ff ff       	jmp    801066bb <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $87
8010700c:	6a 57                	push   $0x57
  jmp alltraps
8010700e:	e9 a8 f6 ff ff       	jmp    801066bb <alltraps>
...
80107013:	6a 00                	push   $0x0
  pushl $88
80107015:	6a 58                	push   $0x58
  jmp alltraps
80107017:	e9 9f f6 ff ff       	jmp    801066bb <alltraps>
...
8010701c:	6a 00                	push   $0x0
  pushl $89
8010701e:	6a 59                	push   $0x59
  jmp alltraps
80107020:	e9 96 f6 ff ff       	jmp    801066bb <alltraps>
...
80107025:	6a 00                	push   $0x0
  pushl $90
80107027:	6a 5a                	push   $0x5a
  jmp alltraps
80107029:	e9 8d f6 ff ff       	jmp    801066bb <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $91
80107030:	6a 5b                	push   $0x5b
  jmp alltraps
80107032:	e9 84 f6 ff ff       	jmp    801066bb <alltraps>
...
80107037:	6a 00                	push   $0x0
  pushl $92
80107039:	6a 5c                	push   $0x5c
  jmp alltraps
8010703b:	e9 7b f6 ff ff       	jmp    801066bb <alltraps>
...
80107040:	6a 00                	push   $0x0
  pushl $93
80107042:	6a 5d                	push   $0x5d
  jmp alltraps
80107044:	e9 72 f6 ff ff       	jmp    801066bb <alltraps>
...
80107049:	6a 00                	push   $0x0
  pushl $94
8010704b:	6a 5e                	push   $0x5e
  jmp alltraps
8010704d:	e9 69 f6 ff ff       	jmp    801066bb <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $95
80107054:	6a 5f                	push   $0x5f
  jmp alltraps
80107056:	e9 60 f6 ff ff       	jmp    801066bb <alltraps>
...
8010705b:	6a 00                	push   $0x0
  pushl $96
8010705d:	6a 60                	push   $0x60
  jmp alltraps
8010705f:	e9 57 f6 ff ff       	jmp    801066bb <alltraps>
...
80107064:	6a 00                	push   $0x0
  pushl $97
80107066:	6a 61                	push   $0x61
  jmp alltraps
80107068:	e9 4e f6 ff ff       	jmp    801066bb <alltraps>
...
8010706d:	6a 00                	push   $0x0
  pushl $98
8010706f:	6a 62                	push   $0x62
  jmp alltraps
80107071:	e9 45 f6 ff ff       	jmp    801066bb <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $99
80107078:	6a 63                	push   $0x63
  jmp alltraps
8010707a:	e9 3c f6 ff ff       	jmp    801066bb <alltraps>
...
8010707f:	6a 00                	push   $0x0
  pushl $100
80107081:	6a 64                	push   $0x64
  jmp alltraps
80107083:	e9 33 f6 ff ff       	jmp    801066bb <alltraps>
...
80107088:	6a 00                	push   $0x0
  pushl $101
8010708a:	6a 65                	push   $0x65
  jmp alltraps
8010708c:	e9 2a f6 ff ff       	jmp    801066bb <alltraps>
...
80107091:	6a 00                	push   $0x0
  pushl $102
80107093:	6a 66                	push   $0x66
  jmp alltraps
80107095:	e9 21 f6 ff ff       	jmp    801066bb <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $103
8010709c:	6a 67                	push   $0x67
  jmp alltraps
8010709e:	e9 18 f6 ff ff       	jmp    801066bb <alltraps>
...
801070a3:	6a 00                	push   $0x0
  pushl $104
801070a5:	6a 68                	push   $0x68
  jmp alltraps
801070a7:	e9 0f f6 ff ff       	jmp    801066bb <alltraps>
...
801070ac:	6a 00                	push   $0x0
  pushl $105
801070ae:	6a 69                	push   $0x69
  jmp alltraps
801070b0:	e9 06 f6 ff ff       	jmp    801066bb <alltraps>
...
801070b5:	6a 00                	push   $0x0
  pushl $106
801070b7:	6a 6a                	push   $0x6a
  jmp alltraps
801070b9:	e9 fd f5 ff ff       	jmp    801066bb <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $107
801070c0:	6a 6b                	push   $0x6b
  jmp alltraps
801070c2:	e9 f4 f5 ff ff       	jmp    801066bb <alltraps>
...
801070c7:	6a 00                	push   $0x0
  pushl $108
801070c9:	6a 6c                	push   $0x6c
  jmp alltraps
801070cb:	e9 eb f5 ff ff       	jmp    801066bb <alltraps>
...
801070d0:	6a 00                	push   $0x0
  pushl $109
801070d2:	6a 6d                	push   $0x6d
  jmp alltraps
801070d4:	e9 e2 f5 ff ff       	jmp    801066bb <alltraps>
...
801070d9:	6a 00                	push   $0x0
  pushl $110
801070db:	6a 6e                	push   $0x6e
  jmp alltraps
801070dd:	e9 d9 f5 ff ff       	jmp    801066bb <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $111
801070e4:	6a 6f                	push   $0x6f
  jmp alltraps
801070e6:	e9 d0 f5 ff ff       	jmp    801066bb <alltraps>
...
801070eb:	6a 00                	push   $0x0
  pushl $112
801070ed:	6a 70                	push   $0x70
  jmp alltraps
801070ef:	e9 c7 f5 ff ff       	jmp    801066bb <alltraps>
...
801070f4:	6a 00                	push   $0x0
  pushl $113
801070f6:	6a 71                	push   $0x71
  jmp alltraps
801070f8:	e9 be f5 ff ff       	jmp    801066bb <alltraps>
...
801070fd:	6a 00                	push   $0x0
  pushl $114
801070ff:	6a 72                	push   $0x72
  jmp alltraps
80107101:	e9 b5 f5 ff ff       	jmp    801066bb <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $115
80107108:	6a 73                	push   $0x73
  jmp alltraps
8010710a:	e9 ac f5 ff ff       	jmp    801066bb <alltraps>
...
8010710f:	6a 00                	push   $0x0
  pushl $116
80107111:	6a 74                	push   $0x74
  jmp alltraps
80107113:	e9 a3 f5 ff ff       	jmp    801066bb <alltraps>
...
80107118:	6a 00                	push   $0x0
  pushl $117
8010711a:	6a 75                	push   $0x75
  jmp alltraps
8010711c:	e9 9a f5 ff ff       	jmp    801066bb <alltraps>
...
80107121:	6a 00                	push   $0x0
  pushl $118
80107123:	6a 76                	push   $0x76
  jmp alltraps
80107125:	e9 91 f5 ff ff       	jmp    801066bb <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $119
8010712c:	6a 77                	push   $0x77
  jmp alltraps
8010712e:	e9 88 f5 ff ff       	jmp    801066bb <alltraps>
...
80107133:	6a 00                	push   $0x0
  pushl $120
80107135:	6a 78                	push   $0x78
  jmp alltraps
80107137:	e9 7f f5 ff ff       	jmp    801066bb <alltraps>
...
8010713c:	6a 00                	push   $0x0
  pushl $121
8010713e:	6a 79                	push   $0x79
  jmp alltraps
80107140:	e9 76 f5 ff ff       	jmp    801066bb <alltraps>
...
80107145:	6a 00                	push   $0x0
  pushl $122
80107147:	6a 7a                	push   $0x7a
  jmp alltraps
80107149:	e9 6d f5 ff ff       	jmp    801066bb <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $123
80107150:	6a 7b                	push   $0x7b
  jmp alltraps
80107152:	e9 64 f5 ff ff       	jmp    801066bb <alltraps>
...
80107157:	6a 00                	push   $0x0
  pushl $124
80107159:	6a 7c                	push   $0x7c
  jmp alltraps
8010715b:	e9 5b f5 ff ff       	jmp    801066bb <alltraps>
...
80107160:	6a 00                	push   $0x0
  pushl $125
80107162:	6a 7d                	push   $0x7d
  jmp alltraps
80107164:	e9 52 f5 ff ff       	jmp    801066bb <alltraps>
...
80107169:	6a 00                	push   $0x0
  pushl $126
8010716b:	6a 7e                	push   $0x7e
  jmp alltraps
8010716d:	e9 49 f5 ff ff       	jmp    801066bb <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $127
80107174:	6a 7f                	push   $0x7f
  jmp alltraps
80107176:	e9 40 f5 ff ff       	jmp    801066bb <alltraps>
...
8010717b:	6a 00                	push   $0x0
  pushl $128
8010717d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107182:	e9 34 f5 ff ff       	jmp    801066bb <alltraps>
...
80107187:	6a 00                	push   $0x0
  pushl $129
80107189:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010718e:	e9 28 f5 ff ff       	jmp    801066bb <alltraps>
...
80107193:	6a 00                	push   $0x0
  pushl $130
80107195:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010719a:	e9 1c f5 ff ff       	jmp    801066bb <alltraps>
...
8010719f:	6a 00                	push   $0x0
  pushl $131
801071a1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801071a6:	e9 10 f5 ff ff       	jmp    801066bb <alltraps>
...
801071ab:	6a 00                	push   $0x0
  pushl $132
801071ad:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801071b2:	e9 04 f5 ff ff       	jmp    801066bb <alltraps>
...
801071b7:	6a 00                	push   $0x0
  pushl $133
801071b9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801071be:	e9 f8 f4 ff ff       	jmp    801066bb <alltraps>
...
801071c3:	6a 00                	push   $0x0
  pushl $134
801071c5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801071ca:	e9 ec f4 ff ff       	jmp    801066bb <alltraps>
...
801071cf:	6a 00                	push   $0x0
  pushl $135
801071d1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801071d6:	e9 e0 f4 ff ff       	jmp    801066bb <alltraps>
...
801071db:	6a 00                	push   $0x0
  pushl $136
801071dd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801071e2:	e9 d4 f4 ff ff       	jmp    801066bb <alltraps>
...
801071e7:	6a 00                	push   $0x0
  pushl $137
801071e9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801071ee:	e9 c8 f4 ff ff       	jmp    801066bb <alltraps>
...
801071f3:	6a 00                	push   $0x0
  pushl $138
801071f5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801071fa:	e9 bc f4 ff ff       	jmp    801066bb <alltraps>
...
801071ff:	6a 00                	push   $0x0
  pushl $139
80107201:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107206:	e9 b0 f4 ff ff       	jmp    801066bb <alltraps>
...
8010720b:	6a 00                	push   $0x0
  pushl $140
8010720d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107212:	e9 a4 f4 ff ff       	jmp    801066bb <alltraps>
...
80107217:	6a 00                	push   $0x0
  pushl $141
80107219:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010721e:	e9 98 f4 ff ff       	jmp    801066bb <alltraps>
...
80107223:	6a 00                	push   $0x0
  pushl $142
80107225:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010722a:	e9 8c f4 ff ff       	jmp    801066bb <alltraps>
...
8010722f:	6a 00                	push   $0x0
  pushl $143
80107231:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107236:	e9 80 f4 ff ff       	jmp    801066bb <alltraps>
...
8010723b:	6a 00                	push   $0x0
  pushl $144
8010723d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107242:	e9 74 f4 ff ff       	jmp    801066bb <alltraps>
...
80107247:	6a 00                	push   $0x0
  pushl $145
80107249:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010724e:	e9 68 f4 ff ff       	jmp    801066bb <alltraps>
...
80107253:	6a 00                	push   $0x0
  pushl $146
80107255:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010725a:	e9 5c f4 ff ff       	jmp    801066bb <alltraps>
...
8010725f:	6a 00                	push   $0x0
  pushl $147
80107261:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107266:	e9 50 f4 ff ff       	jmp    801066bb <alltraps>
...
8010726b:	6a 00                	push   $0x0
  pushl $148
8010726d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107272:	e9 44 f4 ff ff       	jmp    801066bb <alltraps>
...
80107277:	6a 00                	push   $0x0
  pushl $149
80107279:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010727e:	e9 38 f4 ff ff       	jmp    801066bb <alltraps>
...
80107283:	6a 00                	push   $0x0
  pushl $150
80107285:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010728a:	e9 2c f4 ff ff       	jmp    801066bb <alltraps>
...
8010728f:	6a 00                	push   $0x0
  pushl $151
80107291:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107296:	e9 20 f4 ff ff       	jmp    801066bb <alltraps>
...
8010729b:	6a 00                	push   $0x0
  pushl $152
8010729d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801072a2:	e9 14 f4 ff ff       	jmp    801066bb <alltraps>
...
801072a7:	6a 00                	push   $0x0
  pushl $153
801072a9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801072ae:	e9 08 f4 ff ff       	jmp    801066bb <alltraps>
...
801072b3:	6a 00                	push   $0x0
  pushl $154
801072b5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801072ba:	e9 fc f3 ff ff       	jmp    801066bb <alltraps>
...
801072bf:	6a 00                	push   $0x0
  pushl $155
801072c1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801072c6:	e9 f0 f3 ff ff       	jmp    801066bb <alltraps>
...
801072cb:	6a 00                	push   $0x0
  pushl $156
801072cd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801072d2:	e9 e4 f3 ff ff       	jmp    801066bb <alltraps>
...
801072d7:	6a 00                	push   $0x0
  pushl $157
801072d9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801072de:	e9 d8 f3 ff ff       	jmp    801066bb <alltraps>
...
801072e3:	6a 00                	push   $0x0
  pushl $158
801072e5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801072ea:	e9 cc f3 ff ff       	jmp    801066bb <alltraps>
...
801072ef:	6a 00                	push   $0x0
  pushl $159
801072f1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801072f6:	e9 c0 f3 ff ff       	jmp    801066bb <alltraps>
...
801072fb:	6a 00                	push   $0x0
  pushl $160
801072fd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107302:	e9 b4 f3 ff ff       	jmp    801066bb <alltraps>
...
80107307:	6a 00                	push   $0x0
  pushl $161
80107309:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010730e:	e9 a8 f3 ff ff       	jmp    801066bb <alltraps>
...
80107313:	6a 00                	push   $0x0
  pushl $162
80107315:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010731a:	e9 9c f3 ff ff       	jmp    801066bb <alltraps>
...
8010731f:	6a 00                	push   $0x0
  pushl $163
80107321:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107326:	e9 90 f3 ff ff       	jmp    801066bb <alltraps>
...
8010732b:	6a 00                	push   $0x0
  pushl $164
8010732d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107332:	e9 84 f3 ff ff       	jmp    801066bb <alltraps>
...
80107337:	6a 00                	push   $0x0
  pushl $165
80107339:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010733e:	e9 78 f3 ff ff       	jmp    801066bb <alltraps>
...
80107343:	6a 00                	push   $0x0
  pushl $166
80107345:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010734a:	e9 6c f3 ff ff       	jmp    801066bb <alltraps>
...
8010734f:	6a 00                	push   $0x0
  pushl $167
80107351:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107356:	e9 60 f3 ff ff       	jmp    801066bb <alltraps>
...
8010735b:	6a 00                	push   $0x0
  pushl $168
8010735d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107362:	e9 54 f3 ff ff       	jmp    801066bb <alltraps>
...
80107367:	6a 00                	push   $0x0
  pushl $169
80107369:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010736e:	e9 48 f3 ff ff       	jmp    801066bb <alltraps>
...
80107373:	6a 00                	push   $0x0
  pushl $170
80107375:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010737a:	e9 3c f3 ff ff       	jmp    801066bb <alltraps>
...
8010737f:	6a 00                	push   $0x0
  pushl $171
80107381:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107386:	e9 30 f3 ff ff       	jmp    801066bb <alltraps>
...
8010738b:	6a 00                	push   $0x0
  pushl $172
8010738d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107392:	e9 24 f3 ff ff       	jmp    801066bb <alltraps>
...
80107397:	6a 00                	push   $0x0
  pushl $173
80107399:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010739e:	e9 18 f3 ff ff       	jmp    801066bb <alltraps>
...
801073a3:	6a 00                	push   $0x0
  pushl $174
801073a5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801073aa:	e9 0c f3 ff ff       	jmp    801066bb <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $175
801073b1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801073b6:	e9 00 f3 ff ff       	jmp    801066bb <alltraps>
...
801073bb:	6a 00                	push   $0x0
  pushl $176
801073bd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801073c2:	e9 f4 f2 ff ff       	jmp    801066bb <alltraps>
...
801073c7:	6a 00                	push   $0x0
  pushl $177
801073c9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801073ce:	e9 e8 f2 ff ff       	jmp    801066bb <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $178
801073d5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801073da:	e9 dc f2 ff ff       	jmp    801066bb <alltraps>
...
801073df:	6a 00                	push   $0x0
  pushl $179
801073e1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801073e6:	e9 d0 f2 ff ff       	jmp    801066bb <alltraps>
...
801073eb:	6a 00                	push   $0x0
  pushl $180
801073ed:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801073f2:	e9 c4 f2 ff ff       	jmp    801066bb <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $181
801073f9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801073fe:	e9 b8 f2 ff ff       	jmp    801066bb <alltraps>
...
80107403:	6a 00                	push   $0x0
  pushl $182
80107405:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010740a:	e9 ac f2 ff ff       	jmp    801066bb <alltraps>
...
8010740f:	6a 00                	push   $0x0
  pushl $183
80107411:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107416:	e9 a0 f2 ff ff       	jmp    801066bb <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $184
8010741d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107422:	e9 94 f2 ff ff       	jmp    801066bb <alltraps>
...
80107427:	6a 00                	push   $0x0
  pushl $185
80107429:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010742e:	e9 88 f2 ff ff       	jmp    801066bb <alltraps>
...
80107433:	6a 00                	push   $0x0
  pushl $186
80107435:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010743a:	e9 7c f2 ff ff       	jmp    801066bb <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $187
80107441:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107446:	e9 70 f2 ff ff       	jmp    801066bb <alltraps>
...
8010744b:	6a 00                	push   $0x0
  pushl $188
8010744d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107452:	e9 64 f2 ff ff       	jmp    801066bb <alltraps>
...
80107457:	6a 00                	push   $0x0
  pushl $189
80107459:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010745e:	e9 58 f2 ff ff       	jmp    801066bb <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $190
80107465:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010746a:	e9 4c f2 ff ff       	jmp    801066bb <alltraps>
...
8010746f:	6a 00                	push   $0x0
  pushl $191
80107471:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107476:	e9 40 f2 ff ff       	jmp    801066bb <alltraps>
...
8010747b:	6a 00                	push   $0x0
  pushl $192
8010747d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107482:	e9 34 f2 ff ff       	jmp    801066bb <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $193
80107489:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010748e:	e9 28 f2 ff ff       	jmp    801066bb <alltraps>
...
80107493:	6a 00                	push   $0x0
  pushl $194
80107495:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010749a:	e9 1c f2 ff ff       	jmp    801066bb <alltraps>
...
8010749f:	6a 00                	push   $0x0
  pushl $195
801074a1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801074a6:	e9 10 f2 ff ff       	jmp    801066bb <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $196
801074ad:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801074b2:	e9 04 f2 ff ff       	jmp    801066bb <alltraps>
...
801074b7:	6a 00                	push   $0x0
  pushl $197
801074b9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801074be:	e9 f8 f1 ff ff       	jmp    801066bb <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $198
801074c5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801074ca:	e9 ec f1 ff ff       	jmp    801066bb <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $199
801074d1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801074d6:	e9 e0 f1 ff ff       	jmp    801066bb <alltraps>
...
801074db:	6a 00                	push   $0x0
  pushl $200
801074dd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801074e2:	e9 d4 f1 ff ff       	jmp    801066bb <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $201
801074e9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801074ee:	e9 c8 f1 ff ff       	jmp    801066bb <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $202
801074f5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801074fa:	e9 bc f1 ff ff       	jmp    801066bb <alltraps>
...
801074ff:	6a 00                	push   $0x0
  pushl $203
80107501:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107506:	e9 b0 f1 ff ff       	jmp    801066bb <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $204
8010750d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107512:	e9 a4 f1 ff ff       	jmp    801066bb <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $205
80107519:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010751e:	e9 98 f1 ff ff       	jmp    801066bb <alltraps>
...
80107523:	6a 00                	push   $0x0
  pushl $206
80107525:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010752a:	e9 8c f1 ff ff       	jmp    801066bb <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $207
80107531:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107536:	e9 80 f1 ff ff       	jmp    801066bb <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $208
8010753d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107542:	e9 74 f1 ff ff       	jmp    801066bb <alltraps>
...
80107547:	6a 00                	push   $0x0
  pushl $209
80107549:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010754e:	e9 68 f1 ff ff       	jmp    801066bb <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $210
80107555:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010755a:	e9 5c f1 ff ff       	jmp    801066bb <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $211
80107561:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107566:	e9 50 f1 ff ff       	jmp    801066bb <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $212
8010756d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107572:	e9 44 f1 ff ff       	jmp    801066bb <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $213
80107579:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010757e:	e9 38 f1 ff ff       	jmp    801066bb <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $214
80107585:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010758a:	e9 2c f1 ff ff       	jmp    801066bb <alltraps>
...
8010758f:	6a 00                	push   $0x0
  pushl $215
80107591:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107596:	e9 20 f1 ff ff       	jmp    801066bb <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $216
8010759d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801075a2:	e9 14 f1 ff ff       	jmp    801066bb <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $217
801075a9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801075ae:	e9 08 f1 ff ff       	jmp    801066bb <alltraps>
...
801075b3:	6a 00                	push   $0x0
  pushl $218
801075b5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801075ba:	e9 fc f0 ff ff       	jmp    801066bb <alltraps>
...
801075bf:	6a 00                	push   $0x0
  pushl $219
801075c1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801075c6:	e9 f0 f0 ff ff       	jmp    801066bb <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $220
801075cd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801075d2:	e9 e4 f0 ff ff       	jmp    801066bb <alltraps>
...
801075d7:	6a 00                	push   $0x0
  pushl $221
801075d9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801075de:	e9 d8 f0 ff ff       	jmp    801066bb <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $222
801075e5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801075ea:	e9 cc f0 ff ff       	jmp    801066bb <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $223
801075f1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801075f6:	e9 c0 f0 ff ff       	jmp    801066bb <alltraps>
...
801075fb:	6a 00                	push   $0x0
  pushl $224
801075fd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107602:	e9 b4 f0 ff ff       	jmp    801066bb <alltraps>
...
80107607:	6a 00                	push   $0x0
  pushl $225
80107609:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010760e:	e9 a8 f0 ff ff       	jmp    801066bb <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $226
80107615:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010761a:	e9 9c f0 ff ff       	jmp    801066bb <alltraps>
...
8010761f:	6a 00                	push   $0x0
  pushl $227
80107621:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107626:	e9 90 f0 ff ff       	jmp    801066bb <alltraps>
...
8010762b:	6a 00                	push   $0x0
  pushl $228
8010762d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107632:	e9 84 f0 ff ff       	jmp    801066bb <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $229
80107639:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010763e:	e9 78 f0 ff ff       	jmp    801066bb <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $230
80107645:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010764a:	e9 6c f0 ff ff       	jmp    801066bb <alltraps>
...
8010764f:	6a 00                	push   $0x0
  pushl $231
80107651:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107656:	e9 60 f0 ff ff       	jmp    801066bb <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $232
8010765d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107662:	e9 54 f0 ff ff       	jmp    801066bb <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $233
80107669:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010766e:	e9 48 f0 ff ff       	jmp    801066bb <alltraps>
...
80107673:	6a 00                	push   $0x0
  pushl $234
80107675:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010767a:	e9 3c f0 ff ff       	jmp    801066bb <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $235
80107681:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107686:	e9 30 f0 ff ff       	jmp    801066bb <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $236
8010768d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107692:	e9 24 f0 ff ff       	jmp    801066bb <alltraps>
...
80107697:	6a 00                	push   $0x0
  pushl $237
80107699:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010769e:	e9 18 f0 ff ff       	jmp    801066bb <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $238
801076a5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801076aa:	e9 0c f0 ff ff       	jmp    801066bb <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $239
801076b1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801076b6:	e9 00 f0 ff ff       	jmp    801066bb <alltraps>
...
801076bb:	6a 00                	push   $0x0
  pushl $240
801076bd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801076c2:	e9 f4 ef ff ff       	jmp    801066bb <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $241
801076c9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801076ce:	e9 e8 ef ff ff       	jmp    801066bb <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $242
801076d5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801076da:	e9 dc ef ff ff       	jmp    801066bb <alltraps>
...
801076df:	6a 00                	push   $0x0
  pushl $243
801076e1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801076e6:	e9 d0 ef ff ff       	jmp    801066bb <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $244
801076ed:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801076f2:	e9 c4 ef ff ff       	jmp    801066bb <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $245
801076f9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801076fe:	e9 b8 ef ff ff       	jmp    801066bb <alltraps>
...
80107703:	6a 00                	push   $0x0
  pushl $246
80107705:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010770a:	e9 ac ef ff ff       	jmp    801066bb <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $247
80107711:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107716:	e9 a0 ef ff ff       	jmp    801066bb <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $248
8010771d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107722:	e9 94 ef ff ff       	jmp    801066bb <alltraps>
...
80107727:	6a 00                	push   $0x0
  pushl $249
80107729:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010772e:	e9 88 ef ff ff       	jmp    801066bb <alltraps>
...
80107733:	6a 00                	push   $0x0
  pushl $250
80107735:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010773a:	e9 7c ef ff ff       	jmp    801066bb <alltraps>
...
8010773f:	6a 00                	push   $0x0
  pushl $251
80107741:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107746:	e9 70 ef ff ff       	jmp    801066bb <alltraps>
...
8010774b:	6a 00                	push   $0x0
  pushl $252
8010774d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107752:	e9 64 ef ff ff       	jmp    801066bb <alltraps>
...
80107757:	6a 00                	push   $0x0
  pushl $253
80107759:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010775e:	e9 58 ef ff ff       	jmp    801066bb <alltraps>
...
80107763:	6a 00                	push   $0x0
  pushl $254
80107765:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010776a:	e9 4c ef ff ff       	jmp    801066bb <alltraps>
...
8010776f:	6a 00                	push   $0x0
  pushl $255
80107771:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107776:	e9 40 ef ff ff       	jmp    801066bb <alltraps>

8010777b <lgdt>:
{
8010777b:	55                   	push   %ebp
8010777c:	89 e5                	mov    %esp,%ebp
8010777e:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80107781:	8b 45 0c             	mov    0xc(%ebp),%eax
80107784:	83 e8 01             	sub    $0x1,%eax
80107787:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010778b:	8b 45 08             	mov    0x8(%ebp),%eax
8010778e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107792:	8b 45 08             	mov    0x8(%ebp),%eax
80107795:	c1 e8 10             	shr    $0x10,%eax
80107798:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010779c:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010779f:	0f 01 10             	lgdtl  (%eax)
}
801077a2:	c9                   	leave  
801077a3:	c3                   	ret    
...
801077ad:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801077b1:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801077b5:	0f 00 d8             	ltr    %ax
}
801077b8:	c9                   	leave  
801077b9:	c3                   	ret    
...
801077c8:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801077cb:	e8 fa c8 ff ff       	call   801040ca <cpuid>
801077d0:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801077d6:	05 20 38 11 80       	add    $0x80113820,%eax
801077db:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801077de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e1:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801077e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ea:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801077f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f3:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801077f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077fa:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077fe:	83 e2 f0             	and    $0xfffffff0,%edx
80107801:	83 ca 0a             	or     $0xa,%edx
80107804:	88 50 7d             	mov    %dl,0x7d(%eax)
80107807:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010780a:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
80107831:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
...
80107872:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107876:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107879:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107880:	ff ff 
80107882:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107885:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
8010788c:	00 00 
8010788e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107891:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107898:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789b:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078a2:	83 e2 f0             	and    $0xfffffff0,%edx
801078a5:	83 ca 02             	or     $0x2,%edx
801078a8:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801078ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b1:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078b8:	83 ca 10             	or     $0x10,%edx
801078bb:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801078c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c4:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078cb:	83 e2 9f             	and    $0xffffff9f,%edx
801078ce:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80107910:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107917:	83 e2 df             	and    $0xffffffdf,%edx
8010791a:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
...
80107949:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107950:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107953:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
8010795a:	ff ff 
8010795c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795f:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80107966:	00 00 
80107968:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796b:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
80107972:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107975:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
8010797c:	83 e2 f0             	and    $0xfffffff0,%edx
8010797f:	83 ca 0a             	or     $0xa,%edx
...
801079de:	83 e2 ef             	and    $0xffffffef,%edx
...
801079f1:	83 e2 df             	and    $0xffffffdf,%edx
801079f4:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
801079fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fd:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a04:	83 ca 40             	or     $0x40,%edx
80107a07:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a10:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a17:	83 ca 80             	or     $0xffffff80,%edx
80107a1a:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a23:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a2d:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107a34:	ff ff 
80107a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a39:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107a40:	00 00 
80107a42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a45:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107a4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4f:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107a56:	83 e2 f0             	and    $0xfffffff0,%edx
80107a59:	83 ca 02             	or     $0x2,%edx
80107a5c:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107a62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a65:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107a6c:	83 ca 10             	or     $0x10,%edx
80107a6f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107a75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a78:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107a7f:	83 ca 60             	or     $0x60,%edx
80107a82:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107a88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a8b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107a92:	83 ca 80             	or     $0xffffff80,%edx
80107a95:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107a9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a9e:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107aa5:	83 ca 0f             	or     $0xf,%edx
80107aa8:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107aae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab1:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107ab8:	83 e2 ef             	and    $0xffffffef,%edx
80107abb:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac4:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107acb:	83 e2 df             	and    $0xffffffdf,%edx
80107ace:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107ad4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ad7:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107ade:	83 ca 40             	or     $0x40,%edx
80107ae1:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107ae7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aea:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107af1:	83 ca 80             	or     $0xffffff80,%edx
80107af4:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107afa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107afd:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107b04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b07:	83 c0 70             	add    $0x70,%eax
80107b0a:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107b11:	00 
80107b12:	89 04 24             	mov    %eax,(%esp)
80107b15:	e8 61 fc ff ff       	call   8010777b <lgdt>
}
80107b1a:	c9                   	leave  
80107b1b:	c3                   	ret    
...
80107b1f:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;
...
80107b55:	eb 48                	jmp    80107b9f <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107b57:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107b5b:	74 0e                	je     80107b6b <walkpgdir+0x4f>
80107b5d:	e8 47 b0 ff ff       	call   80102ba9 <kalloc>
...
80107b70:	eb 44                	jmp    80107bb6 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107b72:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107b79:	00 
80107b7a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b81:	00 
80107b82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b85:	89 04 24             	mov    %eax,(%esp)
80107b88:	e8 31 d7 ff ff       	call   801052be <memset>
...
80107b95:	83 c8 07             	or     $0x7,%eax
80107b98:	89 c2                	mov    %eax,%edx
80107b9a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b9d:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107b9f:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ba2:	c1 e8 0c             	shr    $0xc,%eax
80107ba5:	25 ff 03 00 00       	and    $0x3ff,%eax
...
80107bbb:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80107bbe:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bc1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bc6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107bc9:	8b 55 0c             	mov    0xc(%ebp),%edx
80107bcc:	8b 45 10             	mov    0x10(%ebp),%eax
80107bcf:	01 d0                	add    %edx,%eax
80107bd1:	83 e8 01             	sub    $0x1,%eax
80107bd4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bd9:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107bdc:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107be3:	00 
80107be4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107be7:	89 44 24 04          	mov    %eax,0x4(%esp)
80107beb:	8b 45 08             	mov    0x8(%ebp),%eax
80107bee:	89 04 24             	mov    %eax,(%esp)
80107bf1:	e8 26 ff ff ff       	call   80107b1c <walkpgdir>
80107bf6:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107bf9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107bfd:	75 07                	jne    80107c06 <mappages+0x4e>
      return -1;
80107bff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107c04:	eb 48                	jmp    80107c4e <mappages+0x96>
    if(*pte & PTE_P)
80107c06:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c09:	8b 00                	mov    (%eax),%eax
80107c0b:	83 e0 01             	and    $0x1,%eax
80107c0e:	85 c0                	test   %eax,%eax
80107c10:	74 0c                	je     80107c1e <mappages+0x66>
      panic("remap");
80107c12:	c7 04 24 30 8b 10 80 	movl   $0x80108b30,(%esp)
80107c19:	e8 44 89 ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
80107c1e:	8b 45 18             	mov    0x18(%ebp),%eax
80107c21:	0b 45 14             	or     0x14(%ebp),%eax
80107c24:	83 c8 01             	or     $0x1,%eax
80107c27:	89 c2                	mov    %eax,%edx
80107c29:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c2c:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107c2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c31:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107c34:	75 08                	jne    80107c3e <mappages+0x86>
      break;
80107c36:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107c3c:	eb 10                	jmp    80107c4e <mappages+0x96>
    a += PGSIZE;
80107c3e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107c45:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107c4c:	eb 8e                	jmp    80107bdc <mappages+0x24>
}
80107c4e:	c9                   	leave  
80107c4f:	c3                   	ret    
...
80107c54:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107c57:	e8 4d af ff ff       	call   80102ba9 <kalloc>
80107c5c:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107c5f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107c63:	75 0a                	jne    80107c6f <setupkvm+0x1f>
    return 0;
80107c65:	b8 00 00 00 00       	mov    $0x0,%eax
80107c6a:	e9 84 00 00 00       	jmp    80107cf3 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
80107c6f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c76:	00 
80107c77:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c7e:	00 
80107c7f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c82:	89 04 24             	mov    %eax,(%esp)
80107c85:	e8 34 d6 ff ff       	call   801052be <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c8a:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107c91:	eb 54                	jmp    80107ce7 <setupkvm+0x97>
...
80107cc8:	e8 eb fe ff ff       	call   80107bb8 <mappages>
80107ccd:	85 c0                	test   %eax,%eax
80107ccf:	79 12                	jns    80107ce3 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107cd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cd4:	89 04 24             	mov    %eax,(%esp)
80107cd7:	e8 26 05 00 00       	call   80108202 <freevm>
      return 0;
80107cdc:	b8 00 00 00 00       	mov    $0x0,%eax
80107ce1:	eb 10                	jmp    80107cf3 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107ce3:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107ce7:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107cee:	72 a3                	jb     80107c93 <setupkvm+0x43>
    }
  return pgdir;
80107cf0:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107cf3:	83 c4 34             	add    $0x34,%esp
80107cf6:	5b                   	pop    %ebx
80107cf7:	5d                   	pop    %ebp
80107cf8:	c3                   	ret    
...
80107cfc:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107cff:	e8 4c ff ff ff       	call   80107c50 <setupkvm>
80107d04:	a3 44 67 11 80       	mov    %eax,0x80116744
  switchkvm();
80107d09:	e8 02 00 00 00       	call   80107d10 <switchkvm>
}
80107d0e:	c9                   	leave  
80107d0f:	c3                   	ret    
...
80107d16:	a1 44 67 11 80       	mov    0x80116744,%eax
80107d1b:	05 00 00 00 80       	add    $0x80000000,%eax
80107d20:	89 04 24             	mov    %eax,(%esp)
80107d23:	e8 92 fa ff ff       	call   801077ba <lcr3>
}
80107d28:	c9                   	leave  
80107d29:	c3                   	ret    
...
80107d2d:	57                   	push   %edi
80107d2e:	56                   	push   %esi
80107d2f:	53                   	push   %ebx
80107d30:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107d33:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107d37:	75 0c                	jne    80107d45 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107d39:	c7 04 24 36 8b 10 80 	movl   $0x80108b36,(%esp)
80107d40:	e8 1d 88 ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107d45:	8b 45 08             	mov    0x8(%ebp),%eax
80107d48:	8b 40 08             	mov    0x8(%eax),%eax
80107d4b:	85 c0                	test   %eax,%eax
80107d4d:	75 0c                	jne    80107d5b <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107d4f:	c7 04 24 4c 8b 10 80 	movl   $0x80108b4c,(%esp)
80107d56:	e8 07 88 ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107d5b:	8b 45 08             	mov    0x8(%ebp),%eax
80107d5e:	8b 40 04             	mov    0x4(%eax),%eax
80107d61:	85 c0                	test   %eax,%eax
80107d63:	75 0c                	jne    80107d71 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107d65:	c7 04 24 61 8b 10 80 	movl   $0x80108b61,(%esp)
80107d6c:	e8 f1 87 ff ff       	call   80100562 <panic>

  pushcli();
80107d71:	e8 43 d4 ff ff       	call   801051b9 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107d76:	e8 70 c3 ff ff       	call   801040eb <mycpu>
80107d7b:	89 c3                	mov    %eax,%ebx
80107d7d:	e8 69 c3 ff ff       	call   801040eb <mycpu>
80107d82:	83 c0 08             	add    $0x8,%eax
80107d85:	89 c7                	mov    %eax,%edi
80107d87:	e8 5f c3 ff ff       	call   801040eb <mycpu>
80107d8c:	83 c0 08             	add    $0x8,%eax
80107d8f:	c1 e8 10             	shr    $0x10,%eax
80107d92:	89 c6                	mov    %eax,%esi
80107d94:	e8 52 c3 ff ff       	call   801040eb <mycpu>
80107d99:	83 c0 08             	add    $0x8,%eax
80107d9c:	c1 e8 18             	shr    $0x18,%eax
80107d9f:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107da6:	67 00 
80107da8:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107daf:	89 f1                	mov    %esi,%ecx
80107db1:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107db7:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107dbe:	83 e2 f0             	and    $0xfffffff0,%edx
80107dc1:	83 ca 09             	or     $0x9,%edx
80107dc4:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107dca:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107dd1:	83 ca 10             	or     $0x10,%edx
80107dd4:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107dda:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107de1:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107dfa:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e01:	83 e2 f0             	and    $0xfffffff0,%edx
80107e04:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e0a:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e11:	83 e2 ef             	and    $0xffffffef,%edx
80107e14:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e1a:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e21:	83 e2 df             	and    $0xffffffdf,%edx
...
80107e41:	83 e2 7f             	and    $0x7f,%edx
80107e44:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e4a:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107e50:	e8 96 c2 ff ff       	call   801040eb <mycpu>
80107e55:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107e5c:	83 e2 ef             	and    $0xffffffef,%edx
80107e5f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107e65:	e8 81 c2 ff ff       	call   801040eb <mycpu>
80107e6a:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107e70:	e8 76 c2 ff ff       	call   801040eb <mycpu>
80107e75:	8b 55 08             	mov    0x8(%ebp),%edx
80107e78:	8b 52 08             	mov    0x8(%edx),%edx
80107e7b:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107e81:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107e84:	e8 62 c2 ff ff       	call   801040eb <mycpu>
80107e89:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107e8f:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107e96:	e8 09 f9 ff ff       	call   801077a4 <ltr>
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107e9b:	8b 45 08             	mov    0x8(%ebp),%eax
80107e9e:	8b 40 04             	mov    0x4(%eax),%eax
80107ea1:	05 00 00 00 80       	add    $0x80000000,%eax
80107ea6:	89 04 24             	mov    %eax,(%esp)
80107ea9:	e8 0c f9 ff ff       	call   801077ba <lcr3>
  popcli();
80107eae:	e8 52 d3 ff ff       	call   80105205 <popcli>
}
80107eb3:	83 c4 1c             	add    $0x1c,%esp
80107eb6:	5b                   	pop    %ebx
80107eb7:	5e                   	pop    %esi
80107eb8:	5f                   	pop    %edi
80107eb9:	5d                   	pop    %ebp
...
80107ebe:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107ec1:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107ec8:	76 0c                	jbe    80107ed6 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107eca:	c7 04 24 75 8b 10 80 	movl   $0x80108b75,(%esp)
80107ed1:	e8 8c 86 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107ed6:	e8 ce ac ff ff       	call   80102ba9 <kalloc>
...
80107ef4:	e8 c5 d3 ff ff       	call   801052be <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107ef9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107efc:	05 00 00 00 80       	add    $0x80000000,%eax
80107f01:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f08:	00 
80107f09:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80107f23:	e8 90 fc ff ff       	call   80107bb8 <mappages>
  memmove(mem, init, sz);
80107f28:	8b 45 10             	mov    0x10(%ebp),%eax
80107f2b:	89 44 24 08          	mov    %eax,0x8(%esp)
80107f2f:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f32:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f39:	89 04 24             	mov    %eax,(%esp)
80107f3c:	e8 4c d4 ff ff       	call   8010538d <memmove>
}
80107f41:	c9                   	leave  
80107f42:	c3                   	ret    
...
80107f53:	74 0c                	je     80107f61 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107f55:	c7 04 24 90 8b 10 80 	movl   $0x80108b90,(%esp)
80107f5c:	e8 01 86 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107f61:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f68:	e9 a6 00 00 00       	jmp    80108013 <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107f6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f70:	8b 55 0c             	mov    0xc(%ebp),%edx
80107f73:	01 d0                	add    %edx,%eax
80107f75:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f7c:	00 
80107f7d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f81:	8b 45 08             	mov    0x8(%ebp),%eax
80107f84:	89 04 24             	mov    %eax,(%esp)
80107f87:	e8 90 fb ff ff       	call   80107b1c <walkpgdir>
80107f8c:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f8f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f93:	75 0c                	jne    80107fa1 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107f95:	c7 04 24 b3 8b 10 80 	movl   $0x80108bb3,(%esp)
80107f9c:	e8 c1 85 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107fa1:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107fa4:	8b 00                	mov    (%eax),%eax
80107fa6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fab:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107fae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb1:	8b 55 18             	mov    0x18(%ebp),%edx
80107fb4:	29 c2                	sub    %eax,%edx
80107fb6:	89 d0                	mov    %edx,%eax
80107fb8:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107fbd:	77 0f                	ja     80107fce <loaduvm+0x8b>
      n = sz - i;
80107fbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc2:	8b 55 18             	mov    0x18(%ebp),%edx
80107fc5:	29 c2                	sub    %eax,%edx
80107fc7:	89 d0                	mov    %edx,%eax
80107fc9:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107fcc:	eb 07                	jmp    80107fd5 <loaduvm+0x92>
    else
      n = PGSIZE;
80107fce:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107fd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd8:	8b 55 14             	mov    0x14(%ebp),%edx
80107fdb:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107fde:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107fe1:	05 00 00 00 80       	add    $0x80000000,%eax
80107fe6:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107fe9:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fed:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107ff1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ff5:	8b 45 10             	mov    0x10(%ebp),%eax
80107ff8:	89 04 24             	mov    %eax,(%esp)
80107ffb:	e8 fa 9d ff ff       	call   80101dfa <readi>
80108000:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108003:	74 07                	je     8010800c <loaduvm+0xc9>
      return -1;
80108005:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010800a:	eb 18                	jmp    80108024 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
8010800c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108013:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108016:	3b 45 18             	cmp    0x18(%ebp),%eax
80108019:	0f 82 4e ff ff ff    	jb     80107f6d <loaduvm+0x2a>
  }
  return 0;
...
80108029:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108031:	79 0a                	jns    8010803d <allocuvm+0x17>
    return 0;
80108033:	b8 00 00 00 00       	mov    $0x0,%eax
80108038:	e9 fd 00 00 00       	jmp    8010813a <allocuvm+0x114>
  if(newsz < oldsz)
8010803d:	8b 45 10             	mov    0x10(%ebp),%eax
80108040:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108043:	73 08                	jae    8010804d <allocuvm+0x27>
    return oldsz;
80108045:	8b 45 0c             	mov    0xc(%ebp),%eax
80108048:	e9 ed 00 00 00       	jmp    8010813a <allocuvm+0x114>
...
8010805d:	e9 c9 00 00 00       	jmp    8010812b <allocuvm+0x105>
    mem = kalloc();
80108062:	e8 42 ab ff ff       	call   80102ba9 <kalloc>
80108067:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
8010806a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010806e:	75 2f                	jne    8010809f <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80108070:	c7 04 24 d1 8b 10 80 	movl   $0x80108bd1,(%esp)
80108077:	e8 4c 83 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010807c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010807f:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108090:	e8 a7 00 00 00       	call   8010813c <deallocuvm>
      return 0;
80108095:	b8 00 00 00 00       	mov    $0x0,%eax
8010809a:	e9 9b 00 00 00       	jmp    8010813a <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
8010809f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080a6:	00 
801080a7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801080ae:	00 
801080af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080b2:	89 04 24             	mov    %eax,(%esp)
801080b5:	e8 04 d2 ff ff       	call   801052be <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801080ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080bd:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
801080c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801080cd:	00 
801080ce:	89 54 24 0c          	mov    %edx,0xc(%esp)
801080d2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080d9:	00 
801080da:	89 44 24 04          	mov    %eax,0x4(%esp)
801080de:	8b 45 08             	mov    0x8(%ebp),%eax
801080e1:	89 04 24             	mov    %eax,(%esp)
801080e4:	e8 cf fa ff ff       	call   80107bb8 <mappages>
801080e9:	85 c0                	test   %eax,%eax
801080eb:	79 37                	jns    80108124 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
801080ed:	c7 04 24 e9 8b 10 80 	movl   $0x80108be9,(%esp)
801080f4:	e8 cf 82 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801080f9:	8b 45 0c             	mov    0xc(%ebp),%eax
801080fc:	89 44 24 08          	mov    %eax,0x8(%esp)
80108100:	8b 45 10             	mov    0x10(%ebp),%eax
80108103:	89 44 24 04          	mov    %eax,0x4(%esp)
80108107:	8b 45 08             	mov    0x8(%ebp),%eax
8010810a:	89 04 24             	mov    %eax,(%esp)
8010810d:	e8 2a 00 00 00       	call   8010813c <deallocuvm>
      kfree(mem);
80108112:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108115:	89 04 24             	mov    %eax,(%esp)
80108118:	e8 f6 a9 ff ff       	call   80102b13 <kfree>
      return 0;
8010811d:	b8 00 00 00 00       	mov    $0x0,%eax
80108122:	eb 16                	jmp    8010813a <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80108124:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010812b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010812e:	3b 45 10             	cmp    0x10(%ebp),%eax
80108131:	0f 82 2b ff ff ff    	jb     80108062 <allocuvm+0x3c>
    }
  }
  return newsz;
80108137:	8b 45 10             	mov    0x10(%ebp),%eax
}
8010813a:	c9                   	leave  
8010813b:	c3                   	ret    
...
{
8010813c:	55                   	push   %ebp
8010813d:	89 e5                	mov    %esp,%ebp
8010813f:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80108148:	72 08                	jb     80108152 <deallocuvm+0x16>
    return oldsz;
8010814a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010814d:	e9 ae 00 00 00       	jmp    80108200 <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
80108152:	8b 45 10             	mov    0x10(%ebp),%eax
80108155:	05 ff 0f 00 00       	add    $0xfff,%eax
8010815a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010815f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108162:	e9 8a 00 00 00       	jmp    801081f1 <deallocuvm+0xb5>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108167:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108171:	00 
80108172:	89 44 24 04          	mov    %eax,0x4(%esp)
80108176:	8b 45 08             	mov    0x8(%ebp),%eax
80108179:	89 04 24             	mov    %eax,(%esp)
8010817c:	e8 9b f9 ff ff       	call   80107b1c <walkpgdir>
80108181:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108184:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108188:	75 16                	jne    801081a0 <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010818a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818d:	c1 e8 16             	shr    $0x16,%eax
80108190:	83 c0 01             	add    $0x1,%eax
80108193:	c1 e0 16             	shl    $0x16,%eax
80108196:	2d 00 10 00 00       	sub    $0x1000,%eax
8010819b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010819e:	eb 4a                	jmp    801081ea <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
801081a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081a3:	8b 00                	mov    (%eax),%eax
801081a5:	83 e0 01             	and    $0x1,%eax
801081a8:	85 c0                	test   %eax,%eax
801081aa:	74 3e                	je     801081ea <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
...
801081bd:	75 0c                	jne    801081cb <deallocuvm+0x8f>
        panic("kfree");
801081bf:	c7 04 24 05 8c 10 80 	movl   $0x80108c05,(%esp)
801081c6:	e8 97 83 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
...
80108205:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108208:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010820c:	75 0c                	jne    8010821a <freevm+0x18>
    panic("freevm: no pgdir");
8010820e:	c7 04 24 0b 8c 10 80 	movl   $0x80108c0b,(%esp)
80108215:	e8 48 83 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010821a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108221:	00 
80108222:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108229:	80 
8010822a:	8b 45 08             	mov    0x8(%ebp),%eax
8010822d:	89 04 24             	mov    %eax,(%esp)
80108230:	e8 07 ff ff ff       	call   8010813c <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108235:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010823c:	eb 45                	jmp    80108283 <freevm+0x81>
    if(pgdir[i] & PTE_P){
8010823e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108241:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108254:	74 29                	je     8010827f <freevm+0x7d>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80108256:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108259:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108260:	8b 45 08             	mov    0x8(%ebp),%eax
80108263:	01 d0                	add    %edx,%eax
...
8010827a:	e8 94 a8 ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
8010827f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108283:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
8010828a:	76 b2                	jbe    8010823e <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
8010828c:	8b 45 08             	mov    0x8(%ebp),%eax
8010828f:	89 04 24             	mov    %eax,(%esp)
80108292:	e8 7c a8 ff ff       	call   80102b13 <kfree>
}
80108297:	c9                   	leave  
80108298:	c3                   	ret    
...
801082a6:	00 
801082a7:	8b 45 0c             	mov    0xc(%ebp),%eax
801082aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801082ae:	8b 45 08             	mov    0x8(%ebp),%eax
801082b1:	89 04 24             	mov    %eax,(%esp)
801082b4:	e8 63 f8 ff ff       	call   80107b1c <walkpgdir>
801082b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801082bc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801082c0:	75 0c                	jne    801082ce <clearpteu+0x35>
    panic("clearpteu");
801082c2:	c7 04 24 1c 8c 10 80 	movl   $0x80108c1c,(%esp)
801082c9:	e8 94 82 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
801082ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d1:	8b 00                	mov    (%eax),%eax
801082d3:	83 e0 fb             	and    $0xfffffffb,%eax
801082d6:	89 c2                	mov    %eax,%edx
801082d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082db:	89 10                	mov    %edx,(%eax)
}
801082dd:	c9                   	leave  
801082de:	c3                   	ret    
...
801082e2:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801082e5:	e8 66 f9 ff ff       	call   80107c50 <setupkvm>
801082ea:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082ed:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801082f1:	75 0a                	jne    801082fd <copyuvm+0x1e>
    return 0;
801082f3:	b8 00 00 00 00       	mov    $0x0,%eax
801082f8:	e9 03 01 00 00       	jmp    80108400 <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
801082fd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108304:	e9 d6 00 00 00       	jmp    801083df <copyuvm+0x100>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108309:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010830c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108313:	00 
80108314:	89 44 24 04          	mov    %eax,0x4(%esp)
80108318:	8b 45 08             	mov    0x8(%ebp),%eax
8010831b:	89 04 24             	mov    %eax,(%esp)
8010831e:	e8 f9 f7 ff ff       	call   80107b1c <walkpgdir>
80108323:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108326:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010832a:	75 0c                	jne    80108338 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010832c:	c7 04 24 26 8c 10 80 	movl   $0x80108c26,(%esp)
80108333:	e8 2a 82 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
80108338:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010833b:	8b 00                	mov    (%eax),%eax
8010833d:	83 e0 01             	and    $0x1,%eax
80108340:	85 c0                	test   %eax,%eax
80108342:	75 0c                	jne    80108350 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108344:	c7 04 24 40 8c 10 80 	movl   $0x80108c40,(%esp)
8010834b:	e8 12 82 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
...
80108367:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010836a:	e8 3a a8 ff ff       	call   80102ba9 <kalloc>
8010836f:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108372:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108376:	75 02                	jne    8010837a <copyuvm+0x9b>
      goto bad;
80108378:	eb 76                	jmp    801083f0 <copyuvm+0x111>
...
8010838e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108391:	89 04 24             	mov    %eax,(%esp)
80108394:	e8 f4 cf ff ff       	call   8010538d <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80108399:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010839c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010839f:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801083a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083a8:	89 54 24 10          	mov    %edx,0x10(%esp)
801083ac:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
...
801083c2:	e8 f1 f7 ff ff       	call   80107bb8 <mappages>
801083c7:	85 c0                	test   %eax,%eax
801083c9:	79 0d                	jns    801083d8 <copyuvm+0xf9>
      kfree(mem);
801083cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083ce:	89 04 24             	mov    %eax,(%esp)
801083d1:	e8 3d a7 ff ff       	call   80102b13 <kfree>
      goto bad;
801083d6:	eb 18                	jmp    801083f0 <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
801083d8:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801083df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083e2:	3b 45 0c             	cmp    0xc(%ebp),%eax
801083e5:	0f 82 1e ff ff ff    	jb     80108309 <copyuvm+0x2a>
    }
  }
  return d;
801083eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083ee:	eb 10                	jmp    80108400 <copyuvm+0x121>

bad:
  freevm(d);
801083f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083f3:	89 04 24             	mov    %eax,(%esp)
801083f6:	e8 07 fe ff ff       	call   80108202 <freevm>
  return 0;
...
8010841d:	e8 fa f6 ff ff       	call   80107b1c <walkpgdir>
...
80108465:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108468:	e9 87 00 00 00       	jmp    801084f4 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
8010846d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108470:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108475:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108478:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010847b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010847f:	8b 45 08             	mov    0x8(%ebp),%eax
80108482:	89 04 24             	mov    %eax,(%esp)
80108485:	e8 78 ff ff ff       	call   80108402 <uva2ka>
8010848a:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
8010848d:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108491:	75 07                	jne    8010849a <copyout+0x3e>
      return -1;
80108493:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108498:	eb 69                	jmp    80108503 <copyout+0xa7>
    n = PGSIZE - (va - va0);
8010849a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010849d:	8b 55 ec             	mov    -0x14(%ebp),%edx
801084a0:	29 c2                	sub    %eax,%edx
...
801084af:	3b 45 14             	cmp    0x14(%ebp),%eax
801084b2:	76 06                	jbe    801084ba <copyout+0x5e>
      n = len;
...
801084c5:	01 c2                	add    %eax,%edx
801084c7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084ca:	89 44 24 08          	mov    %eax,0x8(%esp)
801084ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801084d5:	89 14 24             	mov    %edx,(%esp)
801084d8:	e8 b0 ce ff ff       	call   8010538d <memmove>
    len -= n;
801084dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084e0:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
801084e3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084e6:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801084e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084ec:	05 00 10 00 00       	add    $0x1000,%eax
801084f1:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
801084f4:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801084f8:	0f 85 6f ff ff ff    	jne    8010846d <copyout+0x11>
  }
  return 0;
