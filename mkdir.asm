...
main(int argc, char *argv[])
{
  ...
  47:	e8 37 04 00 00       	call   483 <mkdir>
  ...
  66:	c7 44 24 04 8e 09 00 	movl   $0x98e,0x4(%esp)
  6d:	00 
...
void ps(void) {
 ...
 309:	c7 44 24 04 aa 09 00 	movl   $0x9aa,0x4(%esp)
 310:	00 
 ...
 3e6:	c7 44 24 04 c3 09 00 	movl   $0x9c3,0x4(%esp)
 3ed:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 544:	0f b6 80 50 0c 00 00 	movzbl 0xc50(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a1:	75 09                	jne    6ac <printf+0x101>
          s = "(null)";
 6a3:	c7 45 f4 d3 09 00 00 	movl   $0x9d3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 76d:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 ...
 838:	a3 6c 0c 00 00       	mov    %eax,0xc6c
}
 83d:	c9                   	leave  
 83e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 88b:	e8 ce fe ff ff       	call   75e <free>
  return freep;
 890:	a1 6c 0c 00 00       	mov    0xc6c,%eax
}
 895:	c9                   	leave  
 896:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8a9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8ac:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 8b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8b4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8b8:	75 23                	jne    8dd <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ba:	c7 45 f0 64 0c 00 00 	movl   $0xc64,-0x10(%ebp)
 8c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8c4:	a3 6c 0c 00 00       	mov    %eax,0xc6c
 8c9:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 8ce:	a3 64 0c 00 00       	mov    %eax,0xc64
    base.s.size = 0;
 8d3:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 8da:	00 00 00 
  }
 ...
 930:	a3 6c 0c 00 00       	mov    %eax,0xc6c
      return (void*)(p + 1);
 ...
 93b:	eb 38                	jmp    975 <malloc+0xde>
    ...
    if(p == freep)
 93d:	a1 6c 0c 00 00       	mov    0xc6c,%eax
