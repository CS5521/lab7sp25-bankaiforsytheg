...
wc(int fd, char *name)
{
  ...
  54:	c7 04 24 b9 0a 00 00 	movl   $0xab9,(%esp)
  ...
  b8:	c7 44 24 04 bf 0a 00 	movl   $0xabf,0x4(%esp)
  bf:	00 
  ...
  ed:	c7 44 24 04 cf 0a 00 	movl   $0xacf,0x4(%esp)
  f4:	00 
  f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fc:	e8 ec 05 00 00       	call   6ed <printf>
}
 101:	c9                   	leave  
 102:	c3                   	ret    
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 dc 0a 00 	movl   $0xadc,0x4(%esp)
 119:	00 
 ...
 17b:	c7 44 24 04 dd 0a 00 	movl   $0xadd,0x4(%esp)
 182:	00 
 183:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 18a:	e8 5e 05 00 00       	call   6ed <printf>
      exit();
...
void ps(void) {
 ...
 453:	c7 44 24 04 f1 0a 00 	movl   $0xaf1,0x4(%esp)
 45a:	00 
 45b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 462:	e8 86 02 00 00       	call   6ed <printf>
 ...
 530:	c7 44 24 04 0a 0b 00 	movl   $0xb0a,0x4(%esp)
 537:	00 
 538:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 53f:	e8 a9 01 00 00       	call   6ed <printf>
  for (i = 0; i < NPROC; ++i) {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 648:	74 17                	je     661 <printint+0x2c>
 64a:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 64e:	79 11                	jns    661 <printint+0x2c>
    neg = 1;
 ...
 65f:	eb 06                	jmp    667 <printint+0x32>
  } else {
    x = xx;
 ...
 667:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 66e:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 671:	8d 41 01             	lea    0x1(%ecx),%eax
 ...
 686:	0f b6 80 b8 0d 00 00 	movzbl 0xdb8(%eax),%eax
 68d:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 691:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 6a5:	75 c7                	jne    66e <printint+0x39>
  if(neg)
 6a7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6ab:	74 10                	je     6bd <printint+0x88>
    buf[i++] = '-';
 ...
 6b6:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 6bb:	eb 1f                	jmp    6dc <printint+0xa7>
 6bd:	eb 1d                	jmp    6dc <printint+0xa7>
    putc(fd, buf[i]);
...
printf(int fd, const char *fmt, ...)
{
 ...
 70a:	e9 7c 01 00 00       	jmp    88b <printf+0x19e>
    c = fmt[i] & 0xff;
 ...
 738:	e9 4a 01 00 00       	jmp    887 <printf+0x19a>
      } else {
        putc(fd, c);
 ...
 74d:	e8 bb fe ff ff       	call   60d <putc>
 752:	e9 30 01 00 00       	jmp    887 <printf+0x19a>
      }
    } else if(state == '%'){
 757:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 75b:	0f 85 26 01 00 00    	jne    887 <printf+0x19a>
      if(c == 'd'){
 761:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 765:	75 2d                	jne    794 <printf+0xa7>
        printint(fd, *ap, 10, 1);
 767:	8b 45 e8             	mov    -0x18(%ebp),%eax
 76a:	8b 00                	mov    (%eax),%eax
 76c:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 773:	00 
 ...
 786:	e8 aa fe ff ff       	call   635 <printint>
        ap++;
 78b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 78f:	e9 ec 00 00 00       	jmp    880 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
 794:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 798:	74 06                	je     7a0 <printf+0xb3>
 79a:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 79e:	75 2d                	jne    7cd <printf+0xe0>
        printint(fd, *ap, 16, 0);
 7a0:	8b 45 e8             	mov    -0x18(%ebp),%eax
 7a3:	8b 00                	mov    (%eax),%eax
 7a5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 7ac:	00 
 7ad:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 7b4:	00 
 7b5:	89 44 24 04          	mov    %eax,0x4(%esp)
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
 7bc:	89 04 24             	mov    %eax,(%esp)
 7bf:	e8 71 fe ff ff       	call   635 <printint>
        ap++;
 7c4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 7c8:	e9 b3 00 00 00       	jmp    880 <printf+0x193>
      } else if(c == 's'){
 7cd:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 7d1:	75 45                	jne    818 <printf+0x12b>
        s = (char*)*ap;
 ...
 7e3:	75 09                	jne    7ee <printf+0x101>
          s = "(null)";
 7e5:	c7 45 f4 1a 0b 00 00 	movl   $0xb1a,-0xc(%ebp)
        while(*s != 0){
 7ec:	eb 1e                	jmp    80c <printf+0x11f>
 7ee:	eb 1c                	jmp    80c <printf+0x11f>
          putc(fd, *s);
 ...
 803:	e8 05 fe ff ff       	call   60d <putc>
          s++;
 ...
 814:	75 da                	jne    7f0 <printf+0x103>
 816:	eb 68                	jmp    880 <printf+0x193>
        }
      } else if(c == 'c'){
 818:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 81c:	75 1d                	jne    83b <printf+0x14e>
        putc(fd, *ap);
 ...
 830:	e8 d8 fd ff ff       	call   60d <putc>
        ap++;
 835:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 839:	eb 45                	jmp    880 <printf+0x193>
      } else if(c == '%'){
 83b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 83f:	75 17                	jne    858 <printf+0x16b>
        putc(fd, c);
 ...
 851:	e8 b7 fd ff ff       	call   60d <putc>
 856:	eb 28                	jmp    880 <printf+0x193>
      } else {
 ...
 866:	e8 a2 fd ff ff       	call   60d <putc>
        putc(fd, c);
 ...
 87b:	e8 8d fd ff ff       	call   60d <putc>
      }
      state = 0;
 ...
 898:	0f 85 71 fe ff ff    	jne    70f <printf+0x22>
    }
  }
}
 89e:	c9                   	leave  
...
free(void *ap)
{
 ...
 8af:	a1 e8 0d 00 00       	mov    0xde8,%eax
 ...
 97a:	a3 e8 0d 00 00       	mov    %eax,0xde8
}
 97f:	c9                   	leave  
 980:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 9a0:	e8 48 fc ff ff       	call   5ed <sbrk>
...
malloc(uint nbytes)
{
 ...
 a7d:	eb 38                	jmp    ab7 <malloc+0xde>
    }
    if(p == freep)
 a7f:	a1 e8 0d 00 00       	mov    0xde8,%eax
 a84:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 a87:	75 1b                	jne    aa4 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
 a89:	8b 45 ec             	mov    -0x14(%ebp),%eax
 a8c:	89 04 24             	mov    %eax,(%esp)
 a8f:	e8 ed fe ff ff       	call   981 <morecore>
 a94:	89 45 f4             	mov    %eax,-0xc(%ebp)
 a97:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a9b:	75 07                	jne    aa4 <malloc+0xcb>
        return 0;
 a9d:	b8 00 00 00 00       	mov    $0x0,%eax
 aa2:	eb 13                	jmp    ab7 <malloc+0xde>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 ab2:	e9 70 ff ff ff       	jmp    a27 <malloc+0x4e>
}
 ab7:	c9                   	leave  
 ab8:	c3                   	ret    
