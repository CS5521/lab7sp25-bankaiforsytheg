...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 86 09 00 	movl   $0x986,0x4(%esp)
  6d:	00 
...
void ps(void) {
 ...
 309:	c7 44 24 04 a2 09 00 	movl   $0x9a2,0x4(%esp)
 310:	00 
 ...
 3e6:	c7 44 24 04 bb 09 00 	movl   $0x9bb,0x4(%esp)
 3ed:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 53c:	0f b6 80 48 0c 00 00 	movzbl 0xc48(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 699:	75 09                	jne    6a4 <printf+0x101>
          s = "(null)";
 69b:	c7 45 f4 cb 09 00 00 	movl   $0x9cb,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 765:	a1 64 0c 00 00       	mov    0xc64,%eax
 ...
 830:	a3 64 0c 00 00       	mov    %eax,0xc64
}
 835:	c9                   	leave  
 836:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 883:	e8 ce fe ff ff       	call   756 <free>
  return freep;
 888:	a1 64 0c 00 00       	mov    0xc64,%eax
}
 88d:	c9                   	leave  
 88e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8a1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8a4:	a1 64 0c 00 00       	mov    0xc64,%eax
 8a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8ac:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8b0:	75 23                	jne    8d5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8b2:	c7 45 f0 5c 0c 00 00 	movl   $0xc5c,-0x10(%ebp)
 8b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8bc:	a3 64 0c 00 00       	mov    %eax,0xc64
 8c1:	a1 64 0c 00 00       	mov    0xc64,%eax
 8c6:	a3 5c 0c 00 00       	mov    %eax,0xc5c
    base.s.size = 0;
 ...
 928:	a3 64 0c 00 00       	mov    %eax,0xc64
      return (void*)(p + 1);
 ...
 933:	eb 38                	jmp    96d <malloc+0xde>
    ...
    if(p == freep)
 935:	a1 64 0c 00 00       	mov    0xc64,%eax
